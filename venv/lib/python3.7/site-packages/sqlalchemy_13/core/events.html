...
<li><span class="link-container"><a class="reference external" href="api_basics.html">Core API Basics</a></span></li>
    ...
    <div id="docs-body" class="withsidebar core-events" >
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.event.base.Events"><code class="sig-name descname">Events</code></a></p></td>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.events.PoolEvents"><code class="sig-name descname">PoolEvents</code></a></p></td>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.events.ConnectionEvents"><code class="sig-name descname">ConnectionEvents</code></a></p></td>
<td><p>Available events for <a class="reference internal" href="connections.html#sqlalchemy.engine.Connectable" title="sqlalchemy.engine.Connectable"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connectable</span></code></a>, which includes
...
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.events.DialectEvents"><code class="sig-name descname">DialectEvents</code></a></p></td>
...
<dd><p>Available events for <a class="reference internal" href="connections.html#sqlalchemy.engine.Connectable" title="sqlalchemy.engine.Connectable"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connectable</span></code></a>, which includes
...
specific exception. <a class="footnote-reference brackets" href="#id2" id="id1">1</a>.</p></li>
</ul>
...
<dd><p>The pool “pre_ping” handler enabled using the
<a class="reference internal" href="engines.html#sqlalchemy.create_engine.params.pool_pre_ping" title="sqlalchemy.create_engine"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">create_engine.pool_pre_ping</span></code></a> parameter does
...
For this use case, the <a class="reference internal" href="pooling.html#pool-disconnects-pessimistic-custom"><span class="std std-ref">legacy recipe based on
engine_connect() may be used</span></a>.  A future API allow
more comprehensive customization of the “disconnect”
detection mechanism across all functions.</p>
</dd>
</dl>
</div>
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="engines.html#custom-dbapi-args"><span class="std std-ref">Custom DBAPI connect() arguments / on-connect routines</span></a></p>
</div>
</dd></dl>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.events.DDLEvents"><code class="sig-name descname">DDLEvents</code></a></p></td>
...
<a class="reference internal" href="metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal notranslate"><span class="pre">Column</span></code></a>.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.events.SchemaEventTarget"><code class="sig-name descname">SchemaEventTarget</code></a></p></td>
