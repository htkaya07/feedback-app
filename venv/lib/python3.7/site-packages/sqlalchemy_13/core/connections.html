...
<p>The object returned is known as <a class="reference internal" href="#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a>, which
...
The <a class="reference internal" href="#sqlalchemy.engine.Connection.execute" title="sqlalchemy.engine.Connection.execute"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Connection.execute()</span></code></a> method can of course accommodate more than
...
<a class="reference internal" href="#connections-avoid-nesting"><span class="std std-ref">Arbitrary Transaction Nesting as an Antipattern</span></a>.</p>
</div>
...
one exists.</p>
<div class="section" id="arbitrary-transaction-nesting-as-an-antipattern">
...
which tends to correlate with lower <span class="xref std std-term">cyclomatic complexity</span>.   The
...
<div class="section" id="migrating-from-the-nesting-pattern">
...
<a class="reference internal" href="#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a>.   When using the ORM <code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code>, this
connectivty management is provided by the <code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code> itself.
...
<p><a class="reference internal" href="../orm/session_transaction.html#session-subtransactions-migrating"><span class="std std-ref">Migrating from the “subtransaction” pattern</span></a> - ORM version</p>
</div>
</div>
</div>
</div>
<div class="section" id="library-level-e-g-emulated-autocommit">
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The “autocommit” feature of SQLAlchemy is a legacy feature that will
be deprecated in an upcoming release.  New usage paradigms will eliminate
the need for it to be present.</p>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
...
<div class="section" id="setting-transaction-isolation-levels-including-dbapi-autocommit">
...
that of <code class="xref py py-meth docutils literal notranslate"><span class="pre">Executable.execution_options()</span></code>.  This because the option
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>“Connectionless” and “implicit” execution are legacy SQLAlchemy
features that will be deprecated in an upcoming release.</p>
</div>
...
<a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a>.  This was illustrated using the
...
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since version 1.3: </span>The “threadlocal” engine strategy is deprecated, and will be removed
in a future release.</p>
<p>This strategy is designed for a particular pattern of usage which is
generally considered as a legacy pattern.  It has <strong>no impact</strong> on the
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="../changelog/migration_13.html#change-4393-threadlocal"><span class="std std-ref">“threadlocal” engine strategy deprecated</span></a></p>
</div>
</div>
...
<p>Calling <a class="reference internal" href="#sqlalchemy.engine.Connection.close" title="sqlalchemy.engine.Connection.close"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Connection.close()</span></code></a> on the “contextual” connection does not <a class="reference internal" href="../glossary.html#term-release"><span class="xref std std-term">release</span></a>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.Connectable"><code class="sig-name descname">Connectable</code></a></p></td>
<td><p>Interface for an object which supports execution of SQL constructs.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="sig-name descname">Connection</code></a></p></td>
<td><p>Provides high-level functionality for a wrapped DB-API connection.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.CreateEnginePlugin"><code class="sig-name descname">CreateEnginePlugin</code></a></p></td>
...
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="sig-name descname">Engine</code></a></p></td>
...
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="sig-name descname">ExceptionContext</code></a></p></td>
<td><p>Encapsulate information about an error condition in progress.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.NestedTransaction"><code class="sig-name descname">NestedTransaction</code></a></p></td>
<td><p>Represent a ‘nested’, or SAVEPOINT transaction.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="sig-name descname">ResultProxy</code></a></p></td>
<td><p>A facade around a DBAPI cursor object.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.RowProxy"><code class="sig-name descname">RowProxy</code></a></p></td>
<td><p>Represent a single result row.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.Transaction"><code class="sig-name descname">Transaction</code></a></p></td>
<td><p>Represent a database transaction in progress.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.TwoPhaseTransaction"><code class="sig-name descname">TwoPhaseTransaction</code></a></p></td>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.engine.</code><code class="sig-name descname">Connection</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">engine</span></em>, <em class="sig-param"><span class="n">connection</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">close_with_result</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">_branch_from</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_execution_options</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_dispatch</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_has_events</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="sqlelement.html#sqlalchemy.sql.expression.ClauseElement" title="sqlalchemy.sql.expression.ClauseElement"><code class="xref py py-class docutils literal notranslate"><span class="pre">ClauseElement</span></code></a>, <a class="reference internal" href="internals.html#sqlalchemy.engine.interfaces.Compiled" title="sqlalchemy.engine.interfaces.Compiled"><code class="xref py py-class docutils literal notranslate"><span class="pre">Compiled</span></code></a> and
<a class="reference internal" href="defaults.html#sqlalchemy.schema.DefaultGenerator" title="sqlalchemy.schema.DefaultGenerator"><code class="xref py py-class docutils literal notranslate"><span class="pre">DefaultGenerator</span></code></a>
...
<p>class <a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection</span></code></a> (<a class="reference internal" href="#sqlalchemy.engine.Connectable" title="sqlalchemy.engine.Connectable"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connectable</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.engine.Connection.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">engine</span></em>, <em class="sig-param"><span class="n">connection</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">close_with_result</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">_branch_from</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_execution_options</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_dispatch</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_has_events</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">begin</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.begin" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">begin_nested</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.begin_nested" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">begin_twophase</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">xid</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.begin_twophase" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">close</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.close" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">closed</code><a class="headerlink" href="#sqlalchemy.engine.Connection.closed" title="Permalink to this definition">¶</a></dt>
<dd><p>Return True if this connection is closed.</p>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.engine.Connection.connect">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">connect</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.connect" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">connection</code><a class="headerlink" href="#sqlalchemy.engine.Connection.connection" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">default_isolation_level</code><a class="headerlink" href="#sqlalchemy.engine.Connection.default_isolation_level" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">detach</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.detach" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">execute</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">object_</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">multiparams</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">params</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.execute" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">execution_options</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">opt</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.execution_options" title="Permalink to this definition">¶</a></dt>
<dd><p>Set non-SQL options for the connection which take effect
during execution.</p>
<p>The method returns a copy of this <a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a>
which references
the same underlying DBAPI connection, but also defines the given
execution options which will take effect for a call to
<a class="reference internal" href="#sqlalchemy.engine.Connection.execute" title="sqlalchemy.engine.Connection.execute"><code class="xref py py-meth docutils literal notranslate"><span class="pre">execute()</span></code></a>. As the new <a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a>
references the same
...
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since version 1.4: </span>The library-level “autocommit” feature is being
removed in favor of database driver “autocommit” which is
now widely available.  See the section <a class="reference internal" href="#dbapi-autocommit"><span class="std std-ref">Setting Transaction Isolation Levels including DBAPI Autocommit</span></a>.</p>
</div>
</p></li>
...
<dl class="py method">
<dt id="sqlalchemy.engine.Connection.get_execution_options">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">get_execution_options</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.get_execution_options" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">get_isolation_level</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.get_isolation_level" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">in_transaction</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.in_transaction" title="Permalink to this definition">¶</a></dt>
<dd><p>Return True if a transaction is in progress.</p>
</dd></dl>

<dl class="py attribute">
<dt id="sqlalchemy.engine.Connection.info">
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">info</code><a class="headerlink" href="#sqlalchemy.engine.Connection.info" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">invalidate</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">exception</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.invalidate" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">invalidated</code><a class="headerlink" href="#sqlalchemy.engine.Connection.invalidated" title="Permalink to this definition">¶</a></dt>
<dd><p>Return True if this connection was invalidated.</p>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.engine.Connection.run_callable">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">run_callable</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">callable_</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">args</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.run_callable" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">scalar</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">object_</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">multiparams</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">params</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.scalar" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">schema_for_object</code><em class="property"> = &lt;sqlalchemy.sql.schema._SchemaTranslateMap object&gt;</em><a class="headerlink" href="#sqlalchemy.engine.Connection.schema_for_object" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connection"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connection.</span></code></a><code class="sig-name descname">transaction</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">callable_</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">args</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connection.transaction" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.engine.</code><code class="sig-name descname">Connectable</code><a class="headerlink" href="#sqlalchemy.engine.Connectable" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connectable"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connectable.</span></code></a><code class="sig-name descname">connect</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connectable.connect" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connectable"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connectable.</span></code></a><code class="sig-name descname">contextual_connect</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">arg</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connectable.contextual_connect" title="Permalink to this definition">¶</a></dt>
<dd><p>Return a <a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a>
object which may be part of an ongoing
context.</p>
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since version 1.3: </span>The <a class="reference internal" href="#sqlalchemy.engine.Engine.contextual_connect" title="sqlalchemy.engine.Engine.contextual_connect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Engine.contextual_connect()</span></code></a> and <code class="xref py py-meth docutils literal notranslate"><span class="pre">Connection.contextual_connect()</span></code> methods are deprecated. This method is an artifact of the threadlocal engine strategy which is also to be deprecated.   For explicit connections from an <a class="reference internal" href="#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a>, use the <a class="reference internal" href="#sqlalchemy.engine.Engine.connect" title="sqlalchemy.engine.Engine.connect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Engine.connect()</span></code></a> method.</p>
</div>
<p>Depending on context, this may be <code class="docutils literal notranslate"><span class="pre">self</span></code> if this object
is already an instance of <a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a>, or a newly
procured <a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a> if this object is an instance
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connectable"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connectable.</span></code></a><code class="sig-name descname">create</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">entity</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connectable.create" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connectable"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connectable.</span></code></a><code class="sig-name descname">drop</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">entity</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connectable.drop" title="Permalink to this definition">¶</a></dt>
...
<dl class="py attribute">
<dt id="sqlalchemy.engine.Connectable.engine">
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.Connectable"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connectable.</span></code></a><code class="sig-name descname">engine</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.engine.Connectable.engine" title="Permalink to this definition">¶</a></dt>
<dd><p>The <a class="reference internal" href="#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a> instance referred to by this
<a class="reference internal" href="#sqlalchemy.engine.Connectable" title="sqlalchemy.engine.Connectable"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connectable</span></code></a>.</p>
<p>May be <code class="docutils literal notranslate"><span class="pre">self</span></code> if this is already an <a class="reference internal" href="#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a>.</p>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.engine.Connectable.execute">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connectable"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connectable.</span></code></a><code class="sig-name descname">execute</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">object_</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">multiparams</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">params</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connectable.execute" title="Permalink to this definition">¶</a></dt>
<dd><p>Executes the given construct and returns a</p>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.engine.Connectable.scalar">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Connectable"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connectable.</span></code></a><code class="sig-name descname">scalar</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">object_</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">multiparams</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">params</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Connectable.scalar" title="Permalink to this definition">¶</a></dt>
<dd><p>Executes and returns the first column of the first row.</p>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.engine.</code><code class="sig-name descname">CreateEnginePlugin</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">url</span></em>, <em class="sig-param"><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.CreateEnginePlugin" title="Permalink to this definition">¶</a></dt>
...
<p>Alternatively, the <code class="xref py py-paramref docutils literal notranslate"><span class="pre">plugins&quot;</span> <span class="pre">argument</span> <span class="pre">may</span> <span class="pre">be</span>
<span class="pre">passed</span> <span class="pre">as</span> <span class="pre">a</span> <span class="pre">list</span> <span class="pre">to</span> <span class="pre">:func:`_sa.create_engine</span></code>:</p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.CreateEnginePlugin"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.CreateEnginePlugin.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">url</span></em>, <em class="sig-param"><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.CreateEnginePlugin.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.CreateEnginePlugin"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.CreateEnginePlugin.</span></code></a><code class="sig-name descname">engine_created</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">engine</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.CreateEnginePlugin.engine_created" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.CreateEnginePlugin"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.CreateEnginePlugin.</span></code></a><code class="sig-name descname">handle_dialect_kwargs</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">dialect_cls</span></em>, <em class="sig-param"><span class="n">dialect_args</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.CreateEnginePlugin.handle_dialect_kwargs" title="Permalink to this definition">¶</a></dt>
<dd><p>parse and modify dialect kwargs</p>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.engine.CreateEnginePlugin.handle_pool_kwargs">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.CreateEnginePlugin"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.CreateEnginePlugin.</span></code></a><code class="sig-name descname">handle_pool_kwargs</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">pool_cls</span></em>, <em class="sig-param"><span class="n">pool_args</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.CreateEnginePlugin.handle_pool_kwargs" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.engine.</code><code class="sig-name descname">Engine</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">pool</span></em>, <em class="sig-param"><span class="n">dialect</span></em>, <em class="sig-param"><span class="n">url</span></em>, <em class="sig-param"><span class="n">logging_name</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">echo</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">proxy</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">execution_options</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">hide_parameters</span><span class="o">=</span><span class="default_value">False</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine" title="Permalink to this definition">¶</a></dt>
...
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine</span></code></a> (<a class="reference internal" href="#sqlalchemy.engine.Connectable" title="sqlalchemy.engine.Connectable"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.engine.Connectable</span></code></a>, <a class="reference internal" href="internals.html#sqlalchemy.log.Identified" title="sqlalchemy.log.Identified"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.log.Identified</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.engine.Engine.begin">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">begin</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">close_with_result</span><span class="o">=</span><span class="default_value">False</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.begin" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a> when
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">connect</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.connect" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">contextual_connect</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">close_with_result</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.contextual_connect" title="Permalink to this definition">¶</a></dt>
<dd><p>Return a <a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a>
object which may be part of some
ongoing context.</p>
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since version 1.3: </span>The <a class="reference internal" href="#sqlalchemy.engine.Engine.contextual_connect" title="sqlalchemy.engine.Engine.contextual_connect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Engine.contextual_connect()</span></code></a> method is deprecated. This method is an artifact of the threadlocal engine strategy which is also to be deprecated.   For explicit connections from an <a class="reference internal" href="#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a>, use the <a class="reference internal" href="#sqlalchemy.engine.Engine.connect" title="sqlalchemy.engine.Engine.connect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Engine.connect()</span></code></a> method.</p>
</div>
<p>By default, this method does the same thing as
<a class="reference internal" href="#sqlalchemy.engine.Engine.connect" title="sqlalchemy.engine.Engine.connect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Engine.connect()</span></code></a>.
...
<dl class="field-list simple">
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><p><span class="target" id="sqlalchemy.engine.Engine.contextual_connect.params.close_with_result"></span><strong>close_with_result</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.engine.Engine.contextual_connect.params.close_with_result">¶</a> – When True, the first
<a class="reference internal" href="#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a>
...
<a class="reference internal" href="#sqlalchemy.engine.Connection.close" title="sqlalchemy.engine.Connection.close"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Connection.close()</span></code></a>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">dispose</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.dispose" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">driver</code><a class="headerlink" href="#sqlalchemy.engine.Engine.driver" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">execute</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">statement</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">multiparams</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">params</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.execute" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#sqlalchemy.engine.Engine.contextual_connect" title="sqlalchemy.engine.Engine.contextual_connect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Engine.contextual_connect()</span></code></a> method,
and the statement executed
with that connection. The returned <a class="reference internal" href="#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a>
is flagged
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">execution_options</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">opt</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.execution_options" title="Permalink to this definition">¶</a></dt>
...
<dl class="py method">
<dt id="sqlalchemy.engine.Engine.get_execution_options">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">get_execution_options</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.get_execution_options" title="Permalink to this definition">¶</a></dt>
<dd><p>Get the non-SQL options which will take effect during execution.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#sqlalchemy.engine.Engine.execution_options" title="sqlalchemy.engine.Engine.execution_options"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Engine.execution_options()</span></code></a></p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">has_table</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">table_name</span></em>, <em class="sig-param"><span class="n">schema</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.has_table" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">raw_connection</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">_connection</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.raw_connection" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">run_callable</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">callable_</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">args</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.run_callable" title="Permalink to this definition">¶</a></dt>
<dd><p>Given a callable object or function, execute it, passing
a <a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a> as the first argument.</p>
<p>The given *args and **kwargs are passed subsequent
to the <a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a> argument.</p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">scalar</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">statement</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">multiparams</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">params</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.scalar" title="Permalink to this definition">¶</a></dt>
<dd><p>Executes and returns the first column of the first row.</p>
<p>The underlying cursor is closed after execution.</p>
</dd></dl>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">schema_for_object</code><em class="property"> = &lt;sqlalchemy.sql.schema._SchemaTranslateMap object&gt;</em><a class="headerlink" href="#sqlalchemy.engine.Engine.schema_for_object" title="Permalink to this definition">¶</a></dt>
<dd><p>Return the “.schema” attribute for an object.</p>
<p>Used for <a class="reference internal" href="metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal notranslate"><span class="pre">Table</span></code></a>, <a class="reference internal" href="defaults.html#sqlalchemy.schema.Sequence" title="sqlalchemy.schema.Sequence"><code class="xref py py-class docutils literal notranslate"><span class="pre">Sequence</span></code></a> and similar objects,
and takes into account
the <a class="reference internal" href="#sqlalchemy.engine.Connection.execution_options.params.schema_translate_map" title="sqlalchemy.engine.Connection.execution_options"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Connection.execution_options.schema_translate_map</span></code></a>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">table_names</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">schema</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">connection</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.table_names" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">transaction</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">callable_</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">args</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.transaction" title="Permalink to this definition">¶</a></dt>
<dd><p>Execute the given function within a transaction boundary.</p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Engine"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Engine.</span></code></a><code class="sig-name descname">update_execution_options</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">opt</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Engine.update_execution_options" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.engine.</code><code class="sig-name descname">ExceptionContext</code><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ExceptionContext.</span></code></a><code class="sig-name descname">chained_exception</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext.chained_exception" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ExceptionContext.</span></code></a><code class="sig-name descname">connection</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext.connection" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ExceptionContext.</span></code></a><code class="sig-name descname">cursor</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext.cursor" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ExceptionContext.</span></code></a><code class="sig-name descname">engine</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext.engine" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ExceptionContext.</span></code></a><code class="sig-name descname">execution_context</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext.execution_context" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ExceptionContext.</span></code></a><code class="sig-name descname">invalidate_pool_on_disconnect</code><em class="property"> = True</em><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext.invalidate_pool_on_disconnect" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ExceptionContext.</span></code></a><code class="sig-name descname">is_disconnect</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext.is_disconnect" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ExceptionContext.</span></code></a><code class="sig-name descname">original_exception</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext.original_exception" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ExceptionContext.</span></code></a><code class="sig-name descname">parameters</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext.parameters" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ExceptionContext.</span></code></a><code class="sig-name descname">sqlalchemy_exception</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext.sqlalchemy_exception" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ExceptionContext"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ExceptionContext.</span></code></a><code class="sig-name descname">statement</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.engine.ExceptionContext.statement" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.engine.</code><code class="sig-name descname">NestedTransaction</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">connection</span></em>, <em class="sig-param"><span class="n">parent</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.NestedTransaction" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.engine.</code><code class="sig-name descname">ResultProxy</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">context</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy" title="Permalink to this definition">¶</a></dt>
<dd><p>A facade around a DBAPI cursor object.</p>
<p>Returns database rows via the <a class="reference internal" href="#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">RowProxy</span></code></a> class, which provides
...
<a class="reference internal" href="#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a> and <a class="reference internal" href="#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">RowProxy</span></code></a> objects.</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.engine.ResultProxy.close">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">close</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.close" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a>
exhausts all available rows.  <a class="reference internal" href="#sqlalchemy.engine.ResultProxy.close" title="sqlalchemy.engine.ResultProxy.close"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ResultProxy.close()</span></code></a>
is generally
an optional method except in the case when discarding a
<a class="reference internal" href="#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a>
that still has additional rows pending for fetch.</p>
...
the underlying <a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a> object is also closed,
which
...
<p><span class="versionmodified changed">Changed in version 1.0.0: </span>- the <a class="reference internal" href="#sqlalchemy.engine.ResultProxy.close" title="sqlalchemy.engine.ResultProxy.close"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ResultProxy.close()</span></code></a>
method
has been separated out from the process that releases the underlying
DBAPI cursor resource.   The “auto close” feature of the
<a class="reference internal" href="#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a> now performs a so-called “soft close”,
which
releases the underlying DBAPI cursor, but allows the
<a class="reference internal" href="#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a>
to still behave as an open-but-exhausted
result set; the actual <a class="reference internal" href="#sqlalchemy.engine.ResultProxy.close" title="sqlalchemy.engine.ResultProxy.close"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ResultProxy.close()</span></code></a>
method is never
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">fetchall</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.fetchall" title="Permalink to this definition">¶</a></dt>
...
<dd class="field-odd"><p>a list of <a class="reference internal" href="#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">RowProxy</span></code></a> objects</p>
</dd>
</dl>
</dd></dl>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">fetchmany</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">size</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.fetchmany" title="Permalink to this definition">¶</a></dt>
...
cursor resource is released, and the object may be safely
discarded.</p>
<p>Calls to <a class="reference internal" href="#sqlalchemy.engine.ResultProxy.fetchmany" title="sqlalchemy.engine.ResultProxy.fetchmany"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ResultProxy.fetchmany()</span></code></a>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">fetchone</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.fetchone" title="Permalink to this definition">¶</a></dt>
...
<dl class="field-list simple">
<dt class="field-odd">Returns</dt>
<dd class="field-odd"><p>a <a class="reference internal" href="#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">RowProxy</span></code></a> object, or None if no rows remain</p>
</dd>
</dl>
</dd></dl>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">first</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.first" title="Permalink to this definition">¶</a></dt>
...
e.g. the <a class="reference internal" href="#sqlalchemy.engine.ResultProxy.close" title="sqlalchemy.engine.ResultProxy.close"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ResultProxy.close()</span></code></a>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">inserted_primary_key</code><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.inserted_primary_key" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">is_insert</code><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.is_insert" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">keys</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.keys" title="Permalink to this definition">¶</a></dt>
<dd><p>Return the list of string keys that would represented by each
<a class="reference internal" href="#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">RowProxy</span></code></a>.</p>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.engine.ResultProxy.last_inserted_params">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">last_inserted_params</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.last_inserted_params" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">last_updated_params</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.last_updated_params" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">lastrow_has_defaults</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.lastrow_has_defaults" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">lastrowid</code><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.lastrowid" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#sqlalchemy.engine.ResultProxy.inserted_primary_key" title="sqlalchemy.engine.ResultProxy.inserted_primary_key"><code class="xref py py-attr docutils literal notranslate"><span class="pre">ResultProxy.inserted_primary_key</span></code></a> attribute provides a
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">next</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.next" title="Permalink to this definition">¶</a></dt>
<dd><p>Implement the Python next() protocol.</p>
<p>This method, mirrored as both <code class="docutils literal notranslate"><span class="pre">.next()</span></code> and  <code class="docutils literal notranslate"><span class="pre">.__next__()</span></code>, is part
of Python’s API for producing iterator-like behavior.</p>
<div class="versionadded">
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">postfetch_cols</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.postfetch_cols" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">prefetch_cols</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.prefetch_cols" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">returned_defaults</code><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.returned_defaults" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">returns_rows</code><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.returns_rows" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#sqlalchemy.engine.ResultProxy.fetchone" title="sqlalchemy.engine.ResultProxy.fetchone"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ResultProxy.fetchone()</span></code></a>,
<a class="reference internal" href="#sqlalchemy.engine.ResultProxy.fetchmany" title="sqlalchemy.engine.ResultProxy.fetchmany"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ResultProxy.fetchmany()</span></code></a>
<a class="reference internal" href="#sqlalchemy.engine.ResultProxy.fetchall" title="sqlalchemy.engine.ResultProxy.fetchall"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ResultProxy.fetchall()</span></code></a>.</p>
</dd></dl>

<dl class="py attribute">
<dt id="sqlalchemy.engine.ResultProxy.rowcount">
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">rowcount</code><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.rowcount" title="Permalink to this definition">¶</a></dt>
...
<li><p><a class="reference internal" href="#sqlalchemy.engine.ResultProxy.rowcount" title="sqlalchemy.engine.ResultProxy.rowcount"><code class="xref py py-attr docutils literal notranslate"><span class="pre">ResultProxy.rowcount</span></code></a>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">scalar</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.scalar" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">supports_sane_multi_rowcount</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.supports_sane_multi_rowcount" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.ResultProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.ResultProxy.</span></code></a><code class="sig-name descname">supports_sane_rowcount</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.ResultProxy.supports_sane_rowcount" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.engine.</code><code class="sig-name descname">RowProxy</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">parent</span></em>, <em class="sig-param"><span class="n">row</span></em>, <em class="sig-param"><span class="n">processors</span></em>, <em class="sig-param"><span class="n">keymap</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.RowProxy" title="Permalink to this definition">¶</a></dt>
<dd><p>Represent a single result row.</p>
<p>The <a class="reference internal" href="#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">RowProxy</span></code></a> object is retrieved from a database result, from the
<a class="reference internal" href="#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a> object using methods like
<a class="reference internal" href="#sqlalchemy.engine.ResultProxy.fetchall" title="sqlalchemy.engine.ResultProxy.fetchall"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ResultProxy.fetchall()</span></code></a>.</p>
<p>The <a class="reference internal" href="#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">RowProxy</span></code></a> object seeks to act mostly like a Python named
tuple, but also provides some Python dictionary behaviors at the same time.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.engine.RowProxy</span></code></a> (<code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.engine.BaseRowProxy</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.engine.RowProxy.has_key">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.RowProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.RowProxy.</span></code></a><code class="sig-name descname">has_key</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">key</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.RowProxy.has_key" title="Permalink to this definition">¶</a></dt>
<dd><p>Return True if this <a class="reference internal" href="#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">RowProxy</span></code></a> contains the given key.</p>
<p>Through the SQLAlchemy 1.x series, the <code class="docutils literal notranslate"><span class="pre">__contains__()</span></code> method
of <a class="reference internal" href="#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">RowProxy</span></code></a> also links to <a class="reference internal" href="#sqlalchemy.engine.RowProxy.has_key" title="sqlalchemy.engine.RowProxy.has_key"><code class="xref py py-meth docutils literal notranslate"><span class="pre">RowProxy.has_key()</span></code></a>, in that
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.RowProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.RowProxy.</span></code></a><code class="sig-name descname">items</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.RowProxy.items" title="Permalink to this definition">¶</a></dt>
...
<dl class="py method">
<dt id="sqlalchemy.engine.RowProxy.iterkeys">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.RowProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.RowProxy.</span></code></a><code class="sig-name descname">iterkeys</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.RowProxy.iterkeys" title="Permalink to this definition">¶</a></dt>
<dd><p>Return a an iterator against the <a class="reference internal" href="#sqlalchemy.engine.RowProxy.keys" title="sqlalchemy.engine.RowProxy.keys"><code class="xref py py-meth docutils literal notranslate"><span class="pre">RowProxy.keys()</span></code></a> method.</p>
...
<dl class="py method">
<dt id="sqlalchemy.engine.RowProxy.itervalues">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.RowProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.RowProxy.</span></code></a><code class="sig-name descname">itervalues</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.RowProxy.itervalues" title="Permalink to this definition">¶</a></dt>
<dd><p>Return a an iterator against the <a class="reference internal" href="#sqlalchemy.engine.RowProxy.values" title="sqlalchemy.engine.RowProxy.values"><code class="xref py py-meth docutils literal notranslate"><span class="pre">RowProxy.values()</span></code></a> method.</p>
<p>This method is analogous to the Python-2-only dictionary
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.RowProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.RowProxy.</span></code></a><code class="sig-name descname">keys</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.RowProxy.keys" title="Permalink to this definition">¶</a></dt>
...
<dl class="py method">
<dt id="sqlalchemy.engine.RowProxy.values">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.RowProxy"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.RowProxy.</span></code></a><code class="sig-name descname">values</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.RowProxy.values" title="Permalink to this definition">¶</a></dt>
<dd><p>Return the values represented by this <a class="reference internal" href="#sqlalchemy.engine.RowProxy" title="sqlalchemy.engine.RowProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">RowProxy</span></code></a> as a list.</p>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.engine.</code><code class="sig-name descname">Transaction</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">connection</span></em>, <em class="sig-param"><span class="n">parent</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Transaction" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Transaction"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Transaction.</span></code></a><code class="sig-name descname">close</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Transaction.close" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Transaction"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Transaction.</span></code></a><code class="sig-name descname">commit</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Transaction.commit" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.Transaction"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.Transaction.</span></code></a><code class="sig-name descname">rollback</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.Transaction.rollback" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.engine.</code><code class="sig-name descname">TwoPhaseTransaction</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">connection</span></em>, <em class="sig-param"><span class="n">xid</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.TwoPhaseTransaction" title="Permalink to this definition">¶</a></dt>
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.engine.TwoPhaseTransaction" title="sqlalchemy.engine.TwoPhaseTransaction"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.engine.TwoPhaseTransaction</span></code></a> (<a class="reference internal" href="#sqlalchemy.engine.Transaction" title="sqlalchemy.engine.Transaction"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.engine.Transaction</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.engine.TwoPhaseTransaction.prepare">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.TwoPhaseTransaction"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.TwoPhaseTransaction.</span></code></a><code class="sig-name descname">prepare</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.TwoPhaseTransaction.prepare" title="Permalink to this definition">¶</a></dt>
