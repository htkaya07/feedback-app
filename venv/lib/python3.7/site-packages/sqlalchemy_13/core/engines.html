...
<li><span class="link-container"><a class="reference external" href="#custom-dbapi-connect-arguments-on-connect-routines">Custom DBAPI connect() arguments / on-connect routines</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#special-keyword-arguments-passed-to-dbapi-connect">Special Keyword Arguments Passed to dbapi.connect()</a></span></li>
<li><span class="link-container"><a class="reference external" href="#controlling-how-parameters-are-passed-to-the-dbapi-connect-function">Controlling how parameters are passed to the DBAPI connect() function</a></span></li>
<li><span class="link-container"><a class="reference external" href="#modifying-the-dbapi-connection-after-connect-or-running-commands-after-connect">Modifying the DBAPI connection after connect, or running commands after connect</a></span></li>
<li><span class="link-container"><a class="reference external" href="#fully-replacing-the-dbapi-connect-function">Fully Replacing the DBAPI <code class="docutils literal notranslate"><span class="pre">connect()</span></code> function</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#configuring-logging">Configuring Logging</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#more-on-the-echo-flag">More on the Echo Flag</a></span></li>
<li><span class="link-container"><a class="reference external" href="#setting-the-logging-name">Setting the Logging Name</a></span></li>
<li><span class="link-container"><a class="reference external" href="#hiding-parameters">Hiding Parameters</a></span></li>
</ul>
</li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="api_basics.html">Core API Basics</a></span></li>
    ...
    <div id="docs-body" class="withsidebar core-engines" >
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.create_engine"><code class="sig-name descname">create_engine</code></a>(*args, **kwargs)</p></td>
...
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine_from_config"><code class="sig-name descname">engine_from_config</code></a>(configuration[, prefix], **kwargs)</p></td>
<td><p>Create a new Engine instance using a configuration dictionary.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.url.make_url"><code class="sig-name descname">make_url</code></a>(name_or_url)</p></td>
<td><p>Given a string or unicode instance, produce a new URL instance.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.engine.url.URL"><code class="sig-name descname">URL</code></a></p></td>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.</code><code class="sig-name descname">create_engine</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">args</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.create_engine" title="Permalink to this definition">¶</a></dt>
...
the <a class="reference internal" href="connections.html#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a>, the underlying <a class="reference internal" href="internals.html#sqlalchemy.engine.interfaces.Dialect" title="sqlalchemy.engine.interfaces.Dialect"><code class="xref py py-class docutils literal notranslate"><span class="pre">Dialect</span></code></a>,
as well as the
...
such as <a class="reference internal" href="connections.html#sqlalchemy.engine.Engine.execute" title="sqlalchemy.engine.Engine.execute"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Engine.execute()</span></code></a> is invoked.   The
...
at <a class="reference internal" href="#custom-dbapi-args"><span class="std std-ref">Custom DBAPI connect() arguments / on-connect routines</span></a>.</p></li>
...
<p><span class="versionmodified deprecated">Deprecated since version 1.3: </span>The <a class="reference internal" href="#sqlalchemy.create_engine.params.convert_unicode" title="sqlalchemy.create_engine"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">create_engine.convert_unicode</span></code></a> parameter
is deprecated and will be removed in a future release.
All modern DBAPIs now support Python Unicode directly and this
parameter is unnecessary.</p>
</div>
</p></li>
...
<a class="reference internal" href="events.html#sqlalchemy.events.DialectEvents.do_connect" title="sqlalchemy.events.DialectEvents.do_connect"><code class="xref py py-class docutils literal notranslate"><span class="pre">do_connect</span></code></a> hook which allows complete
control over how a connection is made to the database, given the full
set of URL arguments and state beforehand.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="events.html#sqlalchemy.events.DialectEvents.do_connect" title="sqlalchemy.events.DialectEvents.do_connect"><code class="xref py py-class docutils literal notranslate"><span class="pre">do_connect</span></code></a> - event hook that allows
full control over DBAPI connection mechanics.</p>
<p><a class="reference internal" href="#custom-dbapi-args"><span class="std std-ref">Custom DBAPI connect() arguments / on-connect routines</span></a></p>
</div>
</p></li>
...
the DBAPIs own encoding facilities.</strong></p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The <code class="docutils literal notranslate"><span class="pre">encoding</span></code> parameter deals only with in-Python
...
please consult specific <a class="reference internal" href="../dialects/index.html"><span class="std std-ref">dialect documentation</span></a> for details.</p>
</div>
<p>All modern DBAPIs that work in Python 3 necessarily feature direct
...
not supporting a Python <code class="docutils literal notranslate"><span class="pre">unicode</span></code> object under Python 2, this
encoding is used to determine the source/destination encoding.  It is
<strong>not used</strong> for those cases where the DBAPI handles unicode directly.</p>
<p>To properly configure a system to accommodate Python <code class="docutils literal notranslate"><span class="pre">unicode</span></code>
...
to the specific target database in use at <a class="reference internal" href="../dialects/index.html"><span class="std std-ref">Dialects</span></a>.</p>
<p>Areas where string encoding may need to be accommodated
outside of the DBAPI, nearly always under <strong>Python 2 only</strong>,
include zero or more of:</p>
<ul>
...
<p>When using Python 3, the DBAPI is required to support all of the above
values as Python <code class="docutils literal notranslate"><span class="pre">unicode</span></code> objects, which in Python 3 are just known
as <code class="docutils literal notranslate"><span class="pre">str</span></code>.  In Python 2, the DBAPI does not specify unicode behavior
...
these string arguments: <code class="docutils literal notranslate"><span class="pre">&quot;SERIALIZABLE&quot;</span></code>, <code class="docutils literal notranslate"><span class="pre">&quot;REPEATABLE</span> <span class="pre">READ&quot;</span></code>,
...
<li><p><span class="target" id="sqlalchemy.create_engine.params.json_deserializer"></span><strong>json_deserializer</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.create_engine.params.json_deserializer">¶</a> – <p>for dialects that support the
...
<p><span class="versionmodified changed">Changed in version 1.3.7: </span>The SQLite dialect renamed this from
<code class="docutils literal notranslate"><span class="pre">_json_deserializer</span></code>.</p>
</div>
</p></li>
<li><p><span class="target" id="sqlalchemy.create_engine.params.json_serializer"></span><strong>json_serializer</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.create_engine.params.json_serializer">¶</a> – <p>for dialects that support the <a class="reference internal" href="type_basics.html#sqlalchemy.types.JSON" title="sqlalchemy.types.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">JSON</span></code></a>
datatype, this is a Python callable that will render a given object
as JSON.   By default, the Python <code class="docutils literal notranslate"><span class="pre">json.dumps</span></code> function is used.</p>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in version 1.3.7: </span>The SQLite dialect renamed this from
<code class="docutils literal notranslate"><span class="pre">_json_serializer</span></code>.</p>
</div>
</p></li>
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="pooling.html#pool-use-lifo"><span class="std std-ref">Using FIFO vs. LIFO</span></a></p>
<p><a class="reference internal" href="pooling.html#pool-disconnects"><span class="std std-ref">Dealing with Disconnects</span></a></p>
</div>
</div></blockquote>
</p></li>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.</code><code class="sig-name descname">engine_from_config</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">configuration</span></em>, <em class="sig-param"><span class="n">prefix</span><span class="o">=</span><span class="default_value">'sqlalchemy.'</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine_from_config" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.engine.url.</code><code class="sig-name descname">make_url</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">name_or_url</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.url.make_url" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.engine.url.</code><code class="sig-name descname">URL</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">drivername</span></em>, <em class="sig-param"><span class="n">username</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">password</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">host</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">port</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">database</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">query</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.url.URL" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.url.URL"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.url.URL.</span></code></a><code class="sig-name descname">get_dialect</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.url.URL.get_dialect" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.engine.url.URL"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.engine.url.URL.</span></code></a><code class="sig-name descname">translate_connect_args</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">names</span><span class="o">=</span><span class="default_value">[]</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.engine.url.URL.translate_connect_args" title="Permalink to this definition">¶</a></dt>
...
<div class="section" id="custom-dbapi-connect-arguments-on-connect-routines">
<span id="custom-dbapi-args"></span><h2>Custom DBAPI connect() arguments / on-connect routines<a class="headerlink" href="#custom-dbapi-connect-arguments-on-connect-routines" title="Permalink to this headline">¶</a></h2>
...
<div class="section" id="special-keyword-arguments-passed-to-dbapi-connect">
<h3>Special Keyword Arguments Passed to dbapi.connect()<a class="headerlink" href="#special-keyword-arguments-passed-to-dbapi-connect" title="Permalink to this headline">¶</a></h3>
<p>For special arguments that must be passed to the DBAPI for which the
SQLAlchemy dialect does not parse from the query string correctly,
the <a class="reference internal" href="#sqlalchemy.create_engine.params.connect_args" title="sqlalchemy.create_engine"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">create_engine.connect_args</span></code></a> dictionary can be used.
...
that replaces the underlying implementation the connection:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">engine</span> <span class="o">=</span> <span class="n">create_engine</span><span class="p">(</span>
    <span class="s2">&quot;postgresql://user:pass@hostname/dbname&quot;</span><span class="p">,</span>
...
<div class="section" id="controlling-how-parameters-are-passed-to-the-dbapi-connect-function">
<h3>Controlling how parameters are passed to the DBAPI connect() function<a class="headerlink" href="#controlling-how-parameters-are-passed-to-the-dbapi-connect-function" title="Permalink to this headline">¶</a></h3>
<p>At the next level, we can customize how the DBAPI <code class="docutils literal notranslate"><span class="pre">connect()</span></code> function
itself is called using the <a class="reference internal" href="events.html#sqlalchemy.events.DialectEvents.do_connect" title="sqlalchemy.events.DialectEvents.do_connect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">DialectEvents.do_connect()</span></code></a> event hook.
This hook is passed the full <code class="docutils literal notranslate"><span class="pre">*args,</span> <span class="pre">**kwargs</span></code> that the dialect would
send to <code class="docutils literal notranslate"><span class="pre">connect()</span></code>.  These collections can then be modified in place
to alter how they are used:</p>
...
<span class="n">engine</span> <span class="o">=</span> <span class="n">create_engine</span><span class="p">(</span><span class="s2">&quot;postgresql://user:pass@hostname/dbname&quot;</span><span class="p">)</span>
...
<span class="k">def</span> <span class="nf">receive_do_connect</span><span class="p">(</span><span class="n">dialect</span><span class="p">,</span> <span class="n">conn_rec</span><span class="p">,</span> <span class="n">cargs</span><span class="p">,</span> <span class="n">cparams</span><span class="p">):</span>
    <span class="n">cparams</span><span class="p">[</span><span class="s1">&#39;connection_factory&#39;</span><span class="p">]</span> <span class="o">=</span> <span class="n">MyConnectionFactory</span></pre></div>
</div>
</div>
<div class="section" id="modifying-the-dbapi-connection-after-connect-or-running-commands-after-connect">
<h3>Modifying the DBAPI connection after connect, or running commands after connect<a class="headerlink" href="#modifying-the-dbapi-connection-after-connect-or-running-commands-after-connect" title="Permalink to this headline">¶</a></h3>
...
<span class="n">engine</span> <span class="o">=</span> <span class="n">create_engine</span><span class="p">(</span>
    <span class="s2">&quot;postgresql://user:pass@hostname/dbname&quot;</span>
<span class="p">)</span>
...
<span class="k">def</span> <span class="nf">connect</span><span class="p">(</span><span class="n">dbapi_connection</span><span class="p">,</span> <span class="n">connection_record</span><span class="p">):</span>
    ...
    <span class="n">cursor</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="s2">&quot;SET some session variables&quot;</span><span class="p">)</span>
    <span class="n">cursor</span><span class="o">.</span><span class="n">close</span><span class="p">()</span></pre></div>
</div>
</div>
<div class="section" id="fully-replacing-the-dbapi-connect-function">
<h3>Fully Replacing the DBAPI <code class="docutils literal notranslate"><span class="pre">connect()</span></code> function<a class="headerlink" href="#fully-replacing-the-dbapi-connect-function" title="Permalink to this headline">¶</a></h3>
...
<a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> object that’s active in a transaction, won’t
...
<a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a>, this is after the current transaction ends
and a new one begins).</p>
</div>
<div class="section" id="more-on-the-echo-flag">
<h3>More on the Echo Flag<a class="headerlink" href="#more-on-the-echo-flag" title="Permalink to this headline">¶</a></h3>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">create_engine</span><span class="p">,</span> <span class="n">text</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">e</span> <span class="o">=</span> <span class="n">create_engine</span><span class="p">(</span><span class="s2">&quot;sqlite://&quot;</span><span class="p">,</span> <span class="n">echo</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">echo_pool</span><span class="o">=</span><span class="s1">&#39;debug&#39;</span><span class="p">)</span>
...
<span class="gp">... </span>   <span class="nb">print</span><span class="p">(</span><span class="n">conn</span><span class="o">.</span><span class="n">scalar</span><span class="p">(</span><span class="n">text</span><span class="p">(</span><span class="s2">&quot;select &#39;hi&#39;&quot;</span><span class="p">)))</span>
<span class="gp">...</span>
...
<div class="section" id="setting-the-logging-name">
<h3>Setting the Logging Name<a class="headerlink" href="#setting-the-logging-name" title="Permalink to this headline">¶</a></h3>
<p>The logger name of instance such as an <a class="reference internal" href="connections.html#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a> or
<a class="reference internal" href="pooling.html#sqlalchemy.pool.Pool" title="sqlalchemy.pool.Pool"><code class="xref py py-class docutils literal notranslate"><span class="pre">Pool</span></code></a> defaults to using a truncated hex identifier
...
<a class="reference internal" href="#sqlalchemy.create_engine.params.pool_logging_name" title="sqlalchemy.create_engine"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">create_engine.pool_logging_name</span></code></a>  with
<a class="reference internal" href="#sqlalchemy.create_engine" title="sqlalchemy.create_engine"><code class="xref py py-func docutils literal notranslate"><span class="pre">create_engine()</span></code></a>:</p>
...
<span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">text</span>
<span class="gp">&gt;&gt;&gt; </span><span class="n">e</span> <span class="o">=</span> <span class="n">create_engine</span><span class="p">(</span><span class="s2">&quot;sqlite://&quot;</span><span class="p">,</span> <span class="n">echo</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">logging_name</span><span class="o">=</span><span class="s1">&#39;myengine&#39;</span><span class="p">)</span>
<span class="gp">&gt;&gt;&gt; </span><span class="k">with</span> <span class="n">e</span><span class="o">.</span><span class="n">connect</span><span class="p">()</span> <span class="k">as</span> <span class="n">conn</span><span class="p">:</span>
...
<div class="section" id="hiding-parameters">
<h3>Hiding Parameters<a class="headerlink" href="#hiding-parameters" title="Permalink to this headline">¶</a></h3>
