...
<li class="selected"><span class="link-container"><strong>Defining Constraints and Indexes</strong><a class="paramlink headerlink reference internal" href="#">¶</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#defining-foreign-keys">Defining Foreign Keys</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#creating-dropping-foreign-key-constraints-via-alter">Creating/Dropping Foreign Key Constraints via ALTER</a></span></li>
<li><span class="link-container"><a class="reference external" href="#on-update-and-on-delete">ON UPDATE and ON DELETE</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#unique-constraint">UNIQUE Constraint</a></span></li>
<li><span class="link-container"><a class="reference external" href="#check-constraint">CHECK Constraint</a></span></li>
<li><span class="link-container"><a class="reference external" href="#primary-key-constraint">PRIMARY KEY Constraint</a></span></li>
<li><span class="link-container"><a class="reference external" href="#setting-up-constraints-when-using-the-declarative-orm-extension">Setting up Constraints when using the Declarative ORM Extension</a></span></li>
<li><span class="link-container"><a class="reference external" href="#configuring-constraint-naming-conventions">Configuring Constraint Naming Conventions</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#naming-check-constraints">Naming CHECK Constraints</a></span></li>
<li><span class="link-container"><a class="reference external" href="#configuring-naming-for-boolean-enum-and-other-schema-types">Configuring Naming for Boolean, Enum, and other schema types</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#constraints-api">Constraints API</a></span></li>
<li><span class="link-container"><a class="reference external" href="#indexes">Indexes</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#functional-indexes">Functional Indexes</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#index-api">Index API</a></span></li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="api_basics.html">Core API Basics</a></span></li>
    ...
    <div id="docs-body" class="withsidebar core-constraints" >
        
<div class="section" id="defining-constraints-and-indexes">
<span id="metadata-constraints"></span><span id="metadata-constraints-toplevel"></span><h1>Defining Constraints and Indexes<a class="headerlink" href="#defining-constraints-and-indexes" title="Permalink to this headline">¶</a></h1>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">user_preference</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span><span class="s1">&#39;user_preference&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="p">,</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">invoice</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span><span class="s1">&#39;invoice&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="p">,</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">invoice_item</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span><span class="s1">&#39;invoice_item&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="p">,</span>
...
<div class="highlight-sql notranslate"><div class="highlight"><pre><span></span><span class="k">CREATE</span> <span class="k">TABLE</span> <span class="n">addresses</span> <span class="p">(</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sqlalchemy</span><span class="o">.</span><span class="n">exc</span><span class="o">.</span><span class="n">CircularDependencyError</span><span class="p">:</span> <span class="n">Can</span><span class="s1">&#39;t sort tables for DROP;</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sqlalchemy</span><span class="o">.</span><span class="n">exc</span><span class="o">.</span><span class="n">CompileError</span><span class="p">:</span> <span class="n">Can</span><span class="s1">&#39;t emit DROP CONSTRAINT for constraint</span>
...
<p><span class="versionmodified changed">Changed in version 1.0.0: </span>- The DDL system invoked by
<a class="reference internal" href="metadata.html#sqlalchemy.schema.MetaData.create_all" title="sqlalchemy.schema.MetaData.create_all"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MetaData.create_all()</span></code></a>
and <a class="reference internal" href="metadata.html#sqlalchemy.schema.MetaData.drop_all" title="sqlalchemy.schema.MetaData.drop_all"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MetaData.drop_all()</span></code></a> will now automatically resolve mutually
dependent foreign keys between tables declared by
<a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint" title="sqlalchemy.schema.ForeignKeyConstraint"><code class="xref py py-class docutils literal notranslate"><span class="pre">ForeignKeyConstraint</span></code></a> and <a class="reference internal" href="#sqlalchemy.schema.ForeignKey" title="sqlalchemy.schema.ForeignKey"><code class="xref py py-class docutils literal notranslate"><span class="pre">ForeignKey</span></code></a> objects, without
the need to explicitly set the <a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint.params.use_alter" title="sqlalchemy.schema.ForeignKeyConstraint"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">ForeignKeyConstraint.use_alter</span></code></a>
flag.</p>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in version 1.0.0: </span>- The <a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint.params.use_alter" title="sqlalchemy.schema.ForeignKeyConstraint"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">ForeignKeyConstraint.use_alter</span></code></a>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">child</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span><span class="s1">&#39;child&#39;</span><span class="p">,</span> <span class="n">meta</span><span class="p">,</span>
...
<p>Note that these clauses require <code class="docutils literal notranslate"><span class="pre">InnoDB</span></code> tables when used with MySQL.
They may also not be supported on other databases.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
...
<p><a class="reference internal" href="../orm/cascades.html#passive-deletes"><span class="std std-ref">Using foreign key ON DELETE cascade with ORM relationships</span></a></p>
<p><a class="reference internal" href="../orm/cascades.html#passive-deletes-many-to-many"><span class="std std-ref">Using foreign key ON DELETE with many-to-many relationships</span></a></p>
</div>
</div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">PrimaryKeyConstraint</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">user_table</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span><span class="s1">&#39;user&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="p">,</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="kn">from</span> <span class="nn">sqlalchemy.sql.schema</span> <span class="k">import</span> <span class="n">DEFAULT_NAMING_CONVENTION</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">metadata</span> <span class="o">=</span> <span class="n">MetaData</span><span class="p">(</span><span class="n">naming_convention</span><span class="o">=</span><span class="p">{</span>
    <span class="s2">&quot;uq&quot;</span><span class="p">:</span> <span class="s2">&quot;uq_</span><span class="si">%(table_name)s</span><span class="s2">_</span><span class="si">%(column_0_N_name)s</span><span class="s2">&quot;</span>
<span class="p">})</span>

<span class="n">long_names</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span>
    <span class="s1">&#39;long_names&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="p">,</span>
    <span class="n">Column</span><span class="p">(</span><span class="s1">&#39;information_channel_code&#39;</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">key</span><span class="o">=</span><span class="s1">&#39;a&#39;</span><span class="p">),</span>
    <span class="n">Column</span><span class="p">(</span><span class="s1">&#39;billing_convention_name&#39;</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">key</span><span class="o">=</span><span class="s1">&#39;b&#39;</span><span class="p">),</span>
    <span class="n">Column</span><span class="p">(</span><span class="s1">&#39;product_identifier&#39;</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">key</span><span class="o">=</span><span class="s1">&#39;c&#39;</span><span class="p">),</span>
    <span class="n">UniqueConstraint</span><span class="p">(</span><span class="s1">&#39;a&#39;</span><span class="p">,</span> <span class="s1">&#39;b&#39;</span><span class="p">,</span> <span class="s1">&#39;c&#39;</span><span class="p">)</span>
<span class="p">)</span></pre></div>
</div>
<p>On the PostgreSQL dialect, names longer than 63 characters will be truncated
as in the following example:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">CREATE</span> <span class="n">TABLE</span> <span class="n">long_names</span> <span class="p">(</span>
    <span class="n">information_channel_code</span> <span class="n">INTEGER</span><span class="p">,</span>
    <span class="n">billing_convention_name</span> <span class="n">INTEGER</span><span class="p">,</span>
    <span class="n">product_identifier</span> <span class="n">INTEGER</span><span class="p">,</span>
    <span class="n">CONSTRAINT</span> <span class="n">uq_long_names_information_channel_code_billing_conventi_a79e</span>
    <span class="n">UNIQUE</span> <span class="p">(</span><span class="n">information_channel_code</span><span class="p">,</span> <span class="n">billing_convention_name</span><span class="p">,</span> <span class="n">product_identifier</span><span class="p">)</span>
<span class="p">)</span></pre></div>
</div>
...
name as follows:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="n">metadata</span> <span class="o">=</span> <span class="n">MetaData</span><span class="p">(</span><span class="n">naming_convention</span><span class="o">=</span><span class="n">convention</span><span class="p">)</span>
...
<p><span class="versionmodified added">New in version 1.3.0: </span>added multi-column naming tokens such as <code class="docutils literal notranslate"><span class="pre">%(column_0_N_name)s</span></code>.
Generated names that go beyond the character limit for the target database will be
deterministically truncated.</p>
</div>
...
“column zero”.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 1.0.0: </span>The <a class="reference internal" href="#sqlalchemy.schema.CheckConstraint" title="sqlalchemy.schema.CheckConstraint"><code class="xref py py-class docutils literal notranslate"><span class="pre">CheckConstraint</span></code></a> object now supports
the <code class="docutils literal notranslate"><span class="pre">column_0_name</span></code> naming convention token.</p>
</div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">Table</span><span class="p">(</span><span class="s1">&#39;foo&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="p">,</span>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in version 1.0: </span>Constraint naming conventions that don’t include
<code class="docutils literal notranslate"><span class="pre">%(constraint_name)s</span></code> again work with <a class="reference internal" href="type_basics.html#sqlalchemy.types.SchemaType" title="sqlalchemy.types.SchemaType"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaType</span></code></a> constraints.</p>
</div>
</div>
</div>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.schema.CheckConstraint"><code class="sig-name descname">CheckConstraint</code></a></p></td>
<td><p>A table- or column-level CHECK constraint.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint"><code class="sig-name descname">ColumnCollectionConstraint</code></a></p></td>
<td><p>A constraint that proxies a ColumnCollection.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionMixin"><code class="sig-name descname">ColumnCollectionMixin</code></a></p></td>
<td></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.schema.Constraint"><code class="sig-name descname">Constraint</code></a></p></td>
<td><p>A table-level SQL constraint.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.schema.conv"><code class="sig-name descname">conv</code></a></p></td>
<td><p>Mark a string indicating that a name has already been converted
by a naming convention.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="sig-name descname">ForeignKey</code></a></p></td>
<td><p>Defines a dependency between two columns.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="sig-name descname">ForeignKeyConstraint</code></a></p></td>
<td><p>A table-level FOREIGN KEY constraint.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.schema.PrimaryKeyConstraint"><code class="sig-name descname">PrimaryKeyConstraint</code></a></p></td>
<td><p>A table-level PRIMARY KEY constraint.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.schema.UniqueConstraint"><code class="sig-name descname">UniqueConstraint</code></a></p></td>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.schema.</code><code class="sig-name descname">Constraint</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">name</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">deferrable</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">initially</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_create_rule</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">info</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_type_bound</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">dialect_kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.Constraint" title="Permalink to this definition">¶</a></dt>
<dd><p>A table-level SQL constraint.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.schema.Constraint" title="sqlalchemy.schema.Constraint"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.schema.Constraint</span></code></a> (<a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.sql.base.DialectKWArgs</span></code></a>, <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.schema.SchemaItem</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.schema.Constraint.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.Constraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Constraint.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">name</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">deferrable</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">initially</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_create_rule</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">info</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_type_bound</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">dialect_kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.Constraint.__init__" title="Permalink to this definition">¶</a></dt>
...
<li><p><span class="target" id="sqlalchemy.schema.Constraint.params.info"></span><strong>info</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.Constraint.params.info">¶</a> – <p>Optional data dictionary which will be populated into the
<a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.info" title="sqlalchemy.schema.SchemaItem.info"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.info</span></code></a> attribute of this object.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 1.0.0.</span></p>
</div>
</p></li>
<li><p><span class="target" id="sqlalchemy.schema.Constraint.params._create_rule"></span><strong>_create_rule</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.Constraint.params._create_rule">¶</a> – <p>a callable which is passed the DDLCompiler object during
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.schema.</code><code class="sig-name descname">ColumnCollectionMixin</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">columns</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionMixin" title="Permalink to this definition">¶</a></dt>
<dd><dl class="py attribute">
<dt id="sqlalchemy.schema.ColumnCollectionMixin.columns">
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionMixin"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionMixin.</span></code></a><code class="sig-name descname">columns</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionMixin.columns" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.schema.</code><code class="sig-name descname">ColumnCollectionConstraint</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">columns</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionConstraint" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionConstraint.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">columns</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionConstraint.__init__" title="Permalink to this definition">¶</a></dt>
...
for this constraint.</p></li>
<li><p><span class="target" id="sqlalchemy.schema.ColumnCollectionConstraint.params.**kw"></span><strong>**kw</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint.params.**kw">¶</a> – other keyword arguments including dialect-specific
arguments are propagated to the <a class="reference internal" href="#sqlalchemy.schema.Constraint" title="sqlalchemy.schema.Constraint"><code class="xref py py-class docutils literal notranslate"><span class="pre">Constraint</span></code></a> superclass.</p></li>
</ul>
</dd>
</dl>
</dd></dl>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionConstraint.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">argument_for</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">dialect_name</span></em>, <em class="sig-param"><span class="n">argument_name</span></em>, <em class="sig-param"><span class="n">default</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionConstraint.argument_for" title="Permalink to this definition">¶</a></dt>
...
<dt id="sqlalchemy.schema.ColumnCollectionConstraint.columns">
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionConstraint.</span></code></a><code class="sig-name descname">columns</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionConstraint.columns" title="Permalink to this definition">¶</a></dt>
<dd><p>A <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.expression.ColumnCollection" title="sqlalchemy.sql.expression.ColumnCollection"><code class="xref py py-class docutils literal notranslate"><span class="pre">ColumnCollection</span></code></a> representing the set of columns
for this constraint.</p>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.schema.ColumnCollectionConstraint.contains_column">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionConstraint.</span></code></a><code class="sig-name descname">contains_column</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">col</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionConstraint.contains_column" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionConstraint.</span></code></a><code class="sig-name descname">dialect_kwargs</code><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionConstraint.dialect_kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionConstraint.</span></code></a><code class="sig-name descname">dialect_options</code><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionConstraint.dialect_options" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionConstraint.</span></code></a><code class="sig-name descname">get_children</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionConstraint.get_children" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.get_children" title="sqlalchemy.schema.SchemaItem.get_children"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SchemaItem.get_children()</span></code></a> <em>method of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionConstraint.</span></code></a><code class="sig-name descname">info</code><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionConstraint.info" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionConstraint.</span></code></a><code class="sig-name descname">kwargs</code><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionConstraint.kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionConstraint.</span></code></a><code class="sig-name descname">quote</code><a class="headerlink" href="#sqlalchemy.schema.ColumnCollectionConstraint.quote" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.quote" title="sqlalchemy.schema.SchemaItem.quote"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.quote</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.schema.</code><code class="sig-name descname">CheckConstraint</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">sqltext</span></em>, <em class="sig-param"><span class="n">name</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">deferrable</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">initially</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">table</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">info</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_create_rule</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_autoattach</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">_type_bound</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.CheckConstraint" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.CheckConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.CheckConstraint.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">sqltext</span></em>, <em class="sig-param"><span class="n">name</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">deferrable</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">initially</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">table</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">info</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_create_rule</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_autoattach</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">_type_bound</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.CheckConstraint.__init__" title="Permalink to this definition">¶</a></dt>
...
for this constraint.</p></li>
<li><p><span class="target" id="sqlalchemy.schema.CheckConstraint.params.info"></span><strong>info</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.CheckConstraint.params.info">¶</a> – <p>Optional data dictionary which will be populated into the
<a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.info" title="sqlalchemy.schema.SchemaItem.info"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.info</span></code></a> attribute of this object.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 1.0.0.</span></p>
</div>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.CheckConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.CheckConstraint.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">argument_for</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">dialect_name</span></em>, <em class="sig-param"><span class="n">argument_name</span></em>, <em class="sig-param"><span class="n">default</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.CheckConstraint.argument_for" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.argument_for" title="sqlalchemy.sql.base.DialectKWArgs.argument_for"><code class="xref py py-meth docutils literal notranslate"><span class="pre">DialectKWArgs.argument_for()</span></code></a> <em>method of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>Add a new kind of dialect-specific keyword argument for this class.</p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.CheckConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.CheckConstraint.</span></code></a><code class="sig-name descname">contains_column</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">col</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.CheckConstraint.contains_column" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.CheckConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.CheckConstraint.</span></code></a><code class="sig-name descname">dialect_kwargs</code><a class="headerlink" href="#sqlalchemy.schema.CheckConstraint.dialect_kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.CheckConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.CheckConstraint.</span></code></a><code class="sig-name descname">dialect_options</code><a class="headerlink" href="#sqlalchemy.schema.CheckConstraint.dialect_options" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_options" title="sqlalchemy.sql.base.DialectKWArgs.dialect_options"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_options</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.CheckConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.CheckConstraint.</span></code></a><code class="sig-name descname">get_children</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.CheckConstraint.get_children" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.get_children" title="sqlalchemy.schema.SchemaItem.get_children"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SchemaItem.get_children()</span></code></a> <em>method of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>used to allow SchemaVisitor access</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.CheckConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.CheckConstraint.</span></code></a><code class="sig-name descname">info</code><a class="headerlink" href="#sqlalchemy.schema.CheckConstraint.info" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.info" title="sqlalchemy.schema.SchemaItem.info"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.info</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Info dictionary associated with the object, allowing user-defined
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.CheckConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.CheckConstraint.</span></code></a><code class="sig-name descname">kwargs</code><a class="headerlink" href="#sqlalchemy.schema.CheckConstraint.kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.kwargs" title="sqlalchemy.sql.base.DialectKWArgs.kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A synonym for <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a>.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.CheckConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.CheckConstraint.</span></code></a><code class="sig-name descname">quote</code><a class="headerlink" href="#sqlalchemy.schema.CheckConstraint.quote" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.quote" title="sqlalchemy.schema.SchemaItem.quote"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.quote</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Return the value of the <code class="docutils literal notranslate"><span class="pre">quote</span></code> flag passed
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.schema.</code><code class="sig-name descname">ForeignKey</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">column</span></em>, <em class="sig-param"><span class="n">_constraint</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">use_alter</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">name</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">onupdate</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">ondelete</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">deferrable</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">initially</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">link_to_name</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">match</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">info</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">dialect_kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKey" title="Permalink to this definition">¶</a></dt>
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.schema.ForeignKey" title="sqlalchemy.schema.ForeignKey"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey</span></code></a> (<a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.sql.base.DialectKWArgs</span></code></a>, <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.schema.SchemaItem</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.schema.ForeignKey.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">column</span></em>, <em class="sig-param"><span class="n">_constraint</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">use_alter</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">name</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">onupdate</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">ondelete</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">deferrable</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">initially</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">link_to_name</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">match</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">info</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">dialect_kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.__init__" title="Permalink to this definition">¶</a></dt>
...
<p><a class="reference internal" href="#use-alter"><span class="std std-ref">Creating/Dropping Foreign Key Constraints via ALTER</span></a></p>
</div>
</p></li>
...
and FULL.</p></li>
<li><p><span class="target" id="sqlalchemy.schema.ForeignKey.params.info"></span><strong>info</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.ForeignKey.params.info">¶</a> – <p>Optional data dictionary which will be populated into the
<a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.info" title="sqlalchemy.schema.SchemaItem.info"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.info</span></code></a> attribute of this object.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 1.0.0.</span></p>
</div>
</p></li>
<li><p><span class="target" id="sqlalchemy.schema.ForeignKey.params.**dialect_kw"></span><strong>**dialect_kw</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.ForeignKey.params.**dialect_kw">¶</a> – <p>Additional keyword arguments are dialect
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">argument_for</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">dialect_name</span></em>, <em class="sig-param"><span class="n">argument_name</span></em>, <em class="sig-param"><span class="n">default</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.argument_for" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.argument_for" title="sqlalchemy.sql.base.DialectKWArgs.argument_for"><code class="xref py py-meth docutils literal notranslate"><span class="pre">DialectKWArgs.argument_for()</span></code></a> <em>method of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>Add a new kind of dialect-specific keyword argument for this class.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">column</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.column" title="Permalink to this definition">¶</a></dt>
...
is raised.</p>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in version 0.9.0: </span>Foreign key target column resolution now occurs as soon as both
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">copy</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">schema</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.copy" title="Permalink to this definition">¶</a></dt>
<dd><p>Produce a copy of this <a class="reference internal" href="#sqlalchemy.schema.ForeignKey" title="sqlalchemy.schema.ForeignKey"><code class="xref py py-class docutils literal notranslate"><span class="pre">ForeignKey</span></code></a> object.</p>
<p>The new <a class="reference internal" href="#sqlalchemy.schema.ForeignKey" title="sqlalchemy.schema.ForeignKey"><code class="xref py py-class docutils literal notranslate"><span class="pre">ForeignKey</span></code></a> will not be bound
to any <a class="reference internal" href="metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal notranslate"><span class="pre">Column</span></code></a>.</p>
<p>This method is usually used by the internal
copy procedures of <a class="reference internal" href="metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal notranslate"><span class="pre">Column</span></code></a>, <a class="reference internal" href="metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal notranslate"><span class="pre">Table</span></code></a>,
and <a class="reference internal" href="metadata.html#sqlalchemy.schema.MetaData" title="sqlalchemy.schema.MetaData"><code class="xref py py-class docutils literal notranslate"><span class="pre">MetaData</span></code></a>.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><p><span class="target" id="sqlalchemy.schema.ForeignKey.copy.params.schema"></span><strong>schema</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.ForeignKey.copy.params.schema">¶</a> – The returned <a class="reference internal" href="#sqlalchemy.schema.ForeignKey" title="sqlalchemy.schema.ForeignKey"><code class="xref py py-class docutils literal notranslate"><span class="pre">ForeignKey</span></code></a> will
reference the original table and column name, qualified
by the given string schema name.</p>
</dd>
</dl>
</dd></dl>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">dialect_kwargs</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.dialect_kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">dialect_options</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.dialect_options" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_options" title="sqlalchemy.sql.base.DialectKWArgs.dialect_options"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_options</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">get_children</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.get_children" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.get_children" title="sqlalchemy.schema.SchemaItem.get_children"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SchemaItem.get_children()</span></code></a> <em>method of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>used to allow SchemaVisitor access</p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">get_referent</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">table</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.get_referent" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">info</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.info" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.info" title="sqlalchemy.schema.SchemaItem.info"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.info</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Info dictionary associated with the object, allowing user-defined
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">kwargs</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.kwargs" title="sqlalchemy.sql.base.DialectKWArgs.kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A synonym for <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a>.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">quote</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.quote" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.quote" title="sqlalchemy.schema.SchemaItem.quote"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.quote</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Return the value of the <code class="docutils literal notranslate"><span class="pre">quote</span></code> flag passed
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">references</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">table</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.references" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKey"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKey.</span></code></a><code class="sig-name descname">target_fullname</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKey.target_fullname" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.schema.</code><code class="sig-name descname">ForeignKeyConstraint</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">columns</span></em>, <em class="sig-param"><span class="n">refcolumns</span></em>, <em class="sig-param"><span class="n">name</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">onupdate</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">ondelete</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">deferrable</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">initially</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">use_alter</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">link_to_name</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">match</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">table</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">info</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">dialect_kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">columns</span></em>, <em class="sig-param"><span class="n">refcolumns</span></em>, <em class="sig-param"><span class="n">name</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">onupdate</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">ondelete</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">deferrable</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">initially</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">use_alter</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">link_to_name</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">match</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">table</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">info</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">dialect_kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.__init__" title="Permalink to this definition">¶</a></dt>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in version 1.0.0: </span>Automatic resolution of foreign key
cycles has been added, removing the need to use the
<a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint.params.use_alter" title="sqlalchemy.schema.ForeignKeyConstraint"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">ForeignKeyConstraint.use_alter</span></code></a> in typical use
cases.</p>
</div>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
...
DDL for this constraint. Typical values include SIMPLE, PARTIAL
and FULL.</p></li>
<li><p><span class="target" id="sqlalchemy.schema.ForeignKeyConstraint.params.info"></span><strong>info</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint.params.info">¶</a> – <p>Optional data dictionary which will be populated into the
<a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.info" title="sqlalchemy.schema.SchemaItem.info"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.info</span></code></a> attribute of this object.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 1.0.0.</span></p>
</div>
</p></li>
<li><p><span class="target" id="sqlalchemy.schema.ForeignKeyConstraint.params.**dialect_kw"></span><strong>**dialect_kw</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint.params.**dialect_kw">¶</a> – <p>Additional keyword arguments are dialect
specific, and passed in the form <code class="docutils literal notranslate"><span class="pre">&lt;dialectname&gt;_&lt;argname&gt;</span></code>.  See
the documentation regarding an individual dialect at
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">argument_for</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">dialect_name</span></em>, <em class="sig-param"><span class="n">argument_name</span></em>, <em class="sig-param"><span class="n">default</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.argument_for" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.argument_for" title="sqlalchemy.sql.base.DialectKWArgs.argument_for"><code class="xref py py-meth docutils literal notranslate"><span class="pre">DialectKWArgs.argument_for()</span></code></a> <em>method of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>Add a new kind of dialect-specific keyword argument for this class.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">column_keys</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.column_keys" title="Permalink to this definition">¶</a></dt>
...
<dl class="py attribute">
<dt id="sqlalchemy.schema.ForeignKeyConstraint.columns">
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">columns</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.columns" title="Permalink to this definition">¶</a></dt>
<dd><p>A <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.expression.ColumnCollection" title="sqlalchemy.sql.expression.ColumnCollection"><code class="xref py py-class docutils literal notranslate"><span class="pre">ColumnCollection</span></code></a> representing the set of columns
for this constraint.</p>
</dd></dl>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">contains_column</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">col</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.contains_column" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint.contains_column" title="sqlalchemy.schema.ColumnCollectionConstraint.contains_column"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ColumnCollectionConstraint.contains_column()</span></code></a> <em>method of</em> <a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint" title="sqlalchemy.schema.ColumnCollectionConstraint"><code class="xref py py-class docutils literal notranslate"><span class="pre">ColumnCollectionConstraint</span></code></a></p>
</div>
<p>Return True if this constraint contains the given column.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">dialect_kwargs</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.dialect_kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">dialect_options</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.dialect_options" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_options" title="sqlalchemy.sql.base.DialectKWArgs.dialect_options"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_options</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<dl class="py attribute">
<dt id="sqlalchemy.schema.ForeignKeyConstraint.elements">
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">elements</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.elements" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">get_children</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.get_children" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.get_children" title="sqlalchemy.schema.SchemaItem.get_children"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SchemaItem.get_children()</span></code></a> <em>method of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>used to allow SchemaVisitor access</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">info</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.info" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.info" title="sqlalchemy.schema.SchemaItem.info"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.info</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Info dictionary associated with the object, allowing user-defined
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">kwargs</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.kwargs" title="sqlalchemy.sql.base.DialectKWArgs.kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A synonym for <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a>.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">quote</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.quote" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.quote" title="sqlalchemy.schema.SchemaItem.quote"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.quote</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Return the value of the <code class="docutils literal notranslate"><span class="pre">quote</span></code> flag passed
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.ForeignKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.ForeignKeyConstraint.</span></code></a><code class="sig-name descname">referred_table</code><a class="headerlink" href="#sqlalchemy.schema.ForeignKeyConstraint.referred_table" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.schema.</code><code class="sig-name descname">PrimaryKeyConstraint</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">columns</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.PrimaryKeyConstraint" title="Permalink to this definition">¶</a></dt>
...
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in version 0.9.2: </span>Using a mixture of columns within a
<a class="reference internal" href="#sqlalchemy.schema.PrimaryKeyConstraint" title="sqlalchemy.schema.PrimaryKeyConstraint"><code class="xref py py-class docutils literal notranslate"><span class="pre">PrimaryKeyConstraint</span></code></a> in addition to columns marked as
<code class="docutils literal notranslate"><span class="pre">primary_key=True</span></code> now emits a warning if the lists don’t match.
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 0.9.2: </span>an empty <a class="reference internal" href="#sqlalchemy.schema.PrimaryKeyConstraint" title="sqlalchemy.schema.PrimaryKeyConstraint"><code class="xref py py-class docutils literal notranslate"><span class="pre">PrimaryKeyConstraint</span></code></a> may now
...
columns within the <a class="reference internal" href="metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal notranslate"><span class="pre">Table</span></code></a> itself; columns marked as
<code class="docutils literal notranslate"><span class="pre">primary_key=True</span></code> will be gathered into the empty constraint’s
column collection.</p>
</div>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.PrimaryKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.PrimaryKeyConstraint.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">argument_for</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">dialect_name</span></em>, <em class="sig-param"><span class="n">argument_name</span></em>, <em class="sig-param"><span class="n">default</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.PrimaryKeyConstraint.argument_for" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.argument_for" title="sqlalchemy.sql.base.DialectKWArgs.argument_for"><code class="xref py py-meth docutils literal notranslate"><span class="pre">DialectKWArgs.argument_for()</span></code></a> <em>method of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>Add a new kind of dialect-specific keyword argument for this class.</p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.PrimaryKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.PrimaryKeyConstraint.</span></code></a><code class="sig-name descname">contains_column</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">col</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.PrimaryKeyConstraint.contains_column" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint.contains_column" title="sqlalchemy.schema.ColumnCollectionConstraint.contains_column"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ColumnCollectionConstraint.contains_column()</span></code></a> <em>method of</em> <a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint" title="sqlalchemy.schema.ColumnCollectionConstraint"><code class="xref py py-class docutils literal notranslate"><span class="pre">ColumnCollectionConstraint</span></code></a></p>
</div>
<p>Return True if this constraint contains the given column.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.PrimaryKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.PrimaryKeyConstraint.</span></code></a><code class="sig-name descname">dialect_kwargs</code><a class="headerlink" href="#sqlalchemy.schema.PrimaryKeyConstraint.dialect_kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.PrimaryKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.PrimaryKeyConstraint.</span></code></a><code class="sig-name descname">dialect_options</code><a class="headerlink" href="#sqlalchemy.schema.PrimaryKeyConstraint.dialect_options" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_options" title="sqlalchemy.sql.base.DialectKWArgs.dialect_options"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_options</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.PrimaryKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.PrimaryKeyConstraint.</span></code></a><code class="sig-name descname">get_children</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.PrimaryKeyConstraint.get_children" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.get_children" title="sqlalchemy.schema.SchemaItem.get_children"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SchemaItem.get_children()</span></code></a> <em>method of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>used to allow SchemaVisitor access</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.PrimaryKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.PrimaryKeyConstraint.</span></code></a><code class="sig-name descname">info</code><a class="headerlink" href="#sqlalchemy.schema.PrimaryKeyConstraint.info" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.info" title="sqlalchemy.schema.SchemaItem.info"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.info</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Info dictionary associated with the object, allowing user-defined
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.PrimaryKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.PrimaryKeyConstraint.</span></code></a><code class="sig-name descname">kwargs</code><a class="headerlink" href="#sqlalchemy.schema.PrimaryKeyConstraint.kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.kwargs" title="sqlalchemy.sql.base.DialectKWArgs.kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A synonym for <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a>.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.PrimaryKeyConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.PrimaryKeyConstraint.</span></code></a><code class="sig-name descname">quote</code><a class="headerlink" href="#sqlalchemy.schema.PrimaryKeyConstraint.quote" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.quote" title="sqlalchemy.schema.SchemaItem.quote"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.quote</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Return the value of the <code class="docutils literal notranslate"><span class="pre">quote</span></code> flag passed
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.schema.</code><code class="sig-name descname">UniqueConstraint</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">columns</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.UniqueConstraint" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.UniqueConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.UniqueConstraint.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">columns</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.UniqueConstraint.__init__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
for this constraint.</p></li>
<li><p><span class="target" id="sqlalchemy.schema.UniqueConstraint.params.**kw"></span><strong>**kw</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.UniqueConstraint.params.**kw">¶</a> – other keyword arguments including dialect-specific
arguments are propagated to the <a class="reference internal" href="#sqlalchemy.schema.Constraint" title="sqlalchemy.schema.Constraint"><code class="xref py py-class docutils literal notranslate"><span class="pre">Constraint</span></code></a> superclass.</p></li>
</ul>
</dd>
</dl>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.UniqueConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.UniqueConstraint.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">argument_for</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">dialect_name</span></em>, <em class="sig-param"><span class="n">argument_name</span></em>, <em class="sig-param"><span class="n">default</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.UniqueConstraint.argument_for" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.argument_for" title="sqlalchemy.sql.base.DialectKWArgs.argument_for"><code class="xref py py-meth docutils literal notranslate"><span class="pre">DialectKWArgs.argument_for()</span></code></a> <em>method of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>Add a new kind of dialect-specific keyword argument for this class.</p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.UniqueConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.UniqueConstraint.</span></code></a><code class="sig-name descname">contains_column</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">col</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.UniqueConstraint.contains_column" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint.contains_column" title="sqlalchemy.schema.ColumnCollectionConstraint.contains_column"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ColumnCollectionConstraint.contains_column()</span></code></a> <em>method of</em> <a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionConstraint" title="sqlalchemy.schema.ColumnCollectionConstraint"><code class="xref py py-class docutils literal notranslate"><span class="pre">ColumnCollectionConstraint</span></code></a></p>
</div>
<p>Return True if this constraint contains the given column.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.UniqueConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.UniqueConstraint.</span></code></a><code class="sig-name descname">dialect_kwargs</code><a class="headerlink" href="#sqlalchemy.schema.UniqueConstraint.dialect_kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.UniqueConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.UniqueConstraint.</span></code></a><code class="sig-name descname">dialect_options</code><a class="headerlink" href="#sqlalchemy.schema.UniqueConstraint.dialect_options" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_options" title="sqlalchemy.sql.base.DialectKWArgs.dialect_options"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_options</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.UniqueConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.UniqueConstraint.</span></code></a><code class="sig-name descname">get_children</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.UniqueConstraint.get_children" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.get_children" title="sqlalchemy.schema.SchemaItem.get_children"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SchemaItem.get_children()</span></code></a> <em>method of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>used to allow SchemaVisitor access</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.UniqueConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.UniqueConstraint.</span></code></a><code class="sig-name descname">info</code><a class="headerlink" href="#sqlalchemy.schema.UniqueConstraint.info" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.info" title="sqlalchemy.schema.SchemaItem.info"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.info</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Info dictionary associated with the object, allowing user-defined
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.UniqueConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.UniqueConstraint.</span></code></a><code class="sig-name descname">kwargs</code><a class="headerlink" href="#sqlalchemy.schema.UniqueConstraint.kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.kwargs" title="sqlalchemy.sql.base.DialectKWArgs.kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A synonym for <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a>.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.UniqueConstraint"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.UniqueConstraint.</span></code></a><code class="sig-name descname">quote</code><a class="headerlink" href="#sqlalchemy.schema.UniqueConstraint.quote" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.quote" title="sqlalchemy.schema.SchemaItem.quote"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.quote</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Return the value of the <code class="docutils literal notranslate"><span class="pre">quote</span></code> flag passed
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.schema.</code><code class="sig-name descname">conv</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">value</span></em>, <em class="sig-param"><span class="n">quote</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.conv" title="Permalink to this definition">¶</a></dt>
...
<div class="highlight-python+sql notranslate"><div class="highlight"><pre><span></span><span class="n">meta</span> <span class="o">=</span> <span class="n">MetaData</span><span class="p">()</span>
<span class="n">mytable</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span><span class="s1">&#39;mytable&#39;</span><span class="p">,</span> <span class="n">meta</span><span class="p">,</span>
...
<div class="highlight-python+sql notranslate"><div class="highlight"><pre><span></span><span class="n">i</span> <span class="o">=</span> <span class="n">Index</span><span class="p">(</span><span class="s1">&#39;someindex&#39;</span><span class="p">,</span> <span class="n">mytable</span><span class="o">.</span><span class="n">c</span><span class="o">.</span><span class="n">col5</span><span class="p">)</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Index</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">func</span><span class="p">,</span> <span class="n">Index</span>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="sig-name descname">Index</code></a></p></td>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.schema.</code><code class="sig-name descname">Index</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">name</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">expressions</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.Index" title="Permalink to this definition">¶</a></dt>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 0.9.5: </span>the <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.expression.text" title="sqlalchemy.sql.expression.text"><code class="xref py py-func docutils literal notranslate"><span class="pre">text()</span></code></a>
construct may be used to
specify <a class="reference internal" href="#sqlalchemy.schema.Index" title="sqlalchemy.schema.Index"><code class="xref py py-class docutils literal notranslate"><span class="pre">Index</span></code></a> expressions, provided the <a class="reference internal" href="#sqlalchemy.schema.Index" title="sqlalchemy.schema.Index"><code class="xref py py-class docutils literal notranslate"><span class="pre">Index</span></code></a>
is explicitly associated with the <a class="reference internal" href="metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal notranslate"><span class="pre">Table</span></code></a>.</p>
</div>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#schema-indexes"><span class="std std-ref">Indexes</span></a> - General information on <a class="reference internal" href="#sqlalchemy.schema.Index" title="sqlalchemy.schema.Index"><code class="xref py py-class docutils literal notranslate"><span class="pre">Index</span></code></a>.</p>
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.schema.Index" title="sqlalchemy.schema.Index"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index</span></code></a> (<a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.sql.base.DialectKWArgs</span></code></a>, <a class="reference internal" href="#sqlalchemy.schema.ColumnCollectionMixin" title="sqlalchemy.schema.ColumnCollectionMixin"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.schema.ColumnCollectionMixin</span></code></a>, <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.schema.SchemaItem</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.schema.Index.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">name</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">expressions</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.Index.__init__" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="metadata.html#sqlalchemy.schema.Column.quote" title="sqlalchemy.schema.Column.quote"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Column.quote</span></code></a>.</p></li>
<li><p><span class="target" id="sqlalchemy.schema.Index.params.info"></span><strong>info=None</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.Index.params.info">¶</a> – <p>Optional data dictionary which will be populated
into the <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.info" title="sqlalchemy.schema.SchemaItem.info"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.info</span></code></a> attribute of this object.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 1.0.0.</span></p>
</div>
</p></li>
<li><p><span class="target" id="sqlalchemy.schema.Index.params.**kw"></span><strong>**kw</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.schema.Index.params.**kw">¶</a> – Additional keyword arguments not mentioned above are
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">argument_for</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">dialect_name</span></em>, <em class="sig-param"><span class="n">argument_name</span></em>, <em class="sig-param"><span class="n">default</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.Index.argument_for" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.argument_for" title="sqlalchemy.sql.base.DialectKWArgs.argument_for"><code class="xref py py-meth docutils literal notranslate"><span class="pre">DialectKWArgs.argument_for()</span></code></a> <em>method of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>Add a new kind of dialect-specific keyword argument for this class.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index.</span></code></a><code class="sig-name descname">bind</code><a class="headerlink" href="#sqlalchemy.schema.Index.bind" title="Permalink to this definition">¶</a></dt>
<dd><p>Return the connectable associated with this Index.</p>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.schema.Index.create">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index.</span></code></a><code class="sig-name descname">create</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">bind</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.Index.create" title="Permalink to this definition">¶</a></dt>
<dd><p>Issue a <code class="docutils literal notranslate"><span class="pre">CREATE</span></code> statement for this
<a class="reference internal" href="#sqlalchemy.schema.Index" title="sqlalchemy.schema.Index"><code class="xref py py-class docutils literal notranslate"><span class="pre">Index</span></code></a>, using the given <a class="reference internal" href="connections.html#sqlalchemy.engine.Connectable" title="sqlalchemy.engine.Connectable"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connectable</span></code></a>
for connectivity.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index.</span></code></a><code class="sig-name descname">dialect_kwargs</code><a class="headerlink" href="#sqlalchemy.schema.Index.dialect_kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index.</span></code></a><code class="sig-name descname">dialect_options</code><a class="headerlink" href="#sqlalchemy.schema.Index.dialect_options" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_options" title="sqlalchemy.sql.base.DialectKWArgs.dialect_options"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_options</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A collection of keyword arguments specified as dialect-specific
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index.</span></code></a><code class="sig-name descname">drop</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">bind</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.Index.drop" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index.</span></code></a><code class="sig-name descname">get_children</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.schema.Index.get_children" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.get_children" title="sqlalchemy.schema.SchemaItem.get_children"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SchemaItem.get_children()</span></code></a> <em>method of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>used to allow SchemaVisitor access</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index.</span></code></a><code class="sig-name descname">info</code><a class="headerlink" href="#sqlalchemy.schema.Index.info" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.info" title="sqlalchemy.schema.SchemaItem.info"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.info</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Info dictionary associated with the object, allowing user-defined
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index.</span></code></a><code class="sig-name descname">kwargs</code><a class="headerlink" href="#sqlalchemy.schema.Index.kwargs" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.kwargs" title="sqlalchemy.sql.base.DialectKWArgs.kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.kwargs</span></code></a> <em>attribute of</em> <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs" title="sqlalchemy.sql.base.DialectKWArgs"><code class="xref py py-class docutils literal notranslate"><span class="pre">DialectKWArgs</span></code></a></p>
</div>
<p>A synonym for <a class="reference internal" href="sqlelement.html#sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs" title="sqlalchemy.sql.base.DialectKWArgs.dialect_kwargs"><code class="xref py py-attr docutils literal notranslate"><span class="pre">DialectKWArgs.dialect_kwargs</span></code></a>.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.schema.Index"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.schema.Index.</span></code></a><code class="sig-name descname">quote</code><a class="headerlink" href="#sqlalchemy.schema.Index.quote" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem.quote" title="sqlalchemy.schema.SchemaItem.quote"><code class="xref py py-attr docutils literal notranslate"><span class="pre">SchemaItem.quote</span></code></a> <em>attribute of</em> <a class="reference internal" href="metadata.html#sqlalchemy.schema.SchemaItem" title="sqlalchemy.schema.SchemaItem"><code class="xref py py-class docutils literal notranslate"><span class="pre">SchemaItem</span></code></a></p>
</div>
<p>Return the value of the <code class="docutils literal notranslate"><span class="pre">quote</span></code> flag passed
