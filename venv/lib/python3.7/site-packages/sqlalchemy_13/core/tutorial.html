...
<li><span class="link-container"><a class="reference external" href="api_basics.html">Core API Basics</a></span></li>
    ...
    <div id="docs-body" class="withsidebar core-tutorial" >
...
connection, we will use the <a class="reference internal" href="connections.html#sqlalchemy.engine.Engine.connect" title="sqlalchemy.engine.Engine.connect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Engine.connect()</span></code></a> method:</p>
...
<p>If on the other hand we used a string column key, the usual rules of
