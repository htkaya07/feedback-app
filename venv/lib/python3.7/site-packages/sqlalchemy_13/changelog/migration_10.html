...
<li><span class="link-container"><a class="reference external" href="migration_04.html">What’s new in SQLAlchemy 0.4?</a></span></li>
    ...
    <div id="docs-body" class="withsidebar changelog-migration_10" >
...
value <code class="xref py py-data docutils literal notranslate"><span class="pre">NEVER_SET</span></code>, which is a value that may be sent
...
would be <code class="docutils literal notranslate"><span class="pre">None</span></code> before, it will now be the <code class="xref py py-data docutils literal notranslate"><span class="pre">NEVER_SET</span></code>
