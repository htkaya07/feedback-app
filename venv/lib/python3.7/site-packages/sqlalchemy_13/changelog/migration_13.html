...
<div id="docs-body-container">
    ...
    <div id="fixed-sidebar" class="withsidebar">
        ...
        <ul>
<li class="selected"><span class="link-container"><strong>What’s New in SQLAlchemy 1.3?</strong><a class="paramlink headerlink reference internal" href="#">¶</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#introduction">Introduction</a></span></li>
<li><span class="link-container"><a class="reference external" href="#general">General</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#deprecation-warnings-are-emitted-for-all-deprecated-elements-new-deprecations-added">Deprecation warnings are emitted for all deprecated elements; new deprecations added</a></span></li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="#relationship-to-aliasedclass-replaces-the-need-for-non-primary-mappers">Relationship to AliasedClass replaces the need for non primary mappers</a></span></li>
<li><span class="link-container"><a class="reference external" href="#selectin-loading-no-longer-uses-join-for-simple-one-to-many">selectin loading no longer uses JOIN for simple one-to-many</a></span></li>
<li><span class="link-container"><a class="reference external" href="#improvement-to-the-behavior-of-many-to-one-query-expressions">Improvement to the behavior of many-to-one query expressions</a></span></li>
<li><span class="link-container"><a class="reference external" href="#many-to-one-replacement-won-t-raise-for-raiseload-or-detached-for-old-object">Many-to-one replacement won’t raise for “raiseload” or detached for “old” object</a></span></li>
<li><span class="link-container"><a class="reference external" href="#del-implemented-for-orm-attributes">“del” implemented for ORM attributes</a></span></li>
<li><span class="link-container"><a class="reference external" href="#info-dictionary-added-to-instancestate">info dictionary added to InstanceState</a></span></li>
<li><span class="link-container"><a class="reference external" href="#horizontal-sharding-extension-supports-bulk-update-and-delete-methods">Horizontal Sharding extension supports bulk update and delete methods</a></span></li>
<li><span class="link-container"><a class="reference external" href="#association-proxy-improvements">Association Proxy Improvements</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#association-proxy-has-new-cascade-scalar-deletes-flag">Association proxy has new cascade_scalar_deletes flag</a></span></li>
<li><span class="link-container"><a class="reference external" href="#associationproxy-stores-class-specific-state-on-a-per-class-basis">AssociationProxy stores class-specific state on a per-class basis</a></span></li>
<li><span class="link-container"><a class="reference external" href="#associationproxy-now-provides-standard-column-operators-for-a-column-oriented-target">AssociationProxy now provides standard column operators for a column-oriented target</a></span></li>
<li><span class="link-container"><a class="reference external" href="#association-proxy-now-strong-references-the-parent-object">Association Proxy now Strong References the Parent Object</a></span></li>
<li><span class="link-container"><a class="reference external" href="#implemented-bulk-replace-for-sets-dicts-with-associationproxy">Implemented bulk replace for sets, dicts with AssociationProxy</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#many-to-one-backref-checks-for-collection-duplicates-during-remove-operation">Many-to-one backref checks for collection duplicates during remove operation</a></span></li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="#query-join-handles-ambiguity-in-deciding-the-left-side-more-explicitly">Query.join() handles ambiguity in deciding the “left” side more explicitly</a></span></li>
<li><span class="link-container"><a class="reference external" href="#for-update-clause-is-rendered-within-the-joined-eager-load-subquery-as-well-as-outside">FOR UPDATE clause is rendered within the joined eager load subquery as well as outside</a></span></li>
<li><span class="link-container"><a class="reference external" href="#passive-deletes-all-will-leave-fk-unchanged-for-object-removed-from-collection">passive_deletes=’all’ will leave FK unchanged for object removed from collection</a></span></li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="#new-multi-column-naming-convention-tokens-long-name-truncation">New multi-column naming convention tokens, long name truncation</a></span></li>
<li><span class="link-container"><a class="reference external" href="#binary-comparison-interpretation-for-sql-functions">Binary comparison interpretation for SQL functions</a></span></li>
<li><span class="link-container"><a class="reference external" href="#expanding-in-feature-now-supports-empty-lists">Expanding IN feature now supports empty lists</a></span></li>
<li><span class="link-container"><a class="reference external" href="#typeengine-methods-bind-expression-column-expression-work-with-variant-type-specific-types">TypeEngine methods bind_expression, column_expression work with Variant, type-specific types</a></span></li>
<li><span class="link-container"><a class="reference external" href="#new-last-in-first-out-strategy-for-queuepool">New last-in-first-out strategy for QueuePool</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#key-changes-core">Key Changes - Core</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#coercion-of-string-sql-fragments-to-text-fully-removed">Coercion of string SQL fragments to text() fully removed</a></span></li>
<li><span class="link-container"><a class="reference external" href="#threadlocal-engine-strategy-deprecated">“threadlocal” engine strategy deprecated</a></span></li>
<li><span class="link-container"><a class="reference external" href="#convert-unicode-parameters-deprecated">convert_unicode parameters deprecated</a></span></li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="#added-basic-reflection-support-for-postgresql-partitioned-tables">Added basic reflection support for PostgreSQL partitioned tables</a></span></li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="#protocol-level-ping-now-used-for-pre-ping">Protocol-level ping now used for pre-ping</a></span></li>
<li><span class="link-container"><a class="reference external" href="#control-of-parameter-ordering-within-on-duplicate-key-update">Control of parameter ordering within ON DUPLICATE KEY UPDATE</a></span></li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="#support-for-sqlite-json-added">Support for SQLite JSON Added</a></span></li>
<li><span class="link-container"><a class="reference external" href="#support-for-sqlite-on-conflict-in-constraints-added">Support for SQLite ON CONFLICT in constraints added</a></span></li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="#national-char-datatypes-de-emphasized-for-generic-unicode-re-enabled-with-option">National char datatypes de-emphasized for generic unicode, re-enabled with option</a></span></li>
<li><span class="link-container"><a class="reference external" href="#cx-oracle-connect-arguments-modernized-deprecated-parameters-removed">cx_Oracle connect arguments modernized, deprecated parameters removed</a></span></li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="#support-for-pyodbc-fast-executemany">Support for pyodbc fast_executemany</a></span></li>
<li><span class="link-container"><a class="reference external" href="#new-parameters-to-affect-identity-start-and-increment-use-of-sequence-deprecated">New parameters to affect IDENTITY start and increment, use of Sequence deprecated</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#changed-statementerror-formatting-newlines-and-s">Changed StatementError formatting (newlines and %s)</a></span></li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="migration_04.html">What’s new in SQLAlchemy 0.4?</a></span></li>
    ...
    <div id="docs-body" class="withsidebar changelog-migration_13" >
        
<div class="section" id="what-s-new-in-sqlalchemy-1-3">
<h1>What’s New in SQLAlchemy 1.3?<a class="headerlink" href="#what-s-new-in-sqlalchemy-1-3" title="Permalink to this headline">¶</a></h1>
...
<div class="section" id="deprecation-warnings-are-emitted-for-all-deprecated-elements-new-deprecations-added">
<span id="change-4393-general"></span><h3>Deprecation warnings are emitted for all deprecated elements; new deprecations added<a class="headerlink" href="#deprecation-warnings-are-emitted-for-all-deprecated-elements-new-deprecations-added" title="Permalink to this headline">¶</a></h3>
...
such as <a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session.params.weak_identity_map" title="sqlalchemy.orm.session.Session"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Session.weak_identity_map</span></code></a> and classes such as
<a class="reference internal" href="../orm/deprecated.html#sqlalchemy.orm.interfaces.MapperExtension" title="sqlalchemy.orm.interfaces.MapperExtension"><code class="xref py py-class docutils literal notranslate"><span class="pre">MapperExtension</span></code></a>.     While all deprecations have been noted in the
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4393">#4393</a></p>
</div>
</div>
...
<div class="section" id="relationship-to-aliasedclass-replaces-the-need-for-non-primary-mappers">
<span id="change-4423"></span><h3>Relationship to AliasedClass replaces the need for non primary mappers<a class="headerlink" href="#relationship-to-aliasedclass-replaces-the-need-for-non-primary-mappers" title="Permalink to this headline">¶</a></h3>
<p>The “non primary mapper” is a <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper" title="sqlalchemy.orm.mapper"><code class="xref py py-func docutils literal notranslate"><span class="pre">mapper()</span></code></a> created in the
<a class="reference internal" href="../orm/mapping_styles.html#classical-mapping"><span class="std std-ref">Classical Mappings</span></a> style, which acts as an additional mapper against an
...
anticipated that the <a class="reference internal" href="../orm/mapping_api.html#sqlalchemy.orm.mapper" title="sqlalchemy.orm.mapper"><code class="xref py py-func docutils literal notranslate"><span class="pre">mapper()</span></code></a> object was to be the primary query
construction interface, before the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal notranslate"><span class="pre">Query</span></code></a> object existed.</p>
<p>With the advent of <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal notranslate"><span class="pre">Query</span></code></a> and later the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.util.AliasedClass" title="sqlalchemy.orm.util.AliasedClass"><code class="xref py py-class docutils literal notranslate"><span class="pre">AliasedClass</span></code></a>
...
to the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.util.AliasedClass" title="sqlalchemy.orm.util.AliasedClass"><code class="xref py py-class docutils literal notranslate"><span class="pre">AliasedClass</span></code></a>.  The <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.util.AliasedClass" title="sqlalchemy.orm.util.AliasedClass"><code class="xref py py-class docutils literal notranslate"><span class="pre">AliasedClass</span></code></a> already does
...
were formerly for non primary mappers at <a class="reference internal" href="../orm/join_conditions.html#relationship-configure-joins"><span class="std std-ref">Configuring how Relationship Joins</span></a>
are changed to aliased class.</p>
<p>At <a class="reference internal" href="../orm/join_conditions.html#relationship-aliased-class"><span class="std std-ref">Relationship to Aliased Class</span></a>, the original non primary mapper looked
like:</p>
...
<span class="n">B_viacd</span> <span class="o">=</span> <span class="n">mapper</span><span class="p">(</span>
    <span class="n">B</span><span class="p">,</span> <span class="n">j</span><span class="p">,</span> <span class="n">non_primary</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">primary_key</span><span class="o">=</span><span class="p">[</span><span class="n">j</span><span class="o">.</span><span class="n">c</span><span class="o">.</span><span class="n">b_id</span><span class="p">],</span>
...
columns are referred towards directly when making the relationship:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">j</span> <span class="o">=</span> <span class="n">join</span><span class="p">(</span><span class="n">B</span><span class="p">,</span> <span class="n">D</span><span class="p">,</span> <span class="n">D</span><span class="o">.</span><span class="n">b_id</span> <span class="o">==</span> <span class="n">B</span><span class="o">.</span><span class="n">id</span><span class="p">)</span><span class="o">.</span><span class="n">join</span><span class="p">(</span><span class="n">C</span><span class="p">,</span> <span class="n">C</span><span class="o">.</span><span class="n">id</span> <span class="o">==</span> <span class="n">D</span><span class="o">.</span><span class="n">c_id</span><span class="p">)</span>
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4423">#4423</a></p>
</div>
<div class="section" id="selectin-loading-no-longer-uses-join-for-simple-one-to-many">
<span id="change-4340"></span><h3>selectin loading no longer uses JOIN for simple one-to-many<a class="headerlink" href="#selectin-loading-no-longer-uses-join-for-simple-one-to-many" title="Permalink to this headline">¶</a></h3>
...
<span class="k">class</span> <span class="nc">B</span><span class="p">(</span><span class="n">Base</span><span class="p">):</span>
    ...
    <span class="nb">id</span> <span class="o">=</span> <span class="n">Column</span><span class="p">(</span><span class="n">Integer</span><span class="p">,</span> <span class="n">primary_key</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
    <span class="n">a_id</span> <span class="o">=</span> <span class="n">Column</span><span class="p">(</span><span class="n">ForeignKey</span><span class="p">(</span><span class="s2">&quot;a.id&quot;</span><span class="p">))</span></pre></div>
</div>
<p>In the 1.2 version of “selectin” loading, a load of A to B looks like:</p>
<div class="highlight-sql notranslate"><div class="highlight"><pre><span></span><span class="k">SELECT</span> <span class="n">a</span><span class="p">.</span><span class="n">id</span> <span class="k">AS</span> <span class="n">a_id</span> <span class="k">FROM</span> <span class="n">a</span>
<span class="k">SELECT</span> <span class="n">a_1</span><span class="p">.</span><span class="n">id</span> <span class="k">AS</span> <span class="n">a_1_id</span><span class="p">,</span> <span class="n">b</span><span class="p">.</span><span class="n">id</span> <span class="k">AS</span> <span class="n">b_id</span><span class="p">,</span> <span class="n">b</span><span class="p">.</span><span class="n">a_id</span> <span class="k">AS</span> <span class="n">b_a_id</span>
<span class="k">FROM</span> <span class="n">a</span> <span class="k">AS</span> <span class="n">a_1</span> <span class="k">JOIN</span> <span class="n">b</span> <span class="k">ON</span> <span class="n">a_1</span><span class="p">.</span><span class="n">id</span> <span class="o">=</span> <span class="n">b</span><span class="p">.</span><span class="n">a_id</span>
<span class="k">WHERE</span> <span class="n">a_1</span><span class="p">.</span><span class="n">id</span> <span class="k">IN</span> <span class="p">(</span><span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">)</span> <span class="k">ORDER</span> <span class="k">BY</span> <span class="n">a_1</span><span class="p">.</span><span class="n">id</span>
<span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">,</span> <span class="mi">3</span><span class="p">,</span> <span class="mi">4</span><span class="p">,</span> <span class="mi">5</span><span class="p">,</span> <span class="mi">6</span><span class="p">,</span> <span class="mi">7</span><span class="p">,</span> <span class="mi">8</span><span class="p">,</span> <span class="mi">9</span><span class="p">,</span> <span class="mi">10</span><span class="p">)</span></pre></div>
</div>
<p>With the new behavior, the load looks like:</p>
<div class="highlight-sql notranslate"><div class="highlight"><pre><span></span><span class="k">SELECT</span> <span class="n">a</span><span class="p">.</span><span class="n">id</span> <span class="k">AS</span> <span class="n">a_id</span> <span class="k">FROM</span> <span class="n">a</span>
<span class="k">SELECT</span> <span class="n">b</span><span class="p">.</span><span class="n">a_id</span> <span class="k">AS</span> <span class="n">b_a_id</span><span class="p">,</span> <span class="n">b</span><span class="p">.</span><span class="n">id</span> <span class="k">AS</span> <span class="n">b_id</span> <span class="k">FROM</span> <span class="n">b</span>
<span class="k">WHERE</span> <span class="n">b</span><span class="p">.</span><span class="n">a_id</span> <span class="k">IN</span> <span class="p">(</span><span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">,</span> <span class="o">?</span><span class="p">)</span> <span class="k">ORDER</span> <span class="k">BY</span> <span class="n">b</span><span class="p">.</span><span class="n">a_id</span>
<span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">,</span> <span class="mi">3</span><span class="p">,</span> <span class="mi">4</span><span class="p">,</span> <span class="mi">5</span><span class="p">,</span> <span class="mi">6</span><span class="p">,</span> <span class="mi">7</span><span class="p">,</span> <span class="mi">8</span><span class="p">,</span> <span class="mi">9</span><span class="p">,</span> <span class="mi">10</span><span class="p">)</span></pre></div>
</div>
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4340">#4340</a></p>
</div>
<div class="section" id="improvement-to-the-behavior-of-many-to-one-query-expressions">
<span id="change-4359"></span><h3>Improvement to the behavior of many-to-one query expressions<a class="headerlink" href="#improvement-to-the-behavior-of-many-to-one-query-expressions" title="Permalink to this headline">¶</a></h3>
...
<a class="reference internal" href="../orm/session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a>, it would raise an error:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">u1</span> <span class="o">=</span> <span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">get</span><span class="p">(</span><span class="mi">5</span><span class="p">)</span>
...
object itself, only its <a class="reference internal" href="../orm/internals.html#sqlalchemy.orm.state.InstanceState" title="sqlalchemy.orm.state.InstanceState"><code class="xref py py-class docutils literal notranslate"><span class="pre">InstanceState</span></code></a>.</p>
...
<a class="reference internal" href="../orm/internals.html#sqlalchemy.orm.state.InstanceState" title="sqlalchemy.orm.state.InstanceState"><code class="xref py py-class docutils literal notranslate"><span class="pre">InstanceState</span></code></a> which will memoize the last known value for a
particular attribute on that state when that attribute is expired.  This
mechanism is only enabled for a specific attribute / <a class="reference internal" href="../orm/internals.html#sqlalchemy.orm.state.InstanceState" title="sqlalchemy.orm.state.InstanceState"><code class="xref py py-class docutils literal notranslate"><span class="pre">InstanceState</span></code></a>
...
<a class="reference internal" href="../orm/internals.html#sqlalchemy.orm.state.InstanceState" title="sqlalchemy.orm.state.InstanceState"><code class="xref py py-class docutils literal notranslate"><span class="pre">InstanceState</span></code></a> that tracks the last known value of a column attribute
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4359">#4359</a></p>
</div>
<div class="section" id="many-to-one-replacement-won-t-raise-for-raiseload-or-detached-for-old-object">
<span id="change-4353"></span><h3>Many-to-one replacement won’t raise for “raiseload” or detached for “old” object<a class="headerlink" href="#many-to-one-replacement-won-t-raise-for-raiseload-or-detached-for-old-object" title="Permalink to this headline">¶</a></h3>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">a1</span> <span class="o">=</span> <span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">Address</span><span class="p">)</span><span class="o">.</span><span class="n">filter_by</span><span class="p">(</span><span class="nb">id</span><span class="o">=</span><span class="mi">5</span><span class="p">)</span><span class="o">.</span><span class="n">one</span><span class="p">()</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">Address</span><span class="p">(</span><span class="n">Base</span><span class="p">):</span>
    ...
    <span class="n">user</span> <span class="o">=</span> <span class="n">relationship</span><span class="p">(</span><span class="s2">&quot;User&quot;</span><span class="p">,</span> <span class="o">...</span><span class="p">,</span> <span class="n">lazy</span><span class="o">=</span><span class="s2">&quot;raise&quot;</span><span class="p">)</span></pre></div>
</div>
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4353">#4353</a></p>
</div>
<div class="section" id="del-implemented-for-orm-attributes">
<span id="change-4354"></span><h3>“del” implemented for ORM attributes<a class="headerlink" href="#del-implemented-for-orm-attributes" title="Permalink to this headline">¶</a></h3>
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4354">#4354</a></p>
</div>
<div class="section" id="info-dictionary-added-to-instancestate">
<span id="change-4257"></span><h3>info dictionary added to InstanceState<a class="headerlink" href="#info-dictionary-added-to-instancestate" title="Permalink to this headline">¶</a></h3>
...
<span id="change-4196"></span><h3>Horizontal Sharding extension supports bulk update and delete methods<a class="headerlink" href="#horizontal-sharding-extension-supports-bulk-update-and-delete-methods" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="association-proxy-improvements">
<h3>Association Proxy Improvements<a class="headerlink" href="#association-proxy-improvements" title="Permalink to this headline">¶</a></h3>
...
<span id="change-4308"></span><h4>Association proxy has new cascade_scalar_deletes flag<a class="headerlink" href="#association-proxy-has-new-cascade-scalar-deletes-flag" title="Permalink to this headline">¶</a></h4>
...
<div class="section" id="associationproxy-stores-class-specific-state-on-a-per-class-basis">
<span id="change-3423"></span><h4>AssociationProxy stores class-specific state on a per-class basis<a class="headerlink" href="#associationproxy-stores-class-specific-state-on-a-per-class-basis" title="Permalink to this headline">¶</a></h4>
...
<div class="section" id="associationproxy-now-provides-standard-column-operators-for-a-column-oriented-target">
<span id="change-4351"></span><h4>AssociationProxy now provides standard column operators for a column-oriented target<a class="headerlink" href="#associationproxy-now-provides-standard-column-operators-for-a-column-oriented-target" title="Permalink to this headline">¶</a></h4>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">s</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">filter</span><span class="p">(</span><span class="n">User</span><span class="o">.</span><span class="n">values</span><span class="o">.</span><span class="n">like</span><span class="p">(</span><span class="s1">&#39;</span><span class="si">%f</span><span class="s1">oo%&#39;</span><span class="p">)))</span>
<span class="go">SELECT &quot;user&quot;.id AS user_id</span>
<span class="go">FROM &quot;user&quot;</span>
<span class="go">WHERE EXISTS (SELECT 1</span>
<span class="go">FROM element</span>
<span class="go">WHERE &quot;user&quot;.id = element.user_id AND element.value LIKE :value_1)</span></pre></div>
</div>
<p><code class="docutils literal notranslate"><span class="pre">equals</span></code>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">s</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">filter</span><span class="p">(</span><span class="n">User</span><span class="o">.</span><span class="n">values</span> <span class="o">==</span> <span class="s1">&#39;foo&#39;</span><span class="p">))</span>
<span class="go">SELECT &quot;user&quot;.id AS user_id</span>
<span class="go">FROM &quot;user&quot;</span>
<span class="go">WHERE EXISTS (SELECT 1</span>
<span class="go">FROM element</span>
<span class="go">WHERE &quot;user&quot;.id = element.user_id AND element.value = :value_1)</span></pre></div>
</div>
...
<span class="go">WHERE (EXISTS (SELECT 1</span>
<span class="go">FROM element</span>
<span class="go">WHERE &quot;user&quot;.id = element.user_id AND element.value IS NULL)) OR NOT (EXISTS (SELECT 1</span>
<span class="go">FROM element</span>
<span class="go">WHERE &quot;user&quot;.id = element.user_id))</span></pre></div>
</div>
<p>Note that the <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.operators.ColumnOperators.contains" title="sqlalchemy.sql.operators.ColumnOperators.contains"><code class="xref py py-meth docutils literal notranslate"><span class="pre">ColumnOperators.contains()</span></code></a> operator is in fact a string
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">s</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">filter</span><span class="p">(</span><span class="n">User</span><span class="o">.</span><span class="n">values</span><span class="o">.</span><span class="n">contains</span><span class="p">(</span><span class="s1">&#39;foo&#39;</span><span class="p">)))</span>
<span class="go">SELECT &quot;user&quot;.id AS user_id</span>
<span class="go">FROM &quot;user&quot;</span>
<span class="go">WHERE EXISTS (SELECT 1</span>
<span class="go">FROM element</span>
...
<span class="k">class</span> <span class="nc">UserElement</span><span class="p">(</span><span class="n">Base</span><span class="p">):</span>
    <span class="n">__tablename__</span> <span class="o">=</span> <span class="s1">&#39;user_element&#39;</span>
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4351">#4351</a></p>
</div>
<div class="section" id="association-proxy-now-strong-references-the-parent-object">
<h4>Association Proxy now Strong References the Parent Object<a class="headerlink" href="#association-proxy-now-strong-references-the-parent-object" title="Permalink to this headline">¶</a></h4>
...
<div class="section" id="implemented-bulk-replace-for-sets-dicts-with-associationproxy">
<span id="change-2642"></span><h4>Implemented bulk replace for sets, dicts with AssociationProxy<a class="headerlink" href="#implemented-bulk-replace-for-sets-dicts-with-associationproxy" title="Permalink to this headline">¶</a></h4>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">class</span> <span class="nc">A</span><span class="p">(</span><span class="n">Base</span><span class="p">):</span>
    ...
    <span class="n">b_rel</span> <span class="o">=</span> <span class="n">relationship</span><span class="p">(</span>
        <span class="s2">&quot;B&quot;</span><span class="p">,</span> <span class="n">collection_class</span><span class="o">=</span><span class="nb">set</span><span class="p">,</span> <span class="n">cascade</span><span class="o">=</span><span class="s2">&quot;all, delete-orphan&quot;</span><span class="p">,</span>
    <span class="p">)</span>
...
<span class="k">assert</span> <span class="nb">len</span><span class="p">(</span><span class="n">s</span><span class="o">.</span><span class="n">new</span><span class="p">)</span> <span class="o">==</span> <span class="mi">1</span></pre></div>
</div>
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/2642">#2642</a></p>
</div>
</div>
<div class="section" id="many-to-one-backref-checks-for-collection-duplicates-during-remove-operation">
<span id="change-1103"></span><h3>Many-to-one backref checks for collection duplicates during remove operation<a class="headerlink" href="#many-to-one-backref-checks-for-collection-duplicates-during-remove-operation" title="Permalink to this headline">¶</a></h3>
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/1103">#1103</a></p>
</div>
</div>
...
<div class="section" id="query-join-handles-ambiguity-in-deciding-the-left-side-more-explicitly">
<span id="change-4365"></span><h3>Query.join() handles ambiguity in deciding the “left” side more explicitly<a class="headerlink" href="#query-join-handles-ambiguity-in-deciding-the-left-side-more-explicitly" title="Permalink to this headline">¶</a></h3>
...
<span class="k">FROM</span> <span class="n">users</span> <span class="k">AS</span> <span class="n">users_1</span><span class="p">,</span> <span class="n">users</span> <span class="k">JOIN</span> <span class="n">addresses</span> <span class="k">ON</span> <span class="n">users</span><span class="p">.</span><span class="n">id</span> <span class="o">=</span> <span class="n">addresses</span><span class="p">.</span><span class="n">user_id</span></pre></div>
</div>
...
resolved:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sqlalchemy</span><span class="o">.</span><span class="n">exc</span><span class="o">.</span><span class="n">InvalidRequestError</span><span class="p">:</span> <span class="n">Can</span><span class="s1">&#39;t determine which FROM clause to</span>
<span class="n">join</span> <span class="n">from</span><span class="p">,</span> <span class="n">there</span> <span class="n">are</span> <span class="n">multiple</span> <span class="n">FROMS</span> <span class="n">which</span> <span class="n">can</span> <span class="n">join</span> <span class="n">to</span> <span class="n">this</span> <span class="n">entity</span><span class="o">.</span>
<span class="n">Try</span> <span class="n">adding</span> <span class="n">an</span> <span class="n">explicit</span> <span class="n">ON</span> <span class="n">clause</span> <span class="n">to</span> <span class="n">help</span> <span class="n">resolve</span> <span class="n">the</span> <span class="n">ambiguity</span><span class="o">.</span></pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sqlalchemy</span><span class="o">.</span><span class="n">exc</span><span class="o">.</span><span class="n">InvalidRequestError</span><span class="p">:</span> <span class="n">Don</span><span class="s1">&#39;t know how to join from</span>
<span class="n">CURRENT_TIMESTAMP</span><span class="p">;</span> <span class="n">please</span> <span class="n">use</span> <span class="n">select_from</span><span class="p">()</span> <span class="n">to</span> <span class="n">establish</span> <span class="n">the</span>
<span class="n">left</span> <span class="n">entity</span><span class="o">/</span><span class="n">selectable</span> <span class="n">of</span> <span class="n">this</span> <span class="n">join</span></pre></div>
</div>
<p>Now the query works fine:</p>
<div class="highlight-sql notranslate"><div class="highlight"><pre><span></span><span class="k">SELECT</span> <span class="k">CURRENT_TIMESTAMP</span> <span class="k">AS</span> <span class="n">current_timestamp_1</span><span class="p">,</span> <span class="n">users</span><span class="p">.</span><span class="n">id</span> <span class="k">AS</span> <span class="n">users_id</span><span class="p">,</span>
<span class="n">users</span><span class="p">.</span><span class="n">name</span> <span class="k">AS</span> <span class="n">users_name</span><span class="p">,</span> <span class="n">users</span><span class="p">.</span><span class="n">fullname</span> <span class="k">AS</span> <span class="n">users_fullname</span><span class="p">,</span>
<span class="n">users</span><span class="p">.</span><span class="n">password</span> <span class="k">AS</span> <span class="n">users_password</span>
<span class="k">FROM</span> <span class="n">users</span> <span class="k">JOIN</span> <span class="n">addresses</span> <span class="k">ON</span> <span class="n">users</span><span class="p">.</span><span class="n">id</span> <span class="o">=</span> <span class="n">addresses</span><span class="p">.</span><span class="n">user_id</span></pre></div>
</div>
<p>Overall the change is directly towards Python’s “explicit is better than
implicit” philosophy.</p>
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4365">#4365</a></p>
</div>
<div class="section" id="for-update-clause-is-rendered-within-the-joined-eager-load-subquery-as-well-as-outside">
<span id="change-4246"></span><h3>FOR UPDATE clause is rendered within the joined eager load subquery as well as outside<a class="headerlink" href="#for-update-clause-is-rendered-within-the-joined-eager-load-subquery-as-well-as-outside" title="Permalink to this headline">¶</a></h3>
...
or <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.limit" title="sqlalchemy.orm.query.Query.limit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.limit()</span></code></a>, as well as with use of the <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.with_for_update" title="sqlalchemy.orm.query.Query.with_for_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.with_for_update()</span></code></a> method.</p>
...
<span id="change-3844"></span><h3>passive_deletes=’all’ will leave FK unchanged for object removed from collection<a class="headerlink" href="#passive-deletes-all-will-leave-fk-unchanged-for-object-removed-from-collection" title="Permalink to this headline">¶</a></h3>
...
<span id="change-4268"></span><h2>New Features and Improvements - Core<a class="headerlink" href="#new-features-and-improvements-core" title="Permalink to this headline">¶</a></h2>
<div class="section" id="new-multi-column-naming-convention-tokens-long-name-truncation">
<span id="change-3989"></span><h3>New multi-column naming convention tokens, long name truncation<a class="headerlink" href="#new-multi-column-naming-convention-tokens-long-name-truncation" title="Permalink to this headline">¶</a></h3>
...
<span class="n">table</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span>
    <span class="s1">&#39;info&#39;</span><span class="p">,</span> <span class="n">metadata</span><span class="p">,</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">CREATE</span> <span class="n">TABLE</span> <span class="n">info</span> <span class="p">(</span>
    <span class="n">a</span> <span class="n">INTEGER</span><span class="p">,</span>
    <span class="n">b</span> <span class="n">INTEGER</span><span class="p">,</span>
    <span class="n">c</span> <span class="n">INTEGER</span><span class="p">,</span>
    <span class="n">CONSTRAINT</span> <span class="n">uq_info_a_b_c</span> <span class="n">UNIQUE</span> <span class="p">(</span><span class="n">a</span><span class="p">,</span> <span class="n">b</span><span class="p">,</span> <span class="n">c</span><span class="p">)</span>
<span class="p">)</span></pre></div>
</div>
...
<span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">UniqueConstraint</span>
<span class="kn">from</span> <span class="nn">sqlalchemy.dialects</span> <span class="k">import</span> <span class="n">postgresql</span>
<span class="kn">from</span> <span class="nn">sqlalchemy.schema</span> <span class="k">import</span> <span class="n">AddConstraint</span>
...
<p>will output:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sqlalchemy</span><span class="o">.</span><span class="n">exc</span><span class="o">.</span><span class="n">IdentifierError</span><span class="p">:</span> <span class="n">Identifier</span>
<span class="s1">&#39;this_is_too_long_of_a_name_for_any_database_backend_even_postgresql&#39;</span>
<span class="n">exceeds</span> <span class="n">maximum</span> <span class="n">length</span> <span class="n">of</span> <span class="mi">63</span> <span class="n">characters</span></pre></div>
</div>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">ALTER</span> <span class="n">TABLE</span> <span class="n">t</span> <span class="n">ADD</span> <span class="n">CONSTRAINT</span> <span class="n">this_is_too_long_of_a_name_for_any_database_backend_eve_ac05</span> <span class="n">UNIQUE</span> <span class="p">(</span><span class="n">x</span><span class="p">)</span></pre></div>
</div>
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/3989">#3989</a></p>
</div>
<div class="section" id="binary-comparison-interpretation-for-sql-functions">
<span id="change-3831"></span><h3>Binary comparison interpretation for SQL functions<a class="headerlink" href="#binary-comparison-interpretation-for-sql-functions" title="Permalink to this headline">¶</a></h3>
...
<span id="change-4271"></span><h3>Expanding IN feature now supports empty lists<a class="headerlink" href="#expanding-in-feature-now-supports-empty-lists" title="Permalink to this headline">¶</a></h3>
...
<span id="change-3981"></span><h3>TypeEngine methods bind_expression, column_expression work with Variant, type-specific types<a class="headerlink" href="#typeengine-methods-bind-expression-column-expression-work-with-variant-type-specific-types" title="Permalink to this headline">¶</a></h3>
...
<span id="change-pr467"></span><h3>New last-in-first-out strategy for QueuePool<a class="headerlink" href="#new-last-in-first-out-strategy-for-queuepool" title="Permalink to this headline">¶</a></h3>
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="../core/pooling.html#pool-use-lifo"><span class="std std-ref">Using FIFO vs. LIFO</span></a></p>
</div>
</div>
</div>
<div class="section" id="key-changes-core">
<h2>Key Changes - Core<a class="headerlink" href="#key-changes-core" title="Permalink to this headline">¶</a></h2>
<div class="section" id="coercion-of-string-sql-fragments-to-text-fully-removed">
<span id="change-4481"></span><h3>Coercion of string SQL fragments to text() fully removed<a class="headerlink" href="#coercion-of-string-sql-fragments-to-text-fully-removed" title="Permalink to this headline">¶</a></h3>
...
passed to methods like <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.filter" title="sqlalchemy.orm.query.Query.filter"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.filter()</span></code></a> and <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Select.order_by" title="sqlalchemy.sql.expression.Select.order_by"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Select.order_by()</span></code></a> being
...
In the case of <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Select.order_by" title="sqlalchemy.sql.expression.Select.order_by"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Select.order_by()</span></code></a>, <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.order_by" title="sqlalchemy.orm.query.Query.order_by"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.order_by()</span></code></a>,
<a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Select.group_by" title="sqlalchemy.sql.expression.Select.group_by"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Select.group_by()</span></code></a>, and <a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.group_by" title="sqlalchemy.orm.query.Query.group_by"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.group_by()</span></code></a>, a string label or column
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4481">#4481</a></p>
</div>
<div class="section" id="threadlocal-engine-strategy-deprecated">
<span id="change-4393-threadlocal"></span><h3>“threadlocal” engine strategy deprecated<a class="headerlink" href="#threadlocal-engine-strategy-deprecated" title="Permalink to this headline">¶</a></h3>
...
<span class="n">table</span><span class="o">.</span><span class="n">insert</span><span class="p">()</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="o">&lt;</span><span class="n">params</span><span class="o">&gt;</span><span class="p">)</span>
...
<span class="n">table</span><span class="o">.</span><span class="n">update</span><span class="p">()</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="o">&lt;</span><span class="n">params</span><span class="o">&gt;</span><span class="p">)</span>
...
<span class="k">try</span><span class="p">:</span>
    ...
    <span class="n">conn</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="n">table</span><span class="o">.</span><span class="n">insert</span><span class="p">(),</span> <span class="o">&lt;</span><span class="n">params</span><span class="o">&gt;</span><span class="p">)</span>
    ...
    <span class="n">conn</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="n">table</span><span class="o">.</span><span class="n">update</span><span class="p">(),</span> <span class="o">&lt;</span><span class="n">params</span><span class="o">&gt;</span><span class="p">)</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="k">with</span> <span class="n">engine</span><span class="o">.</span><span class="n">begin</span><span class="p">()</span> <span class="k">as</span> <span class="n">conn</span><span class="p">:</span>
    ...
    <span class="n">conn</span><span class="o">.</span><span class="n">execute</span><span class="p">(</span><span class="n">table</span><span class="o">.</span><span class="n">update</span><span class="p">(),</span> <span class="o">&lt;</span><span class="n">params</span><span class="o">&gt;</span><span class="p">)</span></pre></div>
</div>
...
<a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Engine.contextual_connect" title="sqlalchemy.engine.Engine.contextual_connect"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Engine.contextual_connect()</span></code></a> method, which is normally synonymous with
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="../core/connections.html#threadlocal-strategy"><span class="std std-ref">Using the Threadlocal Execution Strategy</span></a></p>
</div>
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4393">#4393</a></p>
</div>
<div class="section" id="convert-unicode-parameters-deprecated">
<span id="change-4393-convertunicode"></span><h3>convert_unicode parameters deprecated<a class="headerlink" href="#convert-unicode-parameters-deprecated" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="added-basic-reflection-support-for-postgresql-partitioned-tables">
<span id="change-4237"></span><h3>Added basic reflection support for PostgreSQL partitioned tables<a class="headerlink" href="#added-basic-reflection-support-for-postgresql-partitioned-tables" title="Permalink to this headline">¶</a></h3>
...
<span id="change-mysql-ping"></span><h3>Protocol-level ping now used for pre-ping<a class="headerlink" href="#protocol-level-ping-now-used-for-pre-ping" title="Permalink to this headline">¶</a></h3>
...
pool pre-ping feature, described at <a class="reference internal" href="../core/pooling.html#pool-disconnects-pessimistic"><span class="std std-ref">Disconnect Handling - Pessimistic</span></a>.
...
<span id="change-mysql-ondupordering"></span><h3>Control of parameter ordering within ON DUPLICATE KEY UPDATE<a class="headerlink" href="#control-of-parameter-ordering-within-on-duplicate-key-update" title="Permalink to this headline">¶</a></h3>
...
<span id="change-3850"></span><h3>Support for SQLite JSON Added<a class="headerlink" href="#support-for-sqlite-json-added" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="support-for-sqlite-on-conflict-in-constraints-added">
<span id="change-4360"></span><h3>Support for SQLite ON CONFLICT in constraints added<a class="headerlink" href="#support-for-sqlite-on-conflict-in-constraints-added" title="Permalink to this headline">¶</a></h3>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">some_table</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span>
    ...
    <span class="n">Column</span><span class="p">(</span><span class="s1">&#39;id&#39;</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">primary_key</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">sqlite_on_conflict_primary_key</span><span class="o">=</span><span class="s1">&#39;FAIL&#39;</span><span class="p">),</span>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">CREATE</span> <span class="n">TABLE</span> <span class="n">some_table</span> <span class="p">(</span>
    ...
    <span class="n">PRIMARY</span> <span class="n">KEY</span> <span class="p">(</span><span class="nb">id</span><span class="p">)</span> <span class="n">ON</span> <span class="n">CONFLICT</span> <span class="n">FAIL</span><span class="p">,</span>
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4360">#4360</a></p>
</div>
</div>
...
<span id="change-4242"></span><h3>National char datatypes de-emphasized for generic unicode, re-enabled with option<a class="headerlink" href="#national-char-datatypes-de-emphasized-for-generic-unicode-re-enabled-with-option" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="cx-oracle-connect-arguments-modernized-deprecated-parameters-removed">
<span id="change-4369"></span><h3>cx_Oracle connect arguments modernized, deprecated parameters removed<a class="headerlink" href="#cx-oracle-connect-arguments-modernized-deprecated-parameters-removed" title="Permalink to this headline">¶</a></h3>
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4369">#4369</a></p>
</div>
</div>
...
<span id="change-4158"></span><h3>Support for pyodbc fast_executemany<a class="headerlink" href="#support-for-pyodbc-fast-executemany" title="Permalink to this headline">¶</a></h3>
...
<div class="section" id="new-parameters-to-affect-identity-start-and-increment-use-of-sequence-deprecated">
<span id="change-4362"></span><h3>New parameters to affect IDENTITY start and increment, use of Sequence deprecated<a class="headerlink" href="#new-parameters-to-affect-identity-start-and-increment-use-of-sequence-deprecated" title="Permalink to this headline">¶</a></h3>
<p>SQL Server as of SQL Server 2012 now supports sequences with real
<code class="docutils literal notranslate"><span class="pre">CREATE</span> <span class="pre">SEQUENCE</span></code> syntax.  In <a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4235">#4235</a>, SQLAchemy will add support for
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">test</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span>
    ...
    <span class="n">Column</span><span class="p">(</span><span class="s1">&#39;number&#39;</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">autoincrement</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
<span class="p">)</span></pre></div>
</div>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4362">#4362</a></p>
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4235">#4235</a></p>
</div>
</div>
<div class="section" id="changed-statementerror-formatting-newlines-and-s">
<span id="change-4500"></span><h2>Changed StatementError formatting (newlines and %s)<a class="headerlink" href="#changed-statementerror-formatting-newlines-and-s" title="Permalink to this headline">¶</a></h2>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">sqlalchemy</span><span class="o">.</span><span class="n">exc</span><span class="o">.</span><span class="n">StatementError</span><span class="p">:</span> <span class="p">(</span><span class="n">sqlalchemy</span><span class="o">.</span><span class="n">exc</span><span class="o">.</span><span class="n">InvalidRequestError</span><span class="p">)</span> <span class="n">A</span> <span class="n">value</span> <span class="ow">is</span> <span class="n">required</span> <span class="k">for</span> <span class="n">bind</span> <span class="n">parameter</span> <span class="s1">&#39;id&#39;</span> <span class="p">[</span><span class="n">SQL</span><span class="p">:</span> <span class="s1">&#39;select * from reviews</span><span class="se">\n</span><span class="s1">where id = ?&#39;</span><span class="p">]</span> <span class="p">(</span><span class="n">Background</span> <span class="n">on</span> <span class="n">this</span> <span class="n">error</span> <span class="n">at</span><span class="p">:</span> <span class="n">http</span><span class="p">:</span><span class="o">//</span><span class="n">sqlalche</span><span class="o">.</span><span class="n">me</span><span class="o">/</span><span class="n">e</span><span class="o">/</span><span class="n">cd3x</span><span class="p">)</span></pre></div>
</div>
<p>Will now look like this:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span>sqlalchemy.exc.StatementError: (sqlalchemy.exc.InvalidRequestError) A value is required for bind parameter &#39;id&#39;
[SQL: select * from reviews
where id = ?]
(Background on this error at: http://sqlalche.me/e/cd3x)</pre></div>
</div>
...
<p><a class="reference external" href="http://www.sqlalchemy.org/trac/ticket/4500">#4500</a></p>
</div>
</div>
