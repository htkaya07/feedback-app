...
<li><span class="link-container"><a class="reference external" href="#table-values-row-and-tuple-objects">Table values, Row and Tuple objects</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#row-types">Row Types</a></span></li>
<li><span class="link-container"><a class="reference external" href="#table-types">Table Types</a></span></li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="#specfiying-multiple-fallback-hosts">Specfiying multiple fallback hosts</a></span></li>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.base.PGInspector"><code class="sig-name descname">PGInspector</code></a></p></td>
<td></td>
</tr>
</tbody>
</table>
...
<div class="section" id="table-values-row-and-tuple-objects">
<h2>Table values, Row and Tuple objects<a class="headerlink" href="#table-values-row-and-tuple-objects" title="Permalink to this headline">¶</a></h2>
<div class="section" id="row-types">
<h3>Row Types<a class="headerlink" href="#row-types" title="Permalink to this headline">¶</a></h3>
<p>Built-in support for rendering a <code class="docutils literal notranslate"><span class="pre">ROW</span></code> is not available yet, however the
<a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.tuple_" title="sqlalchemy.sql.expression.tuple_"><code class="xref py py-func docutils literal notranslate"><span class="pre">tuple_()</span></code></a> may be used in its place. Another alternative is
to use the <code class="xref py py-attr docutils literal notranslate"><span class="pre">sqlalchemy.func</span></code> generator with <code class="docutils literal notranslate"><span class="pre">func.ROW</span></code></p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">table</span><span class="o">.</span><span class="n">select</span><span class="p">()</span><span class="o">.</span><span class="n">where</span><span class="p">(</span>
    <span class="n">tuple_</span><span class="p">(</span><span class="n">table</span><span class="o">.</span><span class="n">c</span><span class="o">.</span><span class="n">id</span><span class="p">,</span> <span class="n">table</span><span class="o">.</span><span class="n">c</span><span class="o">.</span><span class="n">fk</span><span class="p">)</span> <span class="o">&gt;</span> <span class="p">(</span><span class="mi">1</span><span class="p">,</span><span class="mi">2</span><span class="p">)</span>
<span class="p">)</span><span class="o">.</span><span class="n">where</span><span class="p">(</span><span class="n">func</span><span class="o">.</span><span class="n">ROW</span><span class="p">(</span><span class="n">table</span><span class="o">.</span><span class="n">c</span><span class="o">.</span><span class="n">id</span><span class="p">,</span> <span class="n">table</span><span class="o">.</span><span class="n">c</span><span class="o">.</span><span class="n">fk</span><span class="p">)</span> <span class="o">&lt;</span> <span class="n">func</span><span class="o">.</span><span class="n">ROW</span><span class="p">(</span><span class="mi">3</span><span class="p">,</span> <span class="mi">7</span><span class="p">))</span></pre></div>
</div>
<p>Will generate the row-wise comparison:</p>
...
<span class="n">WHERE</span> <span class="p">(</span><span class="nb">id</span><span class="p">,</span> <span class="n">fk</span><span class="p">)</span> <span class="o">&gt;</span> <span class="p">(</span><span class="mi">1</span><span class="p">,</span> <span class="mi">2</span><span class="p">)</span>
<span class="n">AND</span> <span class="n">ROW</span><span class="p">(</span><span class="nb">id</span><span class="p">,</span> <span class="n">fk</span><span class="p">)</span> <span class="o">&lt;</span> <span class="n">ROW</span><span class="p">(</span><span class="mi">3</span><span class="p">,</span> <span class="mi">7</span><span class="p">)</span></pre></div>
</div>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
...
<h3>Table Types<a class="headerlink" href="#table-types" title="Permalink to this headline">¶</a></h3>
<p>PostgreSQL also supports passing a table as an argument to a function. This
is not available yet in sqlalchemy, however the
<a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.literal_column" title="sqlalchemy.sql.expression.literal_column"><code class="xref py py-func docutils literal notranslate"><span class="pre">literal_column()</span></code></a> function with the name of the table may be
used in its place:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">select</span><span class="p">([</span><span class="s1">&#39;*&#39;</span><span class="p">])</span><span class="o">.</span><span class="n">select_from</span><span class="p">(</span><span class="n">func</span><span class="o">.</span><span class="n">my_function</span><span class="p">(</span><span class="n">literal_column</span><span class="p">(</span><span class="s1">&#39;my_table&#39;</span><span class="p">)))</span></pre></div>
</div>
<p>Will generate the SQL:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">SELECT</span> <span class="o">*</span>
<span class="n">FROM</span> <span class="n">my_function</span><span class="p">(</span><span class="n">my_table</span><span class="p">)</span></pre></div>
</div>
</div>
</div>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.aggregate_order_by"><code class="sig-name descname">aggregate_order_by</code></a></p></td>
<td><p>Represent a PostgreSQL aggregate order by expression.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.All"><code class="sig-name descname">All</code></a>(other, arrexpr[, operator])</p></td>
...
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.Any"><code class="sig-name descname">Any</code></a>(other, arrexpr[, operator])</p></td>
...
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.array"><code class="sig-name descname">array</code></a></p></td>
<td><p>A PostgreSQL ARRAY literal.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.ARRAY"><code class="sig-name descname">ARRAY</code></a></p></td>
<td><p>PostgreSQL ARRAY type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.array_agg"><code class="sig-name descname">array_agg</code></a>(*arg, **kw)</p></td>
...
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.BIT"><code class="sig-name descname">BIT</code></a></p></td>
<td></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.BYTEA"><code class="sig-name descname">BYTEA</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.CIDR"><code class="sig-name descname">CIDR</code></a></p></td>
<td></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.DOUBLE_PRECISION"><code class="sig-name descname">DOUBLE_PRECISION</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.ENUM"><code class="sig-name descname">ENUM</code></a></p></td>
<td><p>PostgreSQL ENUM type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.HSTORE"><code class="sig-name descname">HSTORE</code></a></p></td>
<td><p>Represent the PostgreSQL HSTORE type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.hstore"><code class="sig-name descname">hstore</code></a></p></td>
...
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.INET"><code class="sig-name descname">INET</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.INTERVAL"><code class="sig-name descname">INTERVAL</code></a></p></td>
<td><p>PostgreSQL INTERVAL type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.JSON"><code class="sig-name descname">JSON</code></a></p></td>
<td><p>Represent the PostgreSQL JSON type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.JSONB"><code class="sig-name descname">JSONB</code></a></p></td>
<td><p>Represent the PostgreSQL JSONB type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.MACADDR"><code class="sig-name descname">MACADDR</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.MONEY"><code class="sig-name descname">MONEY</code></a></p></td>
<td><p>Provide the PostgreSQL MONEY type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.OID"><code class="sig-name descname">OID</code></a></p></td>
<td><p>Provide the PostgreSQL OID type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.REAL"><code class="sig-name descname">REAL</code></a></p></td>
<td><p>The SQL REAL type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.REGCLASS"><code class="sig-name descname">REGCLASS</code></a></p></td>
<td><p>Provide the PostgreSQL REGCLASS type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.TSVECTOR"><code class="sig-name descname">TSVECTOR</code></a></p></td>
...
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.UUID"><code class="sig-name descname">UUID</code></a></p></td>
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.postgresql.array" title="sqlalchemy.dialects.postgresql.array"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.postgresql.array</span></code></a> (<a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.Tuple" title="sqlalchemy.sql.expression.Tuple"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.sql.expression.Tuple</span></code></a>)</p>
</div>
</dd></dl>
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.postgresql.JSONB" title="sqlalchemy.dialects.postgresql.JSONB"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.postgresql.JSONB</span></code></a> (<code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.postgresql.json.JSON</span></code>)</p>
</div>
<dl class="py class">
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.DATERANGE"><code class="sig-name descname">DATERANGE</code></a></p></td>
<td><p>Represent the PostgreSQL DATERANGE type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.INT4RANGE"><code class="sig-name descname">INT4RANGE</code></a></p></td>
<td><p>Represent the PostgreSQL INT4RANGE type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.INT8RANGE"><code class="sig-name descname">INT8RANGE</code></a></p></td>
<td><p>Represent the PostgreSQL INT8RANGE type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.NUMRANGE"><code class="sig-name descname">NUMRANGE</code></a></p></td>
<td><p>Represent the PostgreSQL NUMRANGE type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.ranges.RangeOperators"><code class="sig-name descname">RangeOperators</code></a></p></td>
...
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.TSRANGE"><code class="sig-name descname">TSRANGE</code></a></p></td>
<td><p>Represent the PostgreSQL TSRANGE type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.TSTZRANGE"><code class="sig-name descname">TSTZRANGE</code></a></p></td>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.ExcludeConstraint"><code class="sig-name descname">ExcludeConstraint</code></a></p></td>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.insert"><code class="sig-name descname">insert</code></a>(table[, values, inline, bind, ...], **dialect_kw)</p></td>
...
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.postgresql.Insert"><code class="sig-name descname">Insert</code></a></p></td>
...
<div class="section" id="specfiying-multiple-fallback-hosts">
<span id="psycopg2-multi-host"></span><h3>Specfiying multiple fallback hosts<a class="headerlink" href="#specfiying-multiple-fallback-hosts" title="Permalink to this headline">¶</a></h3>
