...
<li><span class="link-container"><a class="reference external" href="sybase.html">Sybase</a></span></li>
    ...
    <div id="docs-body" class="withsidebar dialects-mssql" >
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.try_cast"><code class="sig-name descname">try_cast</code></a>(*arg, **kw)</p></td>
<td><p>Create a TRY_CAST expression.</p></td>
</tr>
</tbody>
</table>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.BIT"><code class="sig-name descname">BIT</code></a></p></td>
<td></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.CHAR"><code class="sig-name descname">CHAR</code></a></p></td>
<td><p>The SQL CHAR type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.DATETIME2"><code class="sig-name descname">DATETIME2</code></a></p></td>
<td></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.DATETIMEOFFSET"><code class="sig-name descname">DATETIMEOFFSET</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.IMAGE"><code class="sig-name descname">IMAGE</code></a></p></td>
<td></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.MONEY"><code class="sig-name descname">MONEY</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.NCHAR"><code class="sig-name descname">NCHAR</code></a></p></td>
<td><p>The SQL NCHAR type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.NTEXT"><code class="sig-name descname">NTEXT</code></a></p></td>
<td><p>MSSQL NTEXT type, for variable-length unicode text up to 2^30
characters.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.NVARCHAR"><code class="sig-name descname">NVARCHAR</code></a></p></td>
<td><p>The SQL NVARCHAR type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.REAL"><code class="sig-name descname">REAL</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.ROWVERSION"><code class="sig-name descname">ROWVERSION</code></a></p></td>
<td><p>Implement the SQL Server ROWVERSION type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.SMALLDATETIME"><code class="sig-name descname">SMALLDATETIME</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.SMALLMONEY"><code class="sig-name descname">SMALLMONEY</code></a></p></td>
<td></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.SQL_VARIANT"><code class="sig-name descname">SQL_VARIANT</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.TEXT"><code class="sig-name descname">TEXT</code></a></p></td>
<td><p>The SQL TEXT type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.TIME"><code class="sig-name descname">TIME</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.TIMESTAMP"><code class="sig-name descname">TIMESTAMP</code></a></p></td>
<td><p>Implement the SQL Server TIMESTAMP type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.TINYINT"><code class="sig-name descname">TINYINT</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.UNIQUEIDENTIFIER"><code class="sig-name descname">UNIQUEIDENTIFIER</code></a></p></td>
<td></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.VARCHAR"><code class="sig-name descname">VARCHAR</code></a></p></td>
<td><p>The SQL VARCHAR type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mssql.XML"><code class="sig-name descname">XML</code></a></p></td>
...
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mssql.CHAR" title="sqlalchemy.dialects.mssql.CHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mssql.CHAR</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.String" title="sqlalchemy.types.String"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.String</span></code></a>)</p>
</div>
<dl class="py method">
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mssql.NCHAR" title="sqlalchemy.dialects.mssql.NCHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mssql.NCHAR</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Unicode" title="sqlalchemy.types.Unicode"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.Unicode</span></code></a>)</p>
</div>
<dl class="py method">
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mssql.NVARCHAR" title="sqlalchemy.dialects.mssql.NVARCHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mssql.NVARCHAR</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Unicode" title="sqlalchemy.types.Unicode"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.Unicode</span></code></a>)</p>
</div>
<dl class="py method">
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mssql.ROWVERSION" title="sqlalchemy.dialects.mssql.ROWVERSION"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mssql.ROWVERSION</span></code></a> (<code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mssql.base.TIMESTAMP</span></code>)</p>
</div>
<dl class="py method">
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mssql.TEXT" title="sqlalchemy.dialects.mssql.TEXT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mssql.TEXT</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Text" title="sqlalchemy.types.Text"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.Text</span></code></a>)</p>
</div>
<dl class="py method">
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mssql.VARCHAR" title="sqlalchemy.dialects.mssql.VARCHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mssql.VARCHAR</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.String" title="sqlalchemy.types.String"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.String</span></code></a>)</p>
</div>
<dl class="py method">
...
<code class="docutils literal notranslate"><span class="pre">authentication</span></code> (e.g., <code class="docutils literal notranslate"><span class="pre">authentication=ActiveDirectoryIntegrated</span></code>).
...
<div class="section" id="pyodbc-pooling-connection-close-behavior">
<h3>Pyodbc Pooling / connection close behavior<a class="headerlink" href="#pyodbc-pooling-connection-close-behavior" title="Permalink to this headline">¶</a></h3>
...
feature is enabled by setting the flag <code class="docutils literal notranslate"><span class="pre">.fast_executemany</span></code> on the DBAPI
...
<code class="docutils literal notranslate"><span class="pre">.fast_executemany</span></code> flag is passed to
<a class="reference internal" href="../core/engines.html#sqlalchemy.create_engine" title="sqlalchemy.create_engine"><code class="xref py py-func docutils literal notranslate"><span class="pre">create_engine()</span></code></a> ; note that the ODBC driver must be the Microsoft
...
<p>The pyodbc fast_executemany mode <strong>buffers all rows in memory</strong> and is
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>pymssql is currently not included in SQLAlchemy’s continuous integration
(CI) testing.</p>
</div>
