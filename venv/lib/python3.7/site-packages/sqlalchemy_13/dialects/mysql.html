...
<li class="selected"><span class="link-container"><strong>MySQL</strong><a class="paramlink headerlink reference internal" href="#">¶</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql">Support for the MySQL database.</a></span></li>
<li><span class="link-container"><a class="reference external" href="#supported-versions-and-features">Supported Versions and Features</a></span></li>
<li><span class="link-container"><a class="reference external" href="#connection-timeouts-and-disconnects">Connection Timeouts and Disconnects</a></span></li>
<li><span class="link-container"><a class="reference external" href="#create-table-arguments-including-storage-engines">CREATE TABLE arguments including Storage Engines</a></span></li>
<li><span class="link-container"><a class="reference external" href="#case-sensitivity-and-table-reflection">Case Sensitivity and Table Reflection</a></span></li>
...
<li><span class="link-container"><a class="reference external" href="#auto-increment-behavior">AUTO_INCREMENT Behavior</a></span></li>
...
<li><span class="link-container"><a class="reference external" href="#charset-selection">Charset Selection</a></span></li>
<li><span class="link-container"><a class="reference external" href="#dealing-with-binary-data-warnings-and-unicode">Dealing with Binary Data Warnings and Unicode</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#ansi-quoting-style">ANSI Quoting Style</a></span></li>
<li><span class="link-container"><a class="reference external" href="#mysql-sql-extensions">MySQL SQL Extensions</a></span></li>
<li><span class="link-container"><a class="reference external" href="#insert-on-duplicate-key-update-upsert">INSERT…ON DUPLICATE KEY UPDATE (Upsert)</a></span></li>
<li><span class="link-container"><a class="reference external" href="#rowcount-support">rowcount Support</a></span></li>
<li><span class="link-container"><a class="reference external" href="#cast-support">CAST Support</a></span></li>
<li><span class="link-container"><a class="reference external" href="#mysql-specific-index-options">MySQL Specific Index Options</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#index-length">Index Length</a></span></li>
<li><span class="link-container"><a class="reference external" href="#index-prefixes">Index Prefixes</a></span></li>
<li><span class="link-container"><a class="reference external" href="#index-types">Index Types</a></span></li>
<li><span class="link-container"><a class="reference external" href="#index-parsers">Index Parsers</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#mysql-foreign-keys">MySQL Foreign Keys</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#foreign-key-arguments-to-avoid">Foreign Key Arguments to Avoid</a></span></li>
<li><span class="link-container"><a class="reference external" href="#reflection-of-foreign-key-constraints">Reflection of Foreign Key Constraints</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#mysql-unique-constraints-and-reflection">MySQL Unique Constraints and Reflection</a></span></li>
<li><span class="link-container"><a class="reference external" href="#timestamp-datetime-issues">TIMESTAMP / DATETIME issues</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#rendering-on-update-current-timestamp-for-mysql-s-explicit-defaults-for-timestamp">Rendering ON UPDATE CURRENT TIMESTAMP for MySQL’s explicit_defaults_for_timestamp</a></span></li>
<li><span class="link-container"><a class="reference external" href="#timestamp-columns-and-null">TIMESTAMP Columns and NULL</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#mysql-data-types">MySQL Data Types</a></span></li>
<li><span class="link-container"><a class="reference external" href="#mysql-dml-constructs">MySQL DML Constructs</a></span></li>
<li><span class="link-container"><a class="reference external" href="#module-sqlalchemy.dialects.mysql.mysqldb">mysqlclient (fork of MySQL-Python)</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-mysqldb-url">DBAPI</a></span></li>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-mysqldb-connect">Connecting</a></span></li>
<li><span class="link-container"><a class="reference external" href="#driver-status">Driver Status</a></span></li>
<li><span class="link-container"><a class="reference external" href="#mysqldb-unicode">Unicode</a></span></li>
<li><span class="link-container"><a class="reference external" href="#using-mysqldb-with-google-cloud-sql">Using MySQLdb with Google Cloud SQL</a></span></li>
<li><span class="link-container"><a class="reference external" href="#id4">Server Side Cursors</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#module-sqlalchemy.dialects.mysql.pymysql">PyMySQL</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-pymysql-url">DBAPI</a></span></li>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-pymysql-connect">Connecting</a></span></li>
<li><span class="link-container"><a class="reference external" href="#id5">Unicode</a></span></li>
<li><span class="link-container"><a class="reference external" href="#mysql-python-compatibility">MySQL-Python Compatibility</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#module-sqlalchemy.dialects.mysql.mysqlconnector">MySQL-Connector</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-mysqlconnector-url">DBAPI</a></span></li>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-mysqlconnector-connect">Connecting</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#module-sqlalchemy.dialects.mysql.cymysql">cymysql</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-cymysql-url">DBAPI</a></span></li>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-cymysql-connect">Connecting</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#module-sqlalchemy.dialects.mysql.oursql">OurSQL</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-oursql-url">DBAPI</a></span></li>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-oursql-connect">Connecting</a></span></li>
<li><span class="link-container"><a class="reference external" href="#id6">Unicode</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#module-sqlalchemy.dialects.mysql.gaerdbms">Google App Engine</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-gaerdbms-url">DBAPI</a></span></li>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-gaerdbms-connect">Connecting</a></span></li>
<li><span class="link-container"><a class="reference external" href="#pooling">Pooling</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#module-sqlalchemy.dialects.mysql.pyodbc">pyodbc</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-pyodbc-url">DBAPI</a></span></li>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-pyodbc-connect">Connecting</a></span></li>
</ul>
</li>
<li><span class="link-container"><a class="reference external" href="#module-sqlalchemy.dialects.mysql.zxjdbc">zxjdbc</a></span><ul>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-zxjdbc-url">DBAPI</a></span></li>
<li><span class="link-container"><a class="reference external" href="#dialect-mysql-zxjdbc-connect">Connecting</a></span></li>
<li><span class="link-container"><a class="reference external" href="#character-sets">Character Sets</a></span></li>
</ul>
</li>
</ul>
</li>
...
<li><span class="link-container"><a class="reference external" href="sybase.html">Sybase</a></span></li>
    ...
    <div id="docs-body" class="withsidebar dialects-mysql" >
...
<div class="section" id="connection-timeouts-and-disconnects">
...
<p>A <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal notranslate"><span class="pre">Table</span></code></a>
...
dialect-specific parameter <a class="reference internal" href="../core/engines.html#sqlalchemy.create_engine.params.isolation_level" title="sqlalchemy.create_engine"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">create_engine.isolation_level</span></code></a>
accepted
...
<a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column.params.autoincrement" title="sqlalchemy.schema.Column"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Column.autoincrement</span></code></a> argument of <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column" title="sqlalchemy.schema.Column"><code class="xref py py-class docutils literal notranslate"><span class="pre">Column</span></code></a>.
This flag
...
established with a particular <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a>.
...
<li><p>SELECT pragma, use <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Select.prefix_with" title="sqlalchemy.sql.expression.Select.prefix_with"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Select.prefix_with()</span></code></a> and
<a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.prefix_with" title="sqlalchemy.orm.query.Query.prefix_with"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.prefix_with()</span></code></a>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">select</span><span class="p">(</span><span class="o">...</span><span class="p">)</span><span class="o">.</span><span class="n">prefix_with</span><span class="p">([</span><span class="s1">&#39;HIGH_PRIORITY&#39;</span><span class="p">,</span> <span class="s1">&#39;SQL_SMALL_RESULT&#39;</span><span class="p">])</span></pre></div>
</div>
</li>
...
<li><p>optimizer hints, use <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Select.prefix_with" title="sqlalchemy.sql.expression.Select.prefix_with"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Select.prefix_with()</span></code></a> and
<a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.prefix_with" title="sqlalchemy.orm.query.Query.prefix_with"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.prefix_with()</span></code></a>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">select</span><span class="p">(</span><span class="o">...</span><span class="p">)</span><span class="o">.</span><span class="n">prefix_with</span><span class="p">(</span><span class="s2">&quot;/*+ NO_RANGE_OPTIMIZATION(t4 PRIMARY) */&quot;</span><span class="p">)</span></pre></div>
</div>
</li>
<li><p>index hints, use <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.Select.with_hint" title="sqlalchemy.sql.expression.Select.with_hint"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Select.with_hint()</span></code></a> and
<a class="reference internal" href="../orm/query.html#sqlalchemy.orm.query.Query.with_hint" title="sqlalchemy.orm.query.Query.with_hint"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.with_hint()</span></code></a>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">select</span><span class="p">(</span><span class="o">...</span><span class="p">)</span><span class="o">.</span><span class="n">with_hint</span><span class="p">(</span><span class="n">some_table</span><span class="p">,</span> <span class="s2">&quot;USE INDEX xyz&quot;</span><span class="p">)</span></pre></div>
</div>
</li>
</ul>
</div>
...
<a class="reference internal" href="#sqlalchemy.dialects.mysql.insert" title="sqlalchemy.dialects.mysql.insert"><code class="xref py py-func docutils literal notranslate"><span class="pre">insert()</span></code></a> function, which provides
the generative method <a class="reference internal" href="#sqlalchemy.dialects.mysql.Insert.on_duplicate_key_update" title="sqlalchemy.dialects.mysql.Insert.on_duplicate_key_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Insert.on_duplicate_key_update()</span></code></a>:</p>
...
<a class="reference internal" href="#sqlalchemy.dialects.mysql.Insert.on_duplicate_key_update" title="sqlalchemy.dialects.mysql.Insert.on_duplicate_key_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Insert.on_duplicate_key_update()</span></code></a>
given column key values (usually the name of the column, unless it
specifies <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column.params.key" title="sqlalchemy.schema.Column"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Column.key</span></code></a>
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">on_duplicate_key_stmt</span> <span class="o">=</span> <span class="n">insert_stmt</span><span class="o">.</span><span class="n">on_duplicate_key_update</span><span class="p">(</span>
    <span class="n">data</span><span class="o">=</span><span class="s2">&quot;some data&quot;</span><span class="p">,</span>
...
<p>In a manner similar to that of <code class="xref py py-meth docutils literal notranslate"><span class="pre">UpdateBase.values()</span></code>, other parameter
forms are accepted, including a single dictionary:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">on_duplicate_key_stmt</span> <span class="o">=</span> <span class="n">insert_stmt</span><span class="o">.</span><span class="n">on_duplicate_key_update</span><span class="p">(</span>
    <span class="p">{</span><span class="s2">&quot;data&quot;</span><span class="p">:</span> <span class="s2">&quot;some data&quot;</span><span class="p">,</span> <span class="s2">&quot;updated_at&quot;</span><span class="p">:</span> <span class="n">func</span><span class="o">.</span><span class="n">current_timestamp</span><span class="p">()},</span>
<span class="p">)</span></pre></div>
</div>
...
at <a class="reference internal" href="../core/tutorial.html#updates-order-parameters"><span class="std std-ref">Parameter-Ordered Updates</span></a>.  Unlike the <a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.Update" title="sqlalchemy.sql.expression.Update"><code class="xref py py-class docutils literal notranslate"><span class="pre">Update</span></code></a>
object,
...
<p><span class="versionmodified changed">Changed in version 1.3: </span>support for parameter-ordered UPDATE clause within
MySQL ON DUPLICATE KEY UPDATE</p>
</div>
<div class="admonition warning">
<p class="admonition-title">Warning</p>
<p>The <code class="xref py py-meth docutils literal notranslate"><span class="pre">Insert.on_duplicate_key_update()</span></code>
...
<a class="reference internal" href="#sqlalchemy.dialects.mysql.Insert.inserted" title="sqlalchemy.dialects.mysql.Insert.inserted"><code class="xref py py-attr docutils literal notranslate"><span class="pre">Insert.inserted</span></code></a> is available as an attribute on
the <a class="reference internal" href="#sqlalchemy.dialects.mysql.Insert" title="sqlalchemy.dialects.mysql.Insert"><code class="xref py py-class docutils literal notranslate"><span class="pre">Insert</span></code></a> object; this object is a
...
<div class="section" id="index-parsers">
<h3>Index Parsers<a class="headerlink" href="#index-parsers" title="Permalink to this headline">¶</a></h3>
<p>CREATE FULLTEXT INDEX in MySQL also supports a “WITH PARSER” option.  This
is available using the keyword argument <code class="docutils literal notranslate"><span class="pre">mysql_with_parser</span></code>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">Index</span><span class="p">(</span>
    <span class="s1">&#39;my_index&#39;</span><span class="p">,</span> <span class="n">my_table</span><span class="o">.</span><span class="n">c</span><span class="o">.</span><span class="n">data</span><span class="p">,</span>
    <span class="n">mysql_prefix</span><span class="o">=</span><span class="s1">&#39;FULLTEXT&#39;</span><span class="p">,</span> <span class="n">mysql_with_parser</span><span class="o">=</span><span class="s2">&quot;ngram&quot;</span><span class="p">)</span></pre></div>
</div>
<div class="versionadded">
...
<a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKeyConstraint" title="sqlalchemy.schema.ForeignKeyConstraint"><code class="xref py py-class docutils literal notranslate"><span class="pre">ForeignKeyConstraint</span></code></a> or <a class="reference internal" href="../core/constraints.html#sqlalchemy.schema.ForeignKey" title="sqlalchemy.schema.ForeignKey"><code class="xref py py-class docutils literal notranslate"><span class="pre">ForeignKey</span></code></a>
...
<div class="section" id="timestamp-datetime-issues">
<h2>TIMESTAMP / DATETIME issues<a class="headerlink" href="#timestamp-datetime-issues" title="Permalink to this headline">¶</a></h2>
<div class="section" id="rendering-on-update-current-timestamp-for-mysql-s-explicit-defaults-for-timestamp">
<span id="mysql-timestamp-onupdate"></span><h3>Rendering ON UPDATE CURRENT TIMESTAMP for MySQL’s explicit_defaults_for_timestamp<a class="headerlink" href="#rendering-on-update-current-timestamp-for-mysql-s-explicit-defaults-for-timestamp" title="Permalink to this headline">¶</a></h3>
<p>MySQL has historically expanded the DDL for the <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.TIMESTAMP" title="sqlalchemy.types.TIMESTAMP"><code class="xref py py-class docutils literal notranslate"><span class="pre">TIMESTAMP</span></code></a>
...
desired.</p>
<p>MySQL 5.6 introduced a new flag <a class="reference external" href="http://dev.mysql.com/doc/refman/5.6/en/server-system-variables.html#sysvar_explicit_defaults_for_timestamp">explicit_defaults_for_timestamp</a> which disables the above behavior,
...
<code class="docutils literal notranslate"><span class="pre">DATETIME</span></code> datatype as well.</p>
...
<a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column.params.server_onupdate" title="sqlalchemy.schema.Column"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Column.server_onupdate</span></code></a> parameter is currently not related
to this special MySQL behavior.</p>
<p>To generate this DDL, make use of the <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column.params.server_default" title="sqlalchemy.schema.Column"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Column.server_default</span></code></a>
parameter and pass a textual clause that also includes the ON UPDATE clause:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">Table</span><span class="p">,</span> <span class="n">MetaData</span><span class="p">,</span> <span class="n">Column</span><span class="p">,</span> <span class="n">Integer</span><span class="p">,</span> <span class="n">String</span><span class="p">,</span> <span class="n">TIMESTAMP</span>
...
<span class="n">mytable</span> <span class="o">=</span> <span class="n">Table</span><span class="p">(</span>
    ...
    <span class="n">Column</span><span class="p">(</span>
        ...
        <span class="n">server_default</span><span class="o">=</span><span class="n">text</span><span class="p">(</span><span class="s2">&quot;CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP&quot;</span><span class="p">)</span>
    <span class="p">)</span>
<span class="p">)</span></pre></div>
</div>
<p>The same instructions apply to use of the <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.DateTime" title="sqlalchemy.types.DateTime"><code class="xref py py-class docutils literal notranslate"><span class="pre">DateTime</span></code></a> and
<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.DATETIME" title="sqlalchemy.types.DATETIME"><code class="xref py py-class docutils literal notranslate"><span class="pre">DATETIME</span></code></a> datatypes:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">DateTime</span>
...
<p>Even though the <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Column.params.server_onupdate" title="sqlalchemy.schema.Column"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Column.server_onupdate</span></code></a> feature does not
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy.schema</span> <span class="k">import</span> <span class="n">FetchedValue</span>
...
<span class="k">class</span> <span class="nc">MyClass</span><span class="p">(</span><span class="n">Base</span><span class="p">):</span>
    ...
    <span class="n">last_updated</span> <span class="o">=</span> <span class="n">Column</span><span class="p">(</span>
        <span class="n">TIMESTAMP</span><span class="p">,</span>
        <span class="n">server_default</span><span class="o">=</span><span class="n">text</span><span class="p">(</span><span class="s2">&quot;CURRENT_TIMESTAMP ON UPDATE CURRENT_TIMESTAMP&quot;</span><span class="p">),</span>
...
<span id="mysql-timestamp-null"></span><h3>TIMESTAMP Columns and NULL<a class="headerlink" href="#timestamp-columns-and-null" title="Permalink to this headline">¶</a></h3>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.BIGINT"><code class="sig-name descname">BIGINT</code></a></p></td>
<td><p>MySQL BIGINTEGER type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.BINARY"><code class="sig-name descname">BINARY</code></a></p></td>
<td><p>The SQL BINARY type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.BIT"><code class="sig-name descname">BIT</code></a></p></td>
<td><p>MySQL BIT type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.BLOB"><code class="sig-name descname">BLOB</code></a></p></td>
<td><p>The SQL BLOB type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.BOOLEAN"><code class="sig-name descname">BOOLEAN</code></a></p></td>
<td><p>The SQL BOOLEAN type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.CHAR"><code class="sig-name descname">CHAR</code></a></p></td>
<td><p>MySQL CHAR type, for fixed-length character data.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.DATE"><code class="sig-name descname">DATE</code></a></p></td>
<td><p>The SQL DATE type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.DATETIME"><code class="sig-name descname">DATETIME</code></a></p></td>
<td><p>MySQL DATETIME type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.DECIMAL"><code class="sig-name descname">DECIMAL</code></a></p></td>
<td><p>MySQL DECIMAL type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.DOUBLE"><code class="sig-name descname">DOUBLE</code></a></p></td>
<td><p>MySQL DOUBLE type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.ENUM"><code class="sig-name descname">ENUM</code></a></p></td>
<td><p>MySQL ENUM type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.FLOAT"><code class="sig-name descname">FLOAT</code></a></p></td>
<td><p>MySQL FLOAT type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.INTEGER"><code class="sig-name descname">INTEGER</code></a></p></td>
<td><p>MySQL INTEGER type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.JSON"><code class="sig-name descname">JSON</code></a></p></td>
<td><p>MySQL JSON type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.LONGBLOB"><code class="sig-name descname">LONGBLOB</code></a></p></td>
<td><p>MySQL LONGBLOB type, for binary data up to 2^32 bytes.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.LONGTEXT"><code class="sig-name descname">LONGTEXT</code></a></p></td>
<td><p>MySQL LONGTEXT type, for text up to 2^32 characters.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.MEDIUMBLOB"><code class="sig-name descname">MEDIUMBLOB</code></a></p></td>
<td><p>MySQL MEDIUMBLOB type, for binary data up to 2^24 bytes.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.MEDIUMINT"><code class="sig-name descname">MEDIUMINT</code></a></p></td>
<td><p>MySQL MEDIUMINTEGER type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.MEDIUMTEXT"><code class="sig-name descname">MEDIUMTEXT</code></a></p></td>
<td><p>MySQL MEDIUMTEXT type, for text up to 2^24 characters.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.NCHAR"><code class="sig-name descname">NCHAR</code></a></p></td>
<td><p>MySQL NCHAR type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.NUMERIC"><code class="sig-name descname">NUMERIC</code></a></p></td>
<td><p>MySQL NUMERIC type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.NVARCHAR"><code class="sig-name descname">NVARCHAR</code></a></p></td>
<td><p>MySQL NVARCHAR type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.REAL"><code class="sig-name descname">REAL</code></a></p></td>
<td><p>MySQL REAL type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.SET"><code class="sig-name descname">SET</code></a></p></td>
<td><p>MySQL SET type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.SMALLINT"><code class="sig-name descname">SMALLINT</code></a></p></td>
<td><p>MySQL SMALLINTEGER type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.TEXT"><code class="sig-name descname">TEXT</code></a></p></td>
<td><p>MySQL TEXT type, for text up to 2^16 characters.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.TIME"><code class="sig-name descname">TIME</code></a></p></td>
<td><p>MySQL TIME type.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.TIMESTAMP"><code class="sig-name descname">TIMESTAMP</code></a></p></td>
<td><p>MySQL TIMESTAMP type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.TINYBLOB"><code class="sig-name descname">TINYBLOB</code></a></p></td>
<td><p>MySQL TINYBLOB type, for binary data up to 2^8 bytes.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.TINYINT"><code class="sig-name descname">TINYINT</code></a></p></td>
<td><p>MySQL TINYINT type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.TINYTEXT"><code class="sig-name descname">TINYTEXT</code></a></p></td>
<td><p>MySQL TINYTEXT type, for text up to 2^8 characters.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.VARBINARY"><code class="sig-name descname">VARBINARY</code></a></p></td>
<td><p>The SQL VARBINARY type.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.VARCHAR"><code class="sig-name descname">VARCHAR</code></a></p></td>
<td><p>MySQL VARCHAR type, for variable-length character data.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.YEAR"><code class="sig-name descname">YEAR</code></a></p></td>
<td><p>MySQL YEAR type, for single byte storage of years 1901-2155.</p></td>
</tr>
</tbody>
</table>
<dl class="py class">
<dt id="sqlalchemy.dialects.mysql.BIGINT">
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">BIGINT</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.BIGINT" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL BIGINTEGER type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.BIGINT" title="sqlalchemy.dialects.mysql.BIGINT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.BIGINT</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._IntegerType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.BIGINT" title="sqlalchemy.types.BIGINT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.BIGINT</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.BIGINT.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.BIGINT"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.BIGINT.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.BIGINT.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">BINARY</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.BINARY" title="Permalink to this definition">¶</a></dt>
<dd><p>The SQL BINARY type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.BINARY" title="sqlalchemy.dialects.mysql.BINARY"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.BINARY</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.BINARY.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.BINARY"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.BINARY.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.BINARY.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">BIT</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.BIT" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL BIT type.</p>
<p>This type is for MySQL 5.0.3 or greater for MyISAM, and 5.0.5 or greater
for MyISAM, MEMORY, InnoDB and BDB.  For older versions, use a
MSTinyInteger() type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.BIT" title="sqlalchemy.dialects.mysql.BIT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.BIT</span></code></a> (<a class="reference internal" href="../core/type_api.html#sqlalchemy.types.TypeEngine" title="sqlalchemy.types.TypeEngine"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.TypeEngine</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.BIT.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.BIT"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.BIT.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.BIT.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">BLOB</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.BLOB" title="Permalink to this definition">¶</a></dt>
<dd><p>The SQL BLOB type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.BLOB" title="sqlalchemy.dialects.mysql.BLOB"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.BLOB</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.LargeBinary" title="sqlalchemy.types.LargeBinary"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.LargeBinary</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.BLOB.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.BLOB"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.BLOB.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.BLOB.__init__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">BOOLEAN</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">create_constraint</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">name</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_create_events</span><span class="o">=</span><span class="default_value">True</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.BOOLEAN" title="Permalink to this definition">¶</a></dt>
<dd><p>The SQL BOOLEAN type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.BOOLEAN" title="sqlalchemy.dialects.mysql.BOOLEAN"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.BOOLEAN</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Boolean" title="sqlalchemy.types.Boolean"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.Boolean</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.BOOLEAN.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.BOOLEAN"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.BOOLEAN.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">create_constraint</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">name</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">_create_events</span><span class="o">=</span><span class="default_value">True</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.BOOLEAN.__init__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">CHAR</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.CHAR" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL CHAR type, for fixed-length character data.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.CHAR" title="sqlalchemy.dialects.mysql.CHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.CHAR</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._StringType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.CHAR" title="sqlalchemy.types.CHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.CHAR</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.CHAR.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.CHAR"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.CHAR.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.CHAR.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">DATE</code><a class="headerlink" href="#sqlalchemy.dialects.mysql.DATE" title="Permalink to this definition">¶</a></dt>
<dd><p>The SQL DATE type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.DATE" title="sqlalchemy.dialects.mysql.DATE"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.DATE</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Date" title="sqlalchemy.types.Date"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.Date</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.DATE.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.DATE"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.DATE.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.DATE.__init__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">DATETIME</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">timezone</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">fsp</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.DATETIME" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL DATETIME type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.DATETIME" title="sqlalchemy.dialects.mysql.DATETIME"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.DATETIME</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.DATETIME" title="sqlalchemy.types.DATETIME"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.DATETIME</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.DATETIME.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.DATETIME"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.DATETIME.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">timezone</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">fsp</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.DATETIME.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">DECIMAL</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">precision</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">scale</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">asdecimal</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.DECIMAL" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL DECIMAL type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.DECIMAL" title="sqlalchemy.dialects.mysql.DECIMAL"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.DECIMAL</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._NumericType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.DECIMAL" title="sqlalchemy.types.DECIMAL"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.DECIMAL</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.DECIMAL.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.DECIMAL"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.DECIMAL.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">precision</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">scale</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">asdecimal</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.DECIMAL.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">DOUBLE</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">precision</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">scale</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">asdecimal</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.DOUBLE" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL DOUBLE type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.DOUBLE" title="sqlalchemy.dialects.mysql.DOUBLE"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.DOUBLE</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._FloatType</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.DOUBLE.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.DOUBLE"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.DOUBLE.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">precision</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">scale</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">asdecimal</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.DOUBLE.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">ENUM</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">enums</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.ENUM" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL ENUM type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.ENUM" title="sqlalchemy.dialects.mysql.ENUM"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.ENUM</span></code></a> (<code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.NativeForEmulated</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.Enum" title="sqlalchemy.types.Enum"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.Enum</span></code></a>, <code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.enumerated._EnumeratedValues</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.ENUM.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.ENUM"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.ENUM.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">enums</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.ENUM.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">FLOAT</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">precision</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">scale</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">asdecimal</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.FLOAT" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL FLOAT type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.FLOAT" title="sqlalchemy.dialects.mysql.FLOAT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.FLOAT</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._FloatType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.FLOAT" title="sqlalchemy.types.FLOAT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.FLOAT</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.FLOAT.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.FLOAT"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.FLOAT.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">precision</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">scale</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">asdecimal</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.FLOAT.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">INTEGER</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.INTEGER" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL INTEGER type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.INTEGER" title="sqlalchemy.dialects.mysql.INTEGER"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.INTEGER</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._IntegerType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.INTEGER" title="sqlalchemy.types.INTEGER"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.INTEGER</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.INTEGER.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.INTEGER"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.INTEGER.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.INTEGER.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">JSON</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">none_as_null</span><span class="o">=</span><span class="default_value">False</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.JSON" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL JSON type.</p>
<p>MySQL supports JSON as of version 5.7.
MariaDB supports JSON (as an alias for LONGTEXT) as of version 10.2.</p>
<p>The <a class="reference internal" href="#sqlalchemy.dialects.mysql.JSON" title="sqlalchemy.dialects.mysql.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">JSON</span></code></a> type supports persistence of JSON values
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.JSON" title="sqlalchemy.dialects.mysql.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.JSON</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.JSON" title="sqlalchemy.types.JSON"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.JSON</span></code></a>)</p>
</div>
</dd></dl>

<dl class="py class">
<dt id="sqlalchemy.dialects.mysql.LONGBLOB">
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">LONGBLOB</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.LONGBLOB" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL LONGBLOB type, for binary data up to 2^32 bytes.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.LONGBLOB" title="sqlalchemy.dialects.mysql.LONGBLOB"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.LONGBLOB</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.LONGBLOB.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.LONGBLOB"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.LONGBLOB.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.LONGBLOB.__init__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary.__init__</span></code> <em>method of</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary</span></code></p>
</div>
<p>Initialize self.  See help(type(self)) for accurate signature.</p>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">LONGTEXT</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.LONGTEXT" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL LONGTEXT type, for text up to 2^32 characters.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.LONGTEXT" title="sqlalchemy.dialects.mysql.LONGTEXT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.LONGTEXT</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._StringType</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.LONGTEXT.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.LONGTEXT"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.LONGTEXT.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.LONGTEXT.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">MEDIUMBLOB</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.MEDIUMBLOB" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL MEDIUMBLOB type, for binary data up to 2^24 bytes.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.MEDIUMBLOB" title="sqlalchemy.dialects.mysql.MEDIUMBLOB"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.MEDIUMBLOB</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.MEDIUMBLOB.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.MEDIUMBLOB"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.MEDIUMBLOB.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.MEDIUMBLOB.__init__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary.__init__</span></code> <em>method of</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary</span></code></p>
</div>
<p>Initialize self.  See help(type(self)) for accurate signature.</p>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">MEDIUMINT</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.MEDIUMINT" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL MEDIUMINTEGER type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.MEDIUMINT" title="sqlalchemy.dialects.mysql.MEDIUMINT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.MEDIUMINT</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._IntegerType</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.MEDIUMINT.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.MEDIUMINT"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.MEDIUMINT.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.MEDIUMINT.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">MEDIUMTEXT</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.MEDIUMTEXT" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL MEDIUMTEXT type, for text up to 2^24 characters.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.MEDIUMTEXT" title="sqlalchemy.dialects.mysql.MEDIUMTEXT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.MEDIUMTEXT</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._StringType</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.MEDIUMTEXT.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.MEDIUMTEXT"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.MEDIUMTEXT.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.MEDIUMTEXT.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">NCHAR</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.NCHAR" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL NCHAR type.</p>
<p>For fixed-length character data in the server’s configured national
character set.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.NCHAR" title="sqlalchemy.dialects.mysql.NCHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.NCHAR</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._StringType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.NCHAR" title="sqlalchemy.types.NCHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.NCHAR</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.NCHAR.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.NCHAR"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.NCHAR.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.NCHAR.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">NUMERIC</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">precision</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">scale</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">asdecimal</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.NUMERIC" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL NUMERIC type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.NUMERIC" title="sqlalchemy.dialects.mysql.NUMERIC"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.NUMERIC</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._NumericType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.NUMERIC" title="sqlalchemy.types.NUMERIC"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.NUMERIC</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.NUMERIC.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.NUMERIC"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.NUMERIC.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">precision</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">scale</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">asdecimal</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.NUMERIC.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">NVARCHAR</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.NVARCHAR" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL NVARCHAR type.</p>
<p>For variable-length character data in the server’s configured national
character set.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.NVARCHAR" title="sqlalchemy.dialects.mysql.NVARCHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.NVARCHAR</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._StringType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.NVARCHAR" title="sqlalchemy.types.NVARCHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.NVARCHAR</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.NVARCHAR.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.NVARCHAR"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.NVARCHAR.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.NVARCHAR.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">REAL</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">precision</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">scale</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">asdecimal</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.REAL" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL REAL type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.REAL" title="sqlalchemy.dialects.mysql.REAL"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.REAL</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._FloatType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.REAL" title="sqlalchemy.types.REAL"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.REAL</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.REAL.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.REAL"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.REAL.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">precision</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">scale</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">asdecimal</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.REAL.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">SET</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">values</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.SET" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL SET type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.SET" title="sqlalchemy.dialects.mysql.SET"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.SET</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.enumerated._EnumeratedValues</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.SET.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.SET"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.SET.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">values</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.SET.__init__" title="Permalink to this definition">¶</a></dt>
...
<div class="admonition warning">
<p class="admonition-title">Warning</p>
<p>When using <a class="reference internal" href="#sqlalchemy.dialects.mysql.SET.params.retrieve_as_bitwise" title="sqlalchemy.dialects.mysql.SET"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">SET.retrieve_as_bitwise</span></code></a>, it is
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">SMALLINT</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.SMALLINT" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL SMALLINTEGER type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.SMALLINT" title="sqlalchemy.dialects.mysql.SMALLINT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.SMALLINT</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._IntegerType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.SMALLINT" title="sqlalchemy.types.SMALLINT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.SMALLINT</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.SMALLINT.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.SMALLINT"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.SMALLINT.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.SMALLINT.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">TEXT</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TEXT" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL TEXT type, for text up to 2^16 characters.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.TEXT" title="sqlalchemy.dialects.mysql.TEXT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TEXT</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._StringType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.TEXT" title="sqlalchemy.types.TEXT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.TEXT</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.TEXT.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.TEXT"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TEXT.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TEXT.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">TIME</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">timezone</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">fsp</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TIME" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL TIME type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.TIME" title="sqlalchemy.dialects.mysql.TIME"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TIME</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.TIME" title="sqlalchemy.types.TIME"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.TIME</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.TIME.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.TIME"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TIME.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">timezone</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">fsp</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TIME.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">TIMESTAMP</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">timezone</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">fsp</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TIMESTAMP" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL TIMESTAMP type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.TIMESTAMP" title="sqlalchemy.dialects.mysql.TIMESTAMP"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TIMESTAMP</span></code></a> (<a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.TIMESTAMP" title="sqlalchemy.types.TIMESTAMP"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.TIMESTAMP</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.TIMESTAMP.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.TIMESTAMP"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TIMESTAMP.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">timezone</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">fsp</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TIMESTAMP.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">TINYBLOB</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TINYBLOB" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL TINYBLOB type, for binary data up to 2^8 bytes.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.TINYBLOB" title="sqlalchemy.dialects.mysql.TINYBLOB"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TINYBLOB</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.TINYBLOB.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.TINYBLOB"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TINYBLOB.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TINYBLOB.__init__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary.__init__</span></code> <em>method of</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary</span></code></p>
</div>
<p>Initialize self.  See help(type(self)) for accurate signature.</p>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">TINYINT</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TINYINT" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL TINYINT type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.TINYINT" title="sqlalchemy.dialects.mysql.TINYINT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TINYINT</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._IntegerType</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.TINYINT.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.TINYINT"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TINYINT.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TINYINT.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">TINYTEXT</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TINYTEXT" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL TINYTEXT type, for text up to 2^8 characters.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.TINYTEXT" title="sqlalchemy.dialects.mysql.TINYTEXT"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TINYTEXT</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._StringType</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.TINYTEXT.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.TINYTEXT"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.TINYTEXT.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.TINYTEXT.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">VARBINARY</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.VARBINARY" title="Permalink to this definition">¶</a></dt>
<dd><p>The SQL VARBINARY type.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.VARBINARY" title="sqlalchemy.dialects.mysql.VARBINARY"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.VARBINARY</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.VARBINARY.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.VARBINARY"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.VARBINARY.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.VARBINARY.__init__" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary.__init__</span></code> <em>method of</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.types._Binary</span></code></p>
</div>
<p>Initialize self.  See help(type(self)) for accurate signature.</p>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">VARCHAR</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.VARCHAR" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL VARCHAR type, for variable-length character data.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.VARCHAR" title="sqlalchemy.dialects.mysql.VARCHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.VARCHAR</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.types._StringType</span></code>, <a class="reference internal" href="../core/type_basics.html#sqlalchemy.types.VARCHAR" title="sqlalchemy.types.VARCHAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.VARCHAR</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.VARCHAR.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.VARCHAR"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.VARCHAR.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">length</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.VARCHAR.__init__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">YEAR</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.YEAR" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL YEAR type, for single byte storage of years 1901-2155.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.YEAR" title="sqlalchemy.dialects.mysql.YEAR"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.YEAR</span></code></a> (<a class="reference internal" href="../core/type_api.html#sqlalchemy.types.TypeEngine" title="sqlalchemy.types.TypeEngine"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.types.TypeEngine</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.YEAR.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.YEAR"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.YEAR.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">display_width</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.YEAR.__init__" title="Permalink to this definition">¶</a></dt>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.dialects.mysql.insert"><code class="sig-name descname">insert</code></a>(table[, values, inline, bind, ...], **dialect_kw)</p></td>
...
<p>Inherited from <a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.insert" title="sqlalchemy.sql.expression.insert"><code class="xref py py-func docutils literal notranslate"><span class="pre">insert()</span></code></a>; this constructor creates a <a class="reference internal" href="#sqlalchemy.dialects.mysql.Insert" title="sqlalchemy.dialects.mysql.Insert"><code class="xref py py-class docutils literal notranslate"><span class="pre">Insert</span></code></a> object</p>
</div>
...
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><ul class="simple">
<li><p><span class="target" id="sqlalchemy.dialects.mysql.insert.params.table"></span><strong>table</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.dialects.mysql.insert.params.table">¶</a> – <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.TableClause" title="sqlalchemy.sql.expression.TableClause"><code class="xref py py-class docutils literal notranslate"><span class="pre">TableClause</span></code></a>
which is the subject of the
insert.</p></li>
<li><p><span class="target" id="sqlalchemy.dialects.mysql.insert.params.values"></span><strong>values</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.dialects.mysql.insert.params.values">¶</a> – collection of values to be inserted; see
...
based on the parameters passed to <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection.execute" title="sqlalchemy.engine.Connection.execute"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Connection.execute()</span></code></a>.</p></li>
<li><p><span class="target" id="sqlalchemy.dialects.mysql.insert.params.inline"></span><strong>inline</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.dialects.mysql.insert.params.inline">¶</a> – if True, no attempt will be made to retrieve the
...
<dt id="sqlalchemy.dialects.mysql.Insert">
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.dialects.mysql.</code><code class="sig-name descname">Insert</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">table</span></em>, <em class="sig-param"><span class="n">values</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">inline</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">bind</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">prefixes</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">returning</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">return_defaults</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">dialect_kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.Insert" title="Permalink to this definition">¶</a></dt>
<dd><p>MySQL-specific implementation of INSERT.</p>
<p>Adds methods for MySQL-specific syntaxes such as ON DUPLICATE KEY UPDATE.</p>
<p>The <a class="reference internal" href="#sqlalchemy.dialects.mysql.Insert" title="sqlalchemy.dialects.mysql.Insert"><code class="xref py py-class docutils literal notranslate"><span class="pre">Insert</span></code></a> object is created using the
<a class="reference internal" href="#sqlalchemy.dialects.mysql.insert" title="sqlalchemy.dialects.mysql.insert"><code class="xref py py-func docutils literal notranslate"><span class="pre">insert()</span></code></a> function.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 1.2.</span></p>
</div>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.dialects.mysql.Insert" title="sqlalchemy.dialects.mysql.Insert"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.Insert</span></code></a> (<a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.Insert" title="sqlalchemy.sql.expression.Insert"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.sql.expression.Insert</span></code></a>)</p>
</div>
<dl class="py attribute">
<dt id="sqlalchemy.dialects.mysql.Insert.inserted">
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.Insert"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.Insert.</span></code></a><code class="sig-name descname">inserted</code><a class="headerlink" href="#sqlalchemy.dialects.mysql.Insert.inserted" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.Insert.values" title="sqlalchemy.sql.expression.Insert.values"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Insert.values()</span></code></a> method.</p>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
...
to use <code class="xref py py-attr docutils literal notranslate"><span class="pre">Insert.inserted</span></code></p>
</div>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.dialects.mysql.Insert.on_duplicate_key_update">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.dialects.mysql.Insert"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.dialects.mysql.Insert.</span></code></a><code class="sig-name descname">on_duplicate_key_update</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">args</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.dialects.mysql.Insert.on_duplicate_key_update" title="Permalink to this definition">¶</a></dt>
<dd><p>Specifies the ON DUPLICATE KEY UPDATE clause.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><p><span class="target" id="sqlalchemy.dialects.mysql.Insert.on_duplicate_key_update.params.**kw"></span><strong>**kw</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.dialects.mysql.Insert.on_duplicate_key_update.params.**kw">¶</a> – Column keys linked to UPDATE values.  The
...
<dl class="field-list simple">
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><p><span class="target" id="sqlalchemy.dialects.mysql.Insert.on_duplicate_key_update.params.*args"></span><strong>*args</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.dialects.mysql.Insert.on_duplicate_key_update.params.*args">¶</a> – <p>As an alternative to passing key/value parameters,
a dictionary or list of 2-tuples can be passed as a single positional
argument.</p>
<p>Passing a single dictionary is equivalent to the keyword argument
form:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">insert</span><span class="p">()</span><span class="o">.</span><span class="n">on_duplicate_key_update</span><span class="p">({</span><span class="s2">&quot;name&quot;</span><span class="p">:</span> <span class="s2">&quot;some name&quot;</span><span class="p">})</span></pre></div>
</div>
<p>Passing a list of 2-tuples indicates that the parameter assignments
in the UPDATE clause should be ordered as sent, in a manner similar
to that described for the <a class="reference internal" href="../core/dml.html#sqlalchemy.sql.expression.Update" title="sqlalchemy.sql.expression.Update"><code class="xref py py-class docutils literal notranslate"><span class="pre">Update</span></code></a>
construct overall
in <a class="reference internal" href="../core/tutorial.html#updates-order-parameters"><span class="std std-ref">Parameter-Ordered Updates</span></a>:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="n">insert</span><span class="p">()</span><span class="o">.</span><span class="n">on_duplicate_key_update</span><span class="p">(</span>
    <span class="p">[(</span><span class="s2">&quot;name&quot;</span><span class="p">,</span> <span class="s2">&quot;some name&quot;</span><span class="p">),</span> <span class="p">(</span><span class="s2">&quot;value&quot;</span><span class="p">,</span> <span class="s2">&quot;some value&quot;</span><span class="p">)])</span></pre></div>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in version 1.3: </span>parameters can be specified as a dictionary
...
<span id="id3"></span><h3>Unicode<a class="headerlink" href="#mysqldb-unicode" title="Permalink to this headline">¶</a></h3>
...
<h3>Server Side Cursors<a class="headerlink" href="#id4" title="Permalink to this headline">¶</a></h3>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The MySQL Connector/Python DBAPI has had many issues since its release,
some of which may remain unresolved, and the mysqlconnector dialect is
<strong>not tested as part of SQLAlchemy’s continuous integration</strong>.
The recommended MySQL dialects are mysqlclient and PyMySQL.</p>
</div>
</div>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The CyMySQL dialect is <strong>not tested as part of SQLAlchemy’s continuous
integration</strong> and may have unresolved issues.  The recommended MySQL
dialects are mysqlclient and PyMySQL.</p>
</div>
</div>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The OurSQL MySQL dialect is legacy and is no longer supported upstream,
and is <strong>not tested as part of SQLAlchemy’s continuous integration</strong>.
The recommended MySQL dialects are mysqlclient and PyMySQL.</p>
</div>
<div class="section" id="id6">
<h3>Unicode<a class="headerlink" href="#id6" title="Permalink to this headline">¶</a></h3>
<p>Please see <a class="reference internal" href="#mysql-unicode"><span class="std std-ref">Unicode</span></a> for current recommendations on unicode
handling.</p>
</div>
</div>
...
<p>Pass through exact pyodbc connection string:</p>
...
<span class="n">connection_string</span> <span class="o">=</span> <span class="p">(</span>
    <span class="s1">&#39;DRIVER=MySQL ODBC 8.0 ANSI Driver;&#39;</span>
    <span class="s1">&#39;SERVER=localhost;&#39;</span>
    <span class="s1">&#39;PORT=3307;&#39;</span>
    <span class="s1">&#39;DATABASE=mydb;&#39;</span>
    <span class="s1">&#39;UID=root;&#39;</span>
    <span class="s1">&#39;PWD=(whatever);&#39;</span>
    <span class="s1">&#39;charset=utf8mb4;&#39;</span>
<span class="p">)</span>
<span class="n">params</span> <span class="o">=</span> <span class="n">urllib</span><span class="o">.</span><span class="n">parse</span><span class="o">.</span><span class="n">quote_plus</span><span class="p">(</span><span class="n">connection_string</span><span class="p">)</span>
<span class="n">connection_uri</span> <span class="o">=</span> <span class="s2">&quot;mysql+pyodbc:///?odbc_connect=</span><span class="si">%s</span><span class="s2">&quot;</span> <span class="o">%</span> <span class="n">params</span></pre></div>
</div>
</div>
