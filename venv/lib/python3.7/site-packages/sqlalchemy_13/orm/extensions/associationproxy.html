...
<li><span class="link-container"><a class="reference external" href="../examples.html">ORM Examples</a></span></li>
    ...
    <div id="docs-body" class="withsidebar orm-extensions-associationproxy" >
...
<span class="k">class</span> <span class="nc">User</span><span class="p">(</span><span class="n">Base</span><span class="p">):</span>
    ...
    <span class="n">keywords</span> <span class="o">=</span> <span class="n">association_proxy</span><span class="p">(</span>
        ...
        <span class="n">creator</span><span class="o">=</span><span class="k">lambda</span> <span class="n">k</span><span class="p">,</span> <span class="n">v</span><span class="p">:</span> <span class="n">UserKeyword</span><span class="p">(</span><span class="n">special_key</span><span class="o">=</span><span class="n">k</span><span class="p">,</span> <span class="n">keyword</span><span class="o">=</span><span class="n">v</span><span class="p">)</span>
    <span class="p">)</span>

    <span class="c1"># another proxy that is directly column-targeted</span>
    <span class="n">special_keys</span> <span class="o">=</span> <span class="n">association_proxy</span><span class="p">(</span><span class="s2">&quot;user_keywords&quot;</span><span class="p">,</span> <span class="s2">&quot;special_key&quot;</span><span class="p">)</span>
...
<span class="k">class</span> <span class="nc">UserKeyword</span><span class="p">(</span><span class="n">Base</span><span class="p">):</span>
    <span class="n">__tablename__</span> <span class="o">=</span> <span class="s1">&#39;user_keyword&#39;</span>
    <span class="n">user_id</span> <span class="o">=</span> <span class="n">Column</span><span class="p">(</span><span class="n">ForeignKey</span><span class="p">(</span><span class="s1">&#39;user.id&#39;</span><span class="p">),</span> <span class="n">primary_key</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
    <span class="n">keyword_id</span> <span class="o">=</span> <span class="n">Column</span><span class="p">(</span><span class="n">ForeignKey</span><span class="p">(</span><span class="s1">&#39;keyword.id&#39;</span><span class="p">),</span> <span class="n">primary_key</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
    <span class="n">special_key</span> <span class="o">=</span> <span class="n">Column</span><span class="p">(</span><span class="n">String</span><span class="p">)</span>
...
Class-bound attributes such as <code class="docutils literal notranslate"><span class="pre">User.keywords</span></code> and <code class="docutils literal notranslate"><span class="pre">User.special_keys</span></code>
in the preceding example will provide for a SQL generating construct
when accessed at the class level.</p>
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The primary purpose of the association proxy extension is to allow
...
<p>The SQL generated takes the form of a correlated subquery against
...
immediate target of an association proxy is a <strong>mapped column expression</strong>,
standard column operators can be used which will be embedded in the subquery.
For example a straight equality operator:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">filter</span><span class="p">(</span><span class="n">User</span><span class="o">.</span><span class="n">special_keys</span> <span class="o">==</span> <span class="s2">&quot;jek&quot;</span><span class="p">))</span>
...
<span class="go">WHERE &quot;user&quot;.id = user_keyword.user_id AND user_keyword.special_key = :special_key_1)</span></pre></div>
</div>
<p>a LIKE operator:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">filter</span><span class="p">(</span><span class="n">User</span><span class="o">.</span><span class="n">special_keys</span><span class="o">.</span><span class="n">like</span><span class="p">(</span><span class="s2">&quot;%jek&quot;</span><span class="p">)))</span>
<span class="go">SELECT &quot;user&quot;.id AS user_id, &quot;user&quot;.name AS user_name</span>
<span class="go">FROM &quot;user&quot;</span>
<span class="go">WHERE EXISTS (SELECT 1</span>
<span class="go">FROM user_keyword</span>
<span class="go">WHERE &quot;user&quot;.id = user_keyword.user_id AND user_keyword.special_key LIKE :special_key_1)</span></pre></div>
</div>
<p>For association proxies where the immediate target is a <strong>related object or collection,
or another association proxy or attribute on the related object</strong>, relationship-oriented
operators can be used instead, such as <a class="reference internal" href="../internals.html#sqlalchemy.orm.PropComparator.has" title="sqlalchemy.orm.PropComparator.has"><code class="xref py py-meth docutils literal notranslate"><span class="pre">PropComparator.has()</span></code></a> and
<a class="reference internal" href="../internals.html#sqlalchemy.orm.PropComparator.any" title="sqlalchemy.orm.PropComparator.any"><code class="xref py py-meth docutils literal notranslate"><span class="pre">PropComparator.any()</span></code></a>.   The <code class="docutils literal notranslate"><span class="pre">User.keywords</span></code> attribute is in fact
two association proxies linked together, so when using this proxy for generating
SQL phrases, we get two levels of EXISTS subqueries:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="gp">&gt;&gt;&gt; </span><span class="nb">print</span><span class="p">(</span><span class="n">session</span><span class="o">.</span><span class="n">query</span><span class="p">(</span><span class="n">User</span><span class="p">)</span><span class="o">.</span><span class="n">filter</span><span class="p">(</span><span class="n">User</span><span class="o">.</span><span class="n">keywords</span><span class="o">.</span><span class="n">any</span><span class="p">(</span><span class="n">Keyword</span><span class="o">.</span><span class="n">keyword</span> <span class="o">==</span> <span class="s2">&quot;jek&quot;</span><span class="p">)))</span>
<span class="go">SELECT &quot;user&quot;.id AS user_id, &quot;user&quot;.name AS user_name</span>
<span class="go">FROM &quot;user&quot;</span>
<span class="go">WHERE EXISTS (SELECT 1</span>
<span class="go">FROM user_keyword</span>
...
<p>This is not the most efficient form of SQL, so while association proxies can be
...
when chaining association proxies together.</p>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in version 1.3: </span>Association proxy features distinct querying modes
based on the type of target.   See <a class="reference internal" href="../../changelog/migration_13.html#change-4351"><span class="std std-ref">AssociationProxy now provides standard column operators for a column-oriented target</span></a>.</p>
</div>
</div>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.ext.associationproxy.association_proxy"><code class="sig-name descname">association_proxy</code></a>(target_collection, attr, **kw)</p></td>
<td><p>Return a Python property implementing a view of a target
attribute which references an attribute on members of the
target.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.ext.associationproxy.ASSOCIATION_PROXY"><code class="sig-name descname">ASSOCIATION_PROXY</code></a></p></td>
<td></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxy"><code class="sig-name descname">AssociationProxy</code></a></p></td>
<td><p>A descriptor that presents a read/write view of an object attribute.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="sig-name descname">AssociationProxyInstance</code></a></p></td>
<td><p>A per-class object that serves class- and object-specific results.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance"><code class="sig-name descname">ColumnAssociationProxyInstance</code></a></p></td>
<td><p>an <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a> that has a database column as a
target.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance"><code class="sig-name descname">ObjectAssociationProxyInstance</code></a></p></td>
<td><p>an <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a> that has an object as a target.</p></td>
</tr>
</tbody>
</table>
...
<p>class <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxy" title="sqlalchemy.ext.associationproxy.AssociationProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.ext.associationproxy.AssociationProxy</span></code></a> (<a class="reference internal" href="../internals.html#sqlalchemy.orm.base.InspectionAttrInfo" title="sqlalchemy.orm.base.InspectionAttrInfo"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.orm.base.InspectionAttrInfo</span></code></a>)</p>
</div>
<dl class="py method">
...
<dd><p>an <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a> that has an object as a target.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance" title="sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.ext.associationproxy.ObjectAssociationProxyInstance</span></code></a> (<a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.ext.associationproxy.AssociationProxyInstance</span></code></a>)</p>
</div>
<dl class="py method">
...
<dd><p>an <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">AssociationProxyInstance</span></code></a> that has a database column as a
target.</p>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance" title="sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.ext.associationproxy.ColumnAssociationProxyInstance</span></code></a> (<a class="reference internal" href="../../core/sqlelement.html#sqlalchemy.sql.operators.ColumnOperators" title="sqlalchemy.sql.operators.ColumnOperators"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.sql.operators.ColumnOperators</span></code></a>, <a class="reference internal" href="#sqlalchemy.ext.associationproxy.AssociationProxyInstance" title="sqlalchemy.ext.associationproxy.AssociationProxyInstance"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.ext.associationproxy.AssociationProxyInstance</span></code></a>)</p>
</div>
<dl class="py method">
