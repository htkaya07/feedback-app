...
<li><span class="link-container"><a class="reference external" href="examples.html">ORM Examples</a></span></li>
    ...
    <div id="docs-body" class="withsidebar orm-events" >
...
<span id="orm-attribute-events"></span><h2>Attribute Events<a class="headerlink" href="#attribute-events" title="Permalink to this headline">¶</a></h2>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents"><code class="sig-name descname">AttributeEvents</code></a></p></td>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.orm.events.</code><code class="sig-name descname">AttributeEvents</code><a class="headerlink" href="#sqlalchemy.orm.events.AttributeEvents" title="Permalink to this definition">¶</a></dt>
...
<span class="nd">@event</span><span class="o">.</span><span class="n">listens_for</span><span class="p">(</span><span class="n">MyClass</span><span class="o">.</span><span class="n">collection</span><span class="p">,</span> <span class="s1">&#39;append&#39;</span><span class="p">,</span> <span class="n">propagate</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
<span class="k">def</span> <span class="nf">my_append_listener</span><span class="p">(</span><span class="n">target</span><span class="p">,</span> <span class="n">value</span><span class="p">,</span> <span class="n">initiator</span><span class="p">):</span>
    <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;received append event for target: </span><span class="si">%s</span><span class="s2">&quot;</span> <span class="o">%</span> <span class="n">target</span><span class="p">)</span></pre></div>
</div>
<p>Listeners have the option to return a possibly modified version of the
value, when the <a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents.params.retval" title="sqlalchemy.orm.events.AttributeEvents"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">AttributeEvents.retval</span></code></a> flag is passed to
<a class="reference internal" href="../core/event.html#sqlalchemy.event.listen" title="sqlalchemy.event.listen"><code class="xref py py-func docutils literal notranslate"><span class="pre">listen()</span></code></a> or <a class="reference internal" href="../core/event.html#sqlalchemy.event.listens_for" title="sqlalchemy.event.listens_for"><code class="xref py py-func docutils literal notranslate"><span class="pre">listens_for()</span></code></a>:</p>
...
<p>The <a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents.params.propagate" title="sqlalchemy.orm.events.AttributeEvents"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">AttributeEvents.propagate</span></code></a> flag is also important when
applying listeners to mapped classes that also have mapped subclasses,
as when using mapper inheritance patterns:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="nd">@event</span><span class="o">.</span><span class="n">listens_for</span><span class="p">(</span><span class="n">MySuperClass</span><span class="o">.</span><span class="n">attr</span><span class="p">,</span> <span class="s1">&#39;set&#39;</span><span class="p">,</span> <span class="n">propagate</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
<span class="k">def</span> <span class="nf">receive_set</span><span class="p">(</span><span class="n">target</span><span class="p">,</span> <span class="n">value</span><span class="p">,</span> <span class="n">initiator</span><span class="p">):</span>
    <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;value set: </span><span class="si">%s</span><span class="s2">&quot;</span> <span class="o">%</span> <span class="n">target</span><span class="p">)</span></pre></div>
</div>
...
<p>class <a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents" title="sqlalchemy.orm.events.AttributeEvents"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.AttributeEvents</span></code></a> (<code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.event.Events</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.orm.events.AttributeEvents.append">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.AttributeEvents.</span></code></a><code class="sig-name descname">append</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">value</span></em>, <em class="sig-param"><span class="n">initiator</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.AttributeEvents.append" title="Permalink to this definition">¶</a></dt>
...
replaces it.</p></li>
<li><p><span class="target" id="sqlalchemy.orm.events.AttributeEvents.append.params.initiator"></span><strong>initiator</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.events.AttributeEvents.append.params.initiator">¶</a> – An instance of <a class="reference internal" href="internals.html#sqlalchemy.orm.attributes.Event" title="sqlalchemy.orm.attributes.Event"><code class="xref py py-class docutils literal notranslate"><span class="pre">Event</span></code></a>
...
<p><a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents" title="sqlalchemy.orm.events.AttributeEvents"><code class="xref py py-class docutils literal notranslate"><span class="pre">AttributeEvents</span></code></a> - background on listener options such
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.AttributeEvents.</span></code></a><code class="sig-name descname">bulk_replace</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">values</span></em>, <em class="sig-param"><span class="n">initiator</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.AttributeEvents.bulk_replace" title="Permalink to this definition">¶</a></dt>
...
<li><p><span class="target" id="sqlalchemy.orm.events.AttributeEvents.bulk_replace.params.initiator"></span><strong>initiator</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.events.AttributeEvents.bulk_replace.params.initiator">¶</a> – An instance of <a class="reference internal" href="internals.html#sqlalchemy.orm.attributes.Event" title="sqlalchemy.orm.attributes.Event"><code class="xref py py-class docutils literal notranslate"><span class="pre">Event</span></code></a>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.AttributeEvents.</span></code></a><code class="sig-name descname">dispose_collection</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">collection</span></em>, <em class="sig-param"><span class="n">collection_adapter</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.AttributeEvents.dispose_collection" title="Permalink to this definition">¶</a></dt>
...
the <code class="xref py py-class docutils literal notranslate"><span class="pre">linker</span></code> hook.</p>
</div>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents" title="sqlalchemy.orm.events.AttributeEvents"><code class="xref py py-class docutils literal notranslate"><span class="pre">AttributeEvents</span></code></a> - background on listener options such
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.AttributeEvents.</span></code></a><code class="sig-name descname">init_collection</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">collection</span></em>, <em class="sig-param"><span class="n">collection_adapter</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.AttributeEvents.init_collection" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.AttributeEvents.</span></code></a><code class="sig-name descname">init_scalar</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">value</span></em>, <em class="sig-param"><span class="n">dict_</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.AttributeEvents.init_scalar" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.AttributeEvents.</span></code></a><code class="sig-name descname">modified</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">initiator</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.AttributeEvents.modified" title="Permalink to this definition">¶</a></dt>
...
If the listener is registered with <code class="docutils literal notranslate"><span class="pre">raw=True</span></code>, this will
be the <a class="reference internal" href="internals.html#sqlalchemy.orm.state.InstanceState" title="sqlalchemy.orm.state.InstanceState"><code class="xref py py-class docutils literal notranslate"><span class="pre">InstanceState</span></code></a> object.</p></li>
<li><p><span class="target" id="sqlalchemy.orm.events.AttributeEvents.modified.params.initiator"></span><strong>initiator</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.events.AttributeEvents.modified.params.initiator">¶</a> – An instance of <a class="reference internal" href="internals.html#sqlalchemy.orm.attributes.Event" title="sqlalchemy.orm.attributes.Event"><code class="xref py py-class docutils literal notranslate"><span class="pre">Event</span></code></a>
representing the initiation of the event.</p></li>
</ul>
</dd>
</dl>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.AttributeEvents.</span></code></a><code class="sig-name descname">remove</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">value</span></em>, <em class="sig-param"><span class="n">initiator</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.AttributeEvents.remove" title="Permalink to this definition">¶</a></dt>
...
<li><p><span class="target" id="sqlalchemy.orm.events.AttributeEvents.remove.params.initiator"></span><strong>initiator</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.events.AttributeEvents.remove.params.initiator">¶</a> – <p>An instance of <a class="reference internal" href="internals.html#sqlalchemy.orm.attributes.Event" title="sqlalchemy.orm.attributes.Event"><code class="xref py py-class docutils literal notranslate"><span class="pre">Event</span></code></a>
representing the initiation of the event.  May be modified
from its original value by backref handlers in order to control
...
passed as a <a class="reference internal" href="internals.html#sqlalchemy.orm.attributes.Event" title="sqlalchemy.orm.attributes.Event"><code class="xref py py-class docutils literal notranslate"><span class="pre">Event</span></code></a> object, and may be
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.AttributeEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.AttributeEvents.</span></code></a><code class="sig-name descname">set</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">value</span></em>, <em class="sig-param"><span class="n">oldvalue</span></em>, <em class="sig-param"><span class="n">initiator</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.AttributeEvents.set" title="Permalink to this definition">¶</a></dt>
...
or expired.</p></li>
<li><p><span class="target" id="sqlalchemy.orm.events.AttributeEvents.set.params.initiator"></span><strong>initiator</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.events.AttributeEvents.set.params.initiator">¶</a> – <p>An instance of <a class="reference internal" href="internals.html#sqlalchemy.orm.attributes.Event" title="sqlalchemy.orm.attributes.Event"><code class="xref py py-class docutils literal notranslate"><span class="pre">Event</span></code></a>
representing the initiation of the event.  May be modified
from its original value by backref handlers in order to control
chained event propagation.</p>
<div class="versionchanged">
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="sig-name descname">MapperEvents</code></a></p></td>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.orm.events.</code><code class="sig-name descname">MapperEvents</code><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents" title="Permalink to this definition">¶</a></dt>
...
<li><p>the <a class="reference internal" href="mapping_api.html#sqlalchemy.orm.Mapper" title="sqlalchemy.orm.Mapper"><code class="xref py py-class docutils literal notranslate"><span class="pre">Mapper</span></code></a> class itself and the <a class="reference internal" href="mapping_api.html#sqlalchemy.orm.mapper" title="sqlalchemy.orm.mapper"><code class="xref py py-func docutils literal notranslate"><span class="pre">mapper()</span></code></a>
...
persistence methods <a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents.before_insert" title="sqlalchemy.orm.events.MapperEvents.before_insert"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MapperEvents.before_insert()</span></code></a>,
and <a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents.before_update" title="sqlalchemy.orm.events.MapperEvents.before_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MapperEvents.before_update()</span></code></a> are popular
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents" title="sqlalchemy.orm.events.MapperEvents"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents</span></code></a> (<code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.event.Events</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.orm.events.MapperEvents.after_configured">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents.</span></code></a><code class="sig-name descname">after_configured</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents.after_configured" title="Permalink to this definition">¶</a></dt>
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents.before_mapper_configured" title="sqlalchemy.orm.events.MapperEvents.before_mapper_configured"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MapperEvents.before_mapper_configured()</span></code></a></p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents.</span></code></a><code class="sig-name descname">after_delete</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">connection</span></em>, <em class="sig-param"><span class="n">target</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents.after_delete" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents.</span></code></a><code class="sig-name descname">after_insert</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">connection</span></em>, <em class="sig-param"><span class="n">target</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents.after_insert" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents.</span></code></a><code class="sig-name descname">after_update</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">connection</span></em>, <em class="sig-param"><span class="n">target</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents.after_update" title="Permalink to this definition">¶</a></dt>
...
being sent to <a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents.after_update" title="sqlalchemy.orm.events.MapperEvents.after_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MapperEvents.after_update()</span></code></a> is
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents.</span></code></a><code class="sig-name descname">before_configured</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents.before_configured" title="Permalink to this definition">¶</a></dt>
...
as well as <a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents.before_mapper_configured" title="sqlalchemy.orm.events.MapperEvents.before_mapper_configured"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MapperEvents.before_mapper_configured()</span></code></a>
and <a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents.mapper_configured" title="sqlalchemy.orm.events.MapperEvents.mapper_configured"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MapperEvents.mapper_configured()</span></code></a>, which are both invoked
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents.</span></code></a><code class="sig-name descname">before_delete</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">connection</span></em>, <em class="sig-param"><span class="n">target</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents.before_delete" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents.</span></code></a><code class="sig-name descname">before_insert</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">connection</span></em>, <em class="sig-param"><span class="n">target</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents.before_insert" title="Permalink to this definition">¶</a></dt>
...
<dl class="py method">
<dt id="sqlalchemy.orm.events.MapperEvents.before_mapper_configured">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents.</span></code></a><code class="sig-name descname">before_mapper_configured</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">class_</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents.before_mapper_configured" title="Permalink to this definition">¶</a></dt>
...
<span class="k">def</span> <span class="nf">receive_before_mapper_configured</span><span class="p">(</span><span class="n">mapper</span><span class="p">,</span> <span class="n">class_</span><span class="p">):</span>
...
<a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents.before_configured" title="sqlalchemy.orm.events.MapperEvents.before_configured"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MapperEvents.before_configured()</span></code></a>,
<a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents.after_configured" title="sqlalchemy.orm.events.MapperEvents.after_configured"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MapperEvents.after_configured()</span></code></a>, and
<a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents.mapper_configured" title="sqlalchemy.orm.events.MapperEvents.mapper_configured"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MapperEvents.mapper_configured()</span></code></a>, the
...
<p>e.g.:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy.orm</span> <span class="k">import</span> <span class="n">EXT_SKIP</span>
...
<span class="nd">@event</span><span class="o">.</span><span class="n">listens_for</span><span class="p">(</span>
    ...
    <span class="s2">&quot;before_mapper_configured&quot;</span><span class="p">,</span> <span class="n">retval</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">propagate</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
<span class="k">def</span> <span class="nf">dont_configure</span><span class="p">(</span><span class="n">mapper</span><span class="p">,</span> <span class="bp">cls</span><span class="p">):</span>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents.</span></code></a><code class="sig-name descname">before_update</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">connection</span></em>, <em class="sig-param"><span class="n">target</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents.before_update" title="Permalink to this definition">¶</a></dt>
...
column-based attributes have any net changes, no UPDATE
statement will be issued. This means that an instance
being sent to <a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents.before_update" title="sqlalchemy.orm.events.MapperEvents.before_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MapperEvents.before_update()</span></code></a> is
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents.</span></code></a><code class="sig-name descname">instrument_class</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">class_</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents.instrument_class" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.MapperEvents.</span></code></a><code class="sig-name descname">mapper_configured</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">class_</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.MapperEvents.mapper_configured" title="Permalink to this definition">¶</a></dt>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents"><code class="sig-name descname">InstanceEvents</code></a></p></td>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.orm.events.</code><code class="sig-name descname">InstanceEvents</code><a class="headerlink" href="#sqlalchemy.orm.events.InstanceEvents" title="Permalink to this definition">¶</a></dt>
...
<span class="k">def</span> <span class="nf">my_load_listener</span><span class="p">(</span><span class="n">target</span><span class="p">,</span> <span class="n">context</span><span class="p">):</span>
    <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;on load!&quot;</span><span class="p">)</span>
...
instance’s <a class="reference internal" href="internals.html#sqlalchemy.orm.state.InstanceState" title="sqlalchemy.orm.state.InstanceState"><code class="xref py py-class docutils literal notranslate"><span class="pre">InstanceState</span></code></a> management
object, rather than the mapped instance itself.</p></li>
<li><p><span class="target" id="sqlalchemy.orm.events.InstanceEvents.params.restore_load_context"></span><strong>restore_load_context=False</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.events.InstanceEvents.params.restore_load_context">¶</a> – <p>Applies to the
<a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents.load" title="sqlalchemy.orm.events.InstanceEvents.load"><code class="xref py py-meth docutils literal notranslate"><span class="pre">InstanceEvents.load()</span></code></a> and <a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents.refresh" title="sqlalchemy.orm.events.InstanceEvents.refresh"><code class="xref py py-meth docutils literal notranslate"><span class="pre">InstanceEvents.refresh()</span></code></a>
...
events if this flag is not set.</p>
<div class="versionadded">
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents" title="sqlalchemy.orm.events.InstanceEvents"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstanceEvents</span></code></a> (<code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.event.Events</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.orm.events.InstanceEvents.expire">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstanceEvents.</span></code></a><code class="sig-name descname">expire</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">attrs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstanceEvents.expire" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstanceEvents.</span></code></a><code class="sig-name descname">first_init</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">manager</span></em>, <em class="sig-param"><span class="n">cls</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstanceEvents.first_init" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstanceEvents.</span></code></a><code class="sig-name descname">init</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">args</span></em>, <em class="sig-param"><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstanceEvents.init" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstanceEvents.</span></code></a><code class="sig-name descname">init_failure</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">args</span></em>, <em class="sig-param"><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstanceEvents.init_failure" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstanceEvents.</span></code></a><code class="sig-name descname">load</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">context</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstanceEvents.load" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents.params.restore_load_context" title="sqlalchemy.orm.events.InstanceEvents"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">InstanceEvents.restore_load_context</span></code></a> option may  be
...
event is called:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="nd">@event</span><span class="o">.</span><span class="n">listens_for</span><span class="p">(</span>
    <span class="n">SomeClass</span><span class="p">,</span> <span class="s2">&quot;load&quot;</span><span class="p">,</span> <span class="n">restore_load_context</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
<span class="k">def</span> <span class="nf">on_load</span><span class="p">(</span><span class="n">instance</span><span class="p">,</span> <span class="n">context</span><span class="p">):</span>
    <span class="n">instance</span><span class="o">.</span><span class="n">some_unloaded_attribute</span></pre></div>
</div>
<div class="versionchanged">
<p><span class="versionmodified changed">Changed in version 1.3.14: </span>Added
<a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents.params.restore_load_context" title="sqlalchemy.orm.events.InstanceEvents"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">InstanceEvents.restore_load_context</span></code></a>
and <a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.params.restore_load_context" title="sqlalchemy.orm.events.SessionEvents"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">SessionEvents.restore_load_context</span></code></a> flags which
...
changes without this flag being set.</p>
</div>
</div>
...
class-method decorator format called <a class="reference internal" href="constructors.html#sqlalchemy.orm.reconstructor" title="sqlalchemy.orm.reconstructor"><code class="xref py py-func docutils literal notranslate"><span class="pre">reconstructor()</span></code></a>.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><ul class="simple">
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstanceEvents.</span></code></a><code class="sig-name descname">pickle</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">state_dict</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstanceEvents.pickle" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstanceEvents.</span></code></a><code class="sig-name descname">refresh</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">context</span></em>, <em class="sig-param"><span class="n">attrs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstanceEvents.refresh" title="Permalink to this definition">¶</a></dt>
...
on <a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents.load" title="sqlalchemy.orm.events.InstanceEvents.load"><code class="xref py py-meth docutils literal notranslate"><span class="pre">InstanceEvents.load()</span></code></a> for background on making use of the
<a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents.params.restore_load_context" title="sqlalchemy.orm.events.InstanceEvents"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">InstanceEvents.restore_load_context</span></code></a> parameter, in
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstanceEvents.</span></code></a><code class="sig-name descname">refresh_flush</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">flush_context</span></em>, <em class="sig-param"><span class="n">attrs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstanceEvents.refresh_flush" title="Permalink to this definition">¶</a></dt>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>While the <a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents.refresh_flush" title="sqlalchemy.orm.events.InstanceEvents.refresh_flush"><code class="xref py py-meth docutils literal notranslate"><span class="pre">InstanceEvents.refresh_flush()</span></code></a> event is triggered
...
<a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.pending_to_persistent" title="sqlalchemy.orm.events.SessionEvents.pending_to_persistent"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.pending_to_persistent()</span></code></a> and
<a class="reference internal" href="#sqlalchemy.orm.events.MapperEvents.after_insert" title="sqlalchemy.orm.events.MapperEvents.after_insert"><code class="xref py py-meth docutils literal notranslate"><span class="pre">MapperEvents.after_insert()</span></code></a> are better choices.</p>
</div>
<div class="versionadded">
...
<p><a class="reference internal" href="../core/defaults.html"><span class="std std-ref">Column INSERT/UPDATE Defaults</span></a></p>
</div>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.orm.events.InstanceEvents.unpickle">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstanceEvents.</span></code></a><code class="sig-name descname">unpickle</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">target</span></em>, <em class="sig-param"><span class="n">state_dict</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstanceEvents.unpickle" title="Permalink to this definition">¶</a></dt>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="sig-name descname">SessionEvents</code></a></p></td>
<td><p>Define events specific to <a class="reference internal" href="session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> lifecycle.</p></td>
</tr>
</tbody>
</table>
<dl class="py class">
<dt id="sqlalchemy.orm.events.SessionEvents">
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.orm.events.</code><code class="sig-name descname">SessionEvents</code><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents" title="Permalink to this definition">¶</a></dt>
<dd><p>Define events specific to <a class="reference internal" href="session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> lifecycle.</p>
<p>e.g.:</p>
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="kn">from</span> <span class="nn">sqlalchemy</span> <span class="k">import</span> <span class="n">event</span>
...
<span class="k">def</span> <span class="nf">my_before_commit</span><span class="p">(</span><span class="n">session</span><span class="p">):</span>
    <span class="nb">print</span><span class="p">(</span><span class="s2">&quot;before commit!&quot;</span><span class="p">)</span>
...
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><ul class="simple">
<li><p><span class="target" id="sqlalchemy.orm.events.SessionEvents.params.raw"></span><strong>raw=False</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.events.SessionEvents.params.raw">¶</a> – <p>When True, the “target” argument passed
to applicable event listener functions that work on individual
objects will be the instance’s <a class="reference internal" href="internals.html#sqlalchemy.orm.state.InstanceState" title="sqlalchemy.orm.state.InstanceState"><code class="xref py py-class docutils literal notranslate"><span class="pre">InstanceState</span></code></a> management
object, rather than the mapped instance itself.</p>
<div class="versionadded">
<p><span class="versionmodified added">New in version 1.3.14.</span></p>
</div>
</p></li>
<li><p><span class="target" id="sqlalchemy.orm.events.SessionEvents.params.restore_load_context"></span><strong>restore_load_context=False</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.events.SessionEvents.params.restore_load_context">¶</a> – <p>Applies to the
<a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.loaded_as_persistent" title="sqlalchemy.orm.events.SessionEvents.loaded_as_persistent"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.loaded_as_persistent()</span></code></a> event.  Restores the loader
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents" title="sqlalchemy.orm.events.SessionEvents"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents</span></code></a> (<code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.event.Events</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.orm.events.SessionEvents.after_attach">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">after_attach</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.after_attach" title="Permalink to this definition">¶</a></dt>
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.before_attach" title="sqlalchemy.orm.events.SessionEvents.before_attach"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.before_attach()</span></code></a></p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">after_begin</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">transaction</span></em>, <em class="sig-param"><span class="n">connection</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.after_begin" title="Permalink to this definition">¶</a></dt>
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.before_commit" title="sqlalchemy.orm.events.SessionEvents.before_commit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.before_commit()</span></code></a></p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_commit" title="sqlalchemy.orm.events.SessionEvents.after_commit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_commit()</span></code></a></p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_transaction_create" title="sqlalchemy.orm.events.SessionEvents.after_transaction_create"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_transaction_create()</span></code></a></p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_transaction_end" title="sqlalchemy.orm.events.SessionEvents.after_transaction_end"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_transaction_end()</span></code></a></p>
</div>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.orm.events.SessionEvents.after_bulk_delete">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">after_bulk_delete</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">delete_context</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.after_bulk_delete" title="Permalink to this definition">¶</a></dt>
...
<p><span class="versionmodified deprecated">Deprecated since version 0.9: </span>The <code class="xref py py-class docutils literal notranslate"><span class="pre">after_bulk_delete</span></code> event now accepts the 
...
<li><p><code class="docutils literal notranslate"><span class="pre">query</span></code> -the <a class="reference internal" href="query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal notranslate"><span class="pre">Query</span></code></a>
...
<li><p><code class="docutils literal notranslate"><span class="pre">result</span></code> the <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a>
...
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_bulk_update" title="sqlalchemy.orm.events.SessionEvents.after_bulk_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_bulk_update()</span></code></a></p>
</div>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.orm.events.SessionEvents.after_bulk_update">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">after_bulk_update</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">update_context</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.after_bulk_update" title="Permalink to this definition">¶</a></dt>
...
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since version 0.9: </span>The <code class="xref py py-class docutils literal notranslate"><span class="pre">after_bulk_update</span></code> event now accepts the 
...
<a class="reference internal" href="query.html#sqlalchemy.orm.query.Query.update" title="sqlalchemy.orm.query.Query.update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.update()</span></code></a>.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">context</span></code> The <a class="reference internal" href="internals.html#sqlalchemy.orm.query.QueryContext" title="sqlalchemy.orm.query.QueryContext"><code class="xref py py-class docutils literal notranslate"><span class="pre">QueryContext</span></code></a> object, corresponding
to the invocation of an ORM query.</p></li>
<li><p><code class="docutils literal notranslate"><span class="pre">result</span></code> the <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a>
returned as a result of the
...
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_bulk_delete" title="sqlalchemy.orm.events.SessionEvents.after_bulk_delete"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_bulk_delete()</span></code></a></p>
</div>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.orm.events.SessionEvents.after_commit">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">after_commit</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.after_commit" title="Permalink to this definition">¶</a></dt>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The <a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_commit" title="sqlalchemy.orm.events.SessionEvents.after_commit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_commit()</span></code></a> hook is <em>not</em> per-flush,
...
<a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.before_flush" title="sqlalchemy.orm.events.SessionEvents.before_flush"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.before_flush()</span></code></a>,
<a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_flush" title="sqlalchemy.orm.events.SessionEvents.after_flush"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_flush()</span></code></a>, or
<a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_flush_postexec" title="sqlalchemy.orm.events.SessionEvents.after_flush_postexec"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_flush_postexec()</span></code></a>
events.</p>
</div>
<div class="admonition note">
<p class="admonition-title">Note</p>
...
when the <a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_commit" title="sqlalchemy.orm.events.SessionEvents.after_commit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_commit()</span></code></a> event is invoked,
and therefore can not emit SQL.  To emit SQL corresponding to
every transaction, use the <a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.before_commit" title="sqlalchemy.orm.events.SessionEvents.before_commit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.before_commit()</span></code></a>
event.</p>
</div>
<dl class="field-list simple">
<dt class="field-odd">Parameters</dt>
...
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.before_commit" title="sqlalchemy.orm.events.SessionEvents.before_commit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.before_commit()</span></code></a></p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_begin" title="sqlalchemy.orm.events.SessionEvents.after_begin"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_begin()</span></code></a></p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_transaction_create" title="sqlalchemy.orm.events.SessionEvents.after_transaction_create"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_transaction_create()</span></code></a></p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_transaction_end" title="sqlalchemy.orm.events.SessionEvents.after_transaction_end"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_transaction_end()</span></code></a></p>
</div>
</dd></dl>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">after_flush</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">flush_context</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.after_flush" title="Permalink to this definition">¶</a></dt>
...
<div class="admonition warning">
<p class="admonition-title">Warning</p>
<p>This event runs after the <a class="reference internal" href="session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> has emitted
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.before_flush" title="sqlalchemy.orm.events.SessionEvents.before_flush"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.before_flush()</span></code></a></p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_flush_postexec" title="sqlalchemy.orm.events.SessionEvents.after_flush_postexec"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_flush_postexec()</span></code></a></p>
<p><a class="reference internal" href="session_events.html#session-persistence-events"><span class="std std-ref">Persistence Events</span></a></p>
</div>
</dd></dl>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">after_flush_postexec</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">flush_context</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.after_flush_postexec" title="Permalink to this definition">¶</a></dt>
...
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.before_flush" title="sqlalchemy.orm.events.SessionEvents.before_flush"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.before_flush()</span></code></a></p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_flush" title="sqlalchemy.orm.events.SessionEvents.after_flush"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_flush()</span></code></a></p>
<p><a class="reference internal" href="session_events.html#session-persistence-events"><span class="std std-ref">Persistence Events</span></a></p>
</div>
</dd></dl>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">after_rollback</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.after_rollback" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">after_soft_rollback</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">previous_transaction</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.after_soft_rollback" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">after_transaction_create</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">transaction</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.after_transaction_create" title="Permalink to this definition">¶</a></dt>
...
<p>This event differs from <a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_begin" title="sqlalchemy.orm.events.SessionEvents.after_begin"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_begin()</span></code></a>
...
<a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_transaction_end" title="sqlalchemy.orm.events.SessionEvents.after_transaction_end"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_transaction_end()</span></code></a> event
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">after_transaction_end</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">transaction</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.after_transaction_end" title="Permalink to this definition">¶</a></dt>
...
<p>This event differs from <a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_commit" title="sqlalchemy.orm.events.SessionEvents.after_commit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_commit()</span></code></a>
...
<a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_transaction_create" title="sqlalchemy.orm.events.SessionEvents.after_transaction_create"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_transaction_create()</span></code></a> event.</p>
<dl class="field-list simple">
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><ul class="simple">
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">before_attach</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.before_attach" title="Permalink to this definition">¶</a></dt>
...
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.after_attach" title="sqlalchemy.orm.events.SessionEvents.after_attach"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.after_attach()</span></code></a></p>
<p><a class="reference internal" href="session_events.html#session-lifecycle-events"><span class="std std-ref">Object Lifecycle Events</span></a></p>
</div>
</dd></dl>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">before_commit</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.before_commit" title="Permalink to this definition">¶</a></dt>
...
<div class="admonition note">
<p class="admonition-title">Note</p>
<p>The <a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.before_commit" title="sqlalchemy.orm.events.SessionEvents.before_commit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.before_commit()</span></code></a> hook is <em>not</em> per-flush,
that is, the <a class="reference internal" href="session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> can emit SQL to the database
many times within the scope of a transaction.
For interception of these events, use the
<a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.before_flush" title="sqlalchemy.orm.events.SessionEvents.before_flush"><code class="xref py py-meth docutils literal notranslate"><span class="pre">SessionEvents.before_flush()</span></code></a>,
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">before_flush</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">flush_context</span></em>, <em class="sig-param"><span class="n">instances</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.before_flush" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">deleted_to_detached</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.deleted_to_detached" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">deleted_to_persistent</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.deleted_to_persistent" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">detached_to_persistent</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.detached_to_persistent" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">loaded_as_persistent</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.loaded_as_persistent" title="Permalink to this definition">¶</a></dt>
...
context, interfering with the existing load context.   See the note
on <a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents.load" title="sqlalchemy.orm.events.InstanceEvents.load"><code class="xref py py-meth docutils literal notranslate"><span class="pre">InstanceEvents.load()</span></code></a> for background on making use of the
<a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents.params.restore_load_context" title="sqlalchemy.orm.events.SessionEvents"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">SessionEvents.restore_load_context</span></code></a> parameter, which
works in the same manner as that of
<a class="reference internal" href="#sqlalchemy.orm.events.InstanceEvents.params.restore_load_context" title="sqlalchemy.orm.events.InstanceEvents"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">InstanceEvents.restore_load_context</span></code></a>, in  order to
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">pending_to_persistent</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.pending_to_persistent" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">pending_to_transient</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.pending_to_transient" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">persistent_to_deleted</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.persistent_to_deleted" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">persistent_to_detached</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.persistent_to_detached" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">persistent_to_transient</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.persistent_to_transient" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.SessionEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.SessionEvents.</span></code></a><code class="sig-name descname">transient_to_pending</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.SessionEvents.transient_to_pending" title="Permalink to this definition">¶</a></dt>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.events.QueryEvents"><code class="sig-name descname">QueryEvents</code></a></p></td>
<td><p>Represent events within the construction of a <a class="reference internal" href="query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal notranslate"><span class="pre">Query</span></code></a>
object.</p></td>
</tr>
</tbody>
</table>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.orm.events.</code><code class="sig-name descname">QueryEvents</code><a class="headerlink" href="#sqlalchemy.orm.events.QueryEvents" title="Permalink to this definition">¶</a></dt>
<dd><p>Represent events within the construction of a <a class="reference internal" href="query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal notranslate"><span class="pre">Query</span></code></a>
object.</p>
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.orm.events.QueryEvents" title="sqlalchemy.orm.events.QueryEvents"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.QueryEvents</span></code></a> (<code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.event.Events</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.orm.events.QueryEvents.before_compile">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.QueryEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.QueryEvents.</span></code></a><code class="sig-name descname">before_compile</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">query</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.QueryEvents.before_compile" title="Permalink to this definition">¶</a></dt>
<dd><p>Receive the <a class="reference internal" href="query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal notranslate"><span class="pre">Query</span></code></a>
...
<p>The <a class="reference internal" href="#sqlalchemy.orm.events.QueryEvents.before_compile" title="sqlalchemy.orm.events.QueryEvents.before_compile"><code class="xref py py-meth docutils literal notranslate"><span class="pre">QueryEvents.before_compile()</span></code></a> event by default
will disallow “baked” queries from caching a query, if the event
hook returns a new <a class="reference internal" href="query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal notranslate"><span class="pre">Query</span></code></a> object.
...
<div class="highlight-default notranslate"><div class="highlight"><pre><span></span><span class="nd">@event</span><span class="o">.</span><span class="n">listens_for</span><span class="p">(</span>
    <span class="n">Query</span><span class="p">,</span> <span class="s2">&quot;before_compile&quot;</span><span class="p">,</span> <span class="n">retval</span><span class="o">=</span><span class="kc">True</span><span class="p">,</span> <span class="n">bake_ok</span><span class="o">=</span><span class="kc">True</span><span class="p">)</span>
...
<div class="versionadded">
<p><span class="versionmodified added">New in version 1.3.11: </span>- added the “bake_ok” flag to the
<a class="reference internal" href="#sqlalchemy.orm.events.QueryEvents.before_compile" title="sqlalchemy.orm.events.QueryEvents.before_compile"><code class="xref py py-meth docutils literal notranslate"><span class="pre">QueryEvents.before_compile()</span></code></a> event and disallowed caching via
the “baked” extension from occurring for event handlers that
return  a new <a class="reference internal" href="query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal notranslate"><span class="pre">Query</span></code></a> object if this flag is not set.</p>
</div>
<div class="admonition seealso">
<p class="admonition-title">See also</p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.QueryEvents.before_compile_update" title="sqlalchemy.orm.events.QueryEvents.before_compile_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">QueryEvents.before_compile_update()</span></code></a></p>
<p><a class="reference internal" href="#sqlalchemy.orm.events.QueryEvents.before_compile_delete" title="sqlalchemy.orm.events.QueryEvents.before_compile_delete"><code class="xref py py-meth docutils literal notranslate"><span class="pre">QueryEvents.before_compile_delete()</span></code></a></p>
<p><a class="reference internal" href="extensions/baked.html#baked-with-before-compile"><span class="std std-ref">Using the before_compile event</span></a></p>
</div>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.orm.events.QueryEvents.before_compile_delete">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.QueryEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.QueryEvents.</span></code></a><code class="sig-name descname">before_compile_delete</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">query</span></em>, <em class="sig-param"><span class="n">delete_context</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.QueryEvents.before_compile_delete" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.QueryEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.QueryEvents.</span></code></a><code class="sig-name descname">before_compile_update</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">query</span></em>, <em class="sig-param"><span class="n">update_context</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.QueryEvents.before_compile_update" title="Permalink to this definition">¶</a></dt>
<dd><p>Allow modifications to the <a class="reference internal" href="query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal notranslate"><span class="pre">Query</span></code></a> object within
...
<p>Like the <a class="reference internal" href="#sqlalchemy.orm.events.QueryEvents.before_compile" title="sqlalchemy.orm.events.QueryEvents.before_compile"><code class="xref py py-meth docutils literal notranslate"><span class="pre">QueryEvents.before_compile()</span></code></a> event, if the event
is to be used to alter the <a class="reference internal" href="query.html#sqlalchemy.orm.query.Query" title="sqlalchemy.orm.query.Query"><code class="xref py py-class docutils literal notranslate"><span class="pre">Query</span></code></a> object, it should
...
<span class="k">def</span> <span class="nf">no_deleted</span><span class="p">(</span><span class="n">query</span><span class="p">,</span> <span class="n">update_context</span><span class="p">):</span>
    <span class="k">for</span> <span class="n">desc</span> <span class="ow">in</span> <span class="n">query</span><span class="o">.</span><span class="n">column_descriptions</span><span class="p">:</span>
        <span class="k">if</span> <span class="n">desc</span><span class="p">[</span><span class="s1">&#39;type&#39;</span><span class="p">]</span> <span class="ow">is</span> <span class="n">User</span><span class="p">:</span>
            ...
            <span class="n">update_context</span><span class="o">.</span><span class="n">values</span><span class="p">[</span><span class="s1">&#39;timestamp&#39;</span><span class="p">]</span> <span class="o">=</span> <span class="n">datetime</span><span class="o">.</span><span class="n">utcnow</span><span class="p">()</span>
    <span class="k">return</span> <span class="n">query</span></pre></div>
</div>
...
the dictionary of parameters passed to <a class="reference internal" href="query.html#sqlalchemy.orm.query.Query.update" title="sqlalchemy.orm.query.Query.update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.update()</span></code></a>.
This
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.events.InstrumentationEvents"><code class="sig-name descname">InstrumentationEvents</code></a></p></td>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.orm.events.</code><code class="sig-name descname">InstrumentationEvents</code><a class="headerlink" href="#sqlalchemy.orm.events.InstrumentationEvents" title="Permalink to this definition">¶</a></dt>
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.orm.events.InstrumentationEvents" title="sqlalchemy.orm.events.InstrumentationEvents"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstrumentationEvents</span></code></a> (<code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.event.Events</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.orm.events.InstrumentationEvents.attribute_instrument">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstrumentationEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstrumentationEvents.</span></code></a><code class="sig-name descname">attribute_instrument</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">cls</span></em>, <em class="sig-param"><span class="n">key</span></em>, <em class="sig-param"><span class="n">inst</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstrumentationEvents.attribute_instrument" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstrumentationEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstrumentationEvents.</span></code></a><code class="sig-name descname">class_instrument</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">cls</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstrumentationEvents.class_instrument" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.events.InstrumentationEvents"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.events.InstrumentationEvents.</span></code></a><code class="sig-name descname">class_uninstrument</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">cls</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.events.InstrumentationEvents.class_uninstrument" title="Permalink to this definition">¶</a></dt>
