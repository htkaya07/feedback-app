...
<li><span class="link-container"><a class="reference external" href="examples.html">ORM Examples</a></span></li>
    ...
    <div id="docs-body" class="withsidebar orm-session_api" >
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="sig-name descname">Session</code></a></p></td>
<td><p>Manages persistence operations for ORM-mapped objects.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.session.sessionmaker"><code class="sig-name descname">sessionmaker</code></a></p></td>
<td><p>A configurable <a class="reference internal" href="#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> factory.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.session.SessionTransaction"><code class="sig-name descname">SessionTransaction</code></a></p></td>
<td><p>A <a class="reference internal" href="#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a>-level transaction.</p></td>
</tr>
</tbody>
</table>
<dl class="py class">
<dt id="sqlalchemy.orm.session.sessionmaker">
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.orm.session.</code><code class="sig-name descname">sessionmaker</code><span class="sig-paren">(</span><em class="sig-param">bind=None</em>, <em class="sig-param">class_=&lt;class 'sqlalchemy.orm.session.Session'&gt;</em>, <em class="sig-param">autoflush=True</em>, <em class="sig-param">autocommit=False</em>, <em class="sig-param">expire_on_commit=True</em>, <em class="sig-param">info=None</em>, <em class="sig-param">**kw</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.sessionmaker" title="Permalink to this definition">¶</a></dt>
<dd><p>A configurable <a class="reference internal" href="#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> factory.</p>
...
This is usually used to associate one or more <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a>
objects
...
<p><a class="reference internal" href="session_basics.html#session-getting"><span class="std std-ref">Getting a Session</span></a> - introductory text on creating
sessions using <a class="reference internal" href="#sqlalchemy.orm.session.sessionmaker" title="sqlalchemy.orm.session.sessionmaker"><code class="xref py py-class docutils literal notranslate"><span class="pre">sessionmaker</span></code></a>.</p>
</div>
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.orm.session.sessionmaker" title="sqlalchemy.orm.session.sessionmaker"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.sessionmaker</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session._SessionClassMethods</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.orm.session.sessionmaker.__call__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.sessionmaker"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.sessionmaker.</span></code></a><code class="sig-name descname">__call__</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">local_kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.sessionmaker.__call__" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.sessionmaker"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.sessionmaker.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param">bind=None</em>, <em class="sig-param">class_=&lt;class 'sqlalchemy.orm.session.Session'&gt;</em>, <em class="sig-param">autoflush=True</em>, <em class="sig-param">autocommit=False</em>, <em class="sig-param">expire_on_commit=True</em>, <em class="sig-param">info=None</em>, <em class="sig-param">**kw</em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.sessionmaker.__init__" title="Permalink to this definition">¶</a></dt>
...
<li><p><span class="target" id="sqlalchemy.orm.session.sessionmaker.params.bind"></span><strong>bind</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.session.sessionmaker.params.bind">¶</a> – a <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a> or other <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connectable" title="sqlalchemy.engine.Connectable"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connectable</span></code></a>
with
...
<a class="reference internal" href="#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> objects.</p></li>
<li><p><span class="target" id="sqlalchemy.orm.session.sessionmaker.params.expire_on_commit"></span><strong>expire_on_commit=True</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.session.sessionmaker.params.expire_on_commit">¶</a> – the
<code class="xref py py-paramref docutils literal notranslate"><span class="pre">Session.expire_on_commit</span></code> setting to use
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.sessionmaker"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.sessionmaker.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">close_all</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.sessionmaker.close_all" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session._SessionClassMethods.close_all</span></code> <em>method of</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session._SessionClassMethods</span></code></p>
</div>
<p>Close <em>all</em> sessions in memory.</p>
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since version 1.3: </span>The <a class="reference internal" href="#sqlalchemy.orm.session.Session.close_all" title="sqlalchemy.orm.session.Session.close_all"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.close_all()</span></code></a> method is deprecated and will be removed in a future release.  Please refer to <a class="reference internal" href="#sqlalchemy.orm.session.close_all_sessions" title="sqlalchemy.orm.session.close_all_sessions"><code class="xref py py-func docutils literal notranslate"><span class="pre">close_all_sessions()</span></code></a>.</p>
</div>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.orm.session.sessionmaker.configure">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.sessionmaker"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.sessionmaker.</span></code></a><code class="sig-name descname">configure</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">**</span><span class="n">new_kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.sessionmaker.configure" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.sessionmaker"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.sessionmaker.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">identity_key</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">orm_util</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">args</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.sessionmaker.identity_key" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.sessionmaker"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.sessionmaker.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">object_session</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.sessionmaker.object_session" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.orm.session.</code><code class="sig-name descname">Session</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">bind</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">autoflush</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">expire_on_commit</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">_enable_transaction_accounting</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">autocommit</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">twophase</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">weak_identity_map</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">binds</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">extension</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">enable_baked_queries</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">info</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">query_cls</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session" title="Permalink to this definition">¶</a></dt>
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session</span></code></a> (<code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session._SessionClassMethods</span></code>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.orm.session.Session.__init__">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">__init__</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">bind</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">autoflush</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">expire_on_commit</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">_enable_transaction_accounting</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">autocommit</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">twophase</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">weak_identity_map</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">binds</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">extension</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">enable_baked_queries</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">info</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">query_cls</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.__init__" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#sqlalchemy.orm.session.Session.flush" title="sqlalchemy.orm.session.Session.flush"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.flush()</span></code></a> call to this <code class="docutils literal notranslate"><span class="pre">Session</span></code> before proceeding.
This is a convenience feature so that <a class="reference internal" href="#sqlalchemy.orm.session.Session.flush" title="sqlalchemy.orm.session.Session.flush"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.flush()</span></code></a> need
...
<a class="reference internal" href="#sqlalchemy.orm.session.Session.flush" title="sqlalchemy.orm.session.Session.flush"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.flush()</span></code></a> are rarely needed; you usually only need to
call <a class="reference internal" href="#sqlalchemy.orm.session.Session.commit" title="sqlalchemy.orm.session.Session.commit"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.commit()</span></code></a> (which flushes) to finalize changes.</p></li>
...
<li><p><span class="target" id="sqlalchemy.orm.session.Session.params._enable_transaction_accounting"></span><strong>_enable_transaction_accounting</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.session.Session.params._enable_transaction_accounting">¶</a> – <p>A
...
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since version 0.7: </span><a class="reference internal" href="deprecated.html#sqlalchemy.orm.interfaces.SessionExtension" title="sqlalchemy.orm.interfaces.SessionExtension"><code class="xref py py-class docutils literal notranslate"><span class="pre">SessionExtension</span></code></a> is deprecated in favor of the <a class="reference internal" href="events.html#sqlalchemy.orm.events.SessionEvents" title="sqlalchemy.orm.events.SessionEvents"><code class="xref py py-class docutils literal notranslate"><span class="pre">SessionEvents</span></code></a> listener interface.  The <a class="reference internal" href="#sqlalchemy.orm.session.Session.params.extension" title="sqlalchemy.orm.session.Session"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Session.extension</span></code></a> parameter will be removed in a future release.</p>
</div>
</p></li>
...
objects, as returned by the <a class="reference internal" href="#sqlalchemy.orm.session.Session.query" title="sqlalchemy.orm.session.Session.query"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.query()</span></code></a> method.
...
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since version 1.0: </span>The <a class="reference internal" href="#sqlalchemy.orm.session.Session.params.weak_identity_map" title="sqlalchemy.orm.session.Session"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Session.weak_identity_map</span></code></a> parameter as well as the strong-referencing identity map are deprecated, and will be removed in a future release.  For the use case where objects present in a <a class="reference internal" href="#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> need to be automatically strong referenced, see the recipe at <a class="reference internal" href="session_state_management.html#session-referencing-behavior"><span class="std std-ref">Session Referencing Behavior</span></a> for an event-based approach to maintaining strong identity references. </p>
</div>
</p></li>
</ul>
</dd>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">add</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em>, <em class="sig-param"><span class="n">_warn</span><span class="o">=</span><span class="default_value">True</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.add" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">add_all</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instances</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.add_all" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">begin</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">subtransactions</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">nested</span><span class="o">=</span><span class="default_value">False</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.begin" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#sqlalchemy.orm.session.Session.begin.params.subtransactions" title="sqlalchemy.orm.session.Session.begin"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Session.begin.subtransactions</span></code></a> or
<a class="reference internal" href="#sqlalchemy.orm.session.Session.begin.params.nested" title="sqlalchemy.orm.session.Session.begin"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Session.begin.nested</span></code></a> are specified.  A “subtransaction”
...
<a class="reference internal" href="#sqlalchemy.orm.session.Session.begin" title="sqlalchemy.orm.session.Session.begin"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.begin()</span></code></a> can create a “subtransaction”.</p></li>
...
equivalent to calling <a class="reference internal" href="#sqlalchemy.orm.session.Session.begin_nested" title="sqlalchemy.orm.session.Session.begin_nested"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.begin_nested()</span></code></a>. For
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">begin_nested</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.begin_nested" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">bind_mapper</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">bind</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.bind_mapper" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">bind_table</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">table</span></em>, <em class="sig-param"><span class="n">bind</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.bind_table" title="Permalink to this definition">¶</a></dt>
...
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><ul class="simple">
<li><p><span class="target" id="sqlalchemy.orm.session.Session.bind_table.params.table"></span><strong>table</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.session.Session.bind_table.params.table">¶</a> – a <a class="reference internal" href="../core/metadata.html#sqlalchemy.schema.Table" title="sqlalchemy.schema.Table"><code class="xref py py-class docutils literal notranslate"><span class="pre">Table</span></code></a> object,
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">bulk_insert_mappings</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">mappings</span></em>, <em class="sig-param"><span class="n">return_defaults</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">render_nulls</span><span class="o">=</span><span class="default_value">False</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.bulk_insert_mappings" title="Permalink to this definition">¶</a></dt>
...
list.</p></li>
<li><p><span class="target" id="sqlalchemy.orm.session.Session.bulk_insert_mappings.params.mappings"></span><strong>mappings</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.session.Session.bulk_insert_mappings.params.mappings">¶</a> – a sequence of dictionaries, each one containing the
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">bulk_save_objects</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">objects</span></em>, <em class="sig-param"><span class="n">return_defaults</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">update_changed_only</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">preserve_order</span><span class="o">=</span><span class="default_value">True</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.bulk_save_objects" title="Permalink to this definition">¶</a></dt>
...
<dt class="field-odd">Parameters</dt>
<dd class="field-odd"><ul class="simple">
<li><p><span class="target" id="sqlalchemy.orm.session.Session.bulk_save_objects.params.objects"></span><strong>objects</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.session.Session.bulk_save_objects.params.objects">¶</a> – <p>a sequence of mapped object instances.  The mapped
...
<li><p><span class="target" id="sqlalchemy.orm.session.Session.bulk_save_objects.params.preserve_order"></span><strong>preserve_order</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.session.Session.bulk_save_objects.params.preserve_order">¶</a> – <p>when True, the order of inserts and updates
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">bulk_update_mappings</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span></em>, <em class="sig-param"><span class="n">mappings</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.bulk_update_mappings" title="Permalink to this definition">¶</a></dt>
...
representing the single kind of object represented within the mapping
list.</p></li>
<li><p><span class="target" id="sqlalchemy.orm.session.Session.bulk_update_mappings.params.mappings"></span><strong>mappings</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.session.Session.bulk_update_mappings.params.mappings">¶</a> – a sequence of dictionaries, each one containing the
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">close</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.close" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">close_all</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.close_all" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session._SessionClassMethods.close_all</span></code> <em>method of</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session._SessionClassMethods</span></code></p>
</div>
<p>Close <em>all</em> sessions in memory.</p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">commit</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.commit" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">connection</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">clause</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">bind</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">close_with_result</span><span class="o">=</span><span class="default_value">False</span></em>, <em class="sig-param"><span class="n">execution_options</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.connection" title="Permalink to this definition">¶</a></dt>
...
<li><p><span class="target" id="sqlalchemy.orm.session.Session.connection.params.clause"></span><strong>clause</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.session.Session.connection.params.clause">¶</a> – A <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.ClauseElement" title="sqlalchemy.sql.expression.ClauseElement"><code class="xref py py-class docutils literal notranslate"><span class="pre">ClauseElement</span></code></a> (i.e.
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">delete</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.delete" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">deleted</code><a class="headerlink" href="#sqlalchemy.orm.session.Session.deleted" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">dirty</code><a class="headerlink" href="#sqlalchemy.orm.session.Session.dirty" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">enable_relationship_loading</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">obj</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.enable_relationship_loading" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">execute</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">clause</span></em>, <em class="sig-param"><span class="n">params</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">mapper</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">bind</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.execute" title="Permalink to this definition">¶</a></dt>
...
<p><a class="reference internal" href="#sqlalchemy.orm.session.Session.execute" title="sqlalchemy.orm.session.Session.execute"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.execute()</span></code></a> accepts any executable clause construct,
...
this <a class="reference internal" href="#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a>.   The <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a>
which is used
...
<p>The <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a> returned by the
<a class="reference internal" href="#sqlalchemy.orm.session.Session.execute" title="sqlalchemy.orm.session.Session.execute"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.execute()</span></code></a>
...
<a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a> available, a temporary
<a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a> is
established for the statement execution, which is closed (meaning,
returned to the connection pool) when the <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.ResultProxy" title="sqlalchemy.engine.ResultProxy"><code class="xref py py-class docutils literal notranslate"><span class="pre">ResultProxy</span></code></a>
has
...
such as <a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.select" title="sqlalchemy.sql.expression.select"><code class="xref py py-func docutils literal notranslate"><span class="pre">select()</span></code></a>) or string SQL statement
to be executed.</p></li>
...
<p><a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection.execute" title="sqlalchemy.engine.Connection.execute"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Connection.execute()</span></code></a>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">expire</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em>, <em class="sig-param"><span class="n">attribute_names</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.expire" title="Permalink to this definition">¶</a></dt>
...
<p><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.populate_existing()</span></code></p>
</div>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.orm.session.Session.expire_all">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">expire_all</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.expire_all" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">expunge</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.expunge" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">expunge_all</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.expunge_all" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">flush</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">objects</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.flush" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">get_bind</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">mapper</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">clause</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.get_bind" title="Permalink to this definition">¶</a></dt>
...
<li><p>if mapper given and <a class="reference internal" href="#sqlalchemy.orm.session.Session.params.binds" title="sqlalchemy.orm.session.Session"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Session.binds</span></code></a> is present,
...
<a class="reference internal" href="#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a>, and secondly by consulting the
...
<li><p><span class="target" id="sqlalchemy.orm.session.Session.get_bind.params.clause"></span><strong>clause</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.session.Session.get_bind.params.clause">¶</a> – A <a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.ClauseElement" title="sqlalchemy.sql.expression.ClauseElement"><code class="xref py py-class docutils literal notranslate"><span class="pre">ClauseElement</span></code></a> (i.e.
<a class="reference internal" href="../core/selectable.html#sqlalchemy.sql.expression.select" title="sqlalchemy.sql.expression.select"><code class="xref py py-func docutils literal notranslate"><span class="pre">select()</span></code></a>,
<a class="reference internal" href="../core/sqlelement.html#sqlalchemy.sql.expression.text" title="sqlalchemy.sql.expression.text"><code class="xref py py-func docutils literal notranslate"><span class="pre">text()</span></code></a>,
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">identity_key</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">orm_util</span></em>, <em class="sig-param"><span class="o">*</span><span class="n">args</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.identity_key" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session._SessionClassMethods.identity_key</span></code> <em>method of</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session._SessionClassMethods</span></code></p>
</div>
<p>Return an identity key.</p>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">identity_map</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.orm.session.Session.identity_map" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">info</code><a class="headerlink" href="#sqlalchemy.orm.session.Session.info" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">invalidate</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.invalidate" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">is_active</code><a class="headerlink" href="#sqlalchemy.orm.session.Session.is_active" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">is_modified</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em>, <em class="sig-param"><span class="n">include_collections</span><span class="o">=</span><span class="default_value">True</span></em>, <em class="sig-param"><span class="n">passive</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.is_modified" title="Permalink to this definition">¶</a></dt>
...
<li><p><span class="target" id="sqlalchemy.orm.session.Session.is_modified.params.passive"></span><strong>passive</strong><a class="paramlink headerlink reference internal" href="#sqlalchemy.orm.session.Session.is_modified.params.passive">¶</a> – <p>not used</p>
<div class="deprecated">
<p><span class="versionmodified deprecated">Deprecated since version 0.8: </span>The <a class="reference internal" href="#sqlalchemy.orm.session.Session.is_modified.params.passive" title="sqlalchemy.orm.session.Session.is_modified"><code class="xref py py-paramref docutils literal notranslate"><span class="pre">Session.is_modified.passive</span></code></a> flag is deprecated and will be removed in a future release.  The flag is no longer used and is ignored.</p>
</div>
</p></li>
</ul>
</dd>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">merge</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em>, <em class="sig-param"><span class="n">load</span><span class="o">=</span><span class="default_value">True</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.merge" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">new</code><a class="headerlink" href="#sqlalchemy.orm.session.Session.new" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">no_autoflush</code><a class="headerlink" href="#sqlalchemy.orm.session.Session.no_autoflush" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><em class="property">classmethod </em><code class="sig-name descname">object_session</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.object_session" title="Permalink to this definition">¶</a></dt>
<dd><div class="inherited-member docutils container">
<p><em>inherited from the</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session._SessionClassMethods.object_session</span></code> <em>method of</em> <code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session._SessionClassMethods</span></code></p>
</div>
<p>Return the <a class="reference internal" href="#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> to which an object belongs.</p>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">prepare</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.prepare" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">prune</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.prune" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">query</code><span class="sig-paren">(</span><em class="sig-param"><span class="o">*</span><span class="n">entities</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kwargs</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.query" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">refresh</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em>, <em class="sig-param"><span class="n">attribute_names</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">with_for_update</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">lockmode</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.refresh" title="Permalink to this definition">¶</a></dt>
...
<a class="reference internal" href="#sqlalchemy.orm.session.Session.refresh" title="sqlalchemy.orm.session.Session.refresh"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.refresh()</span></code></a> usually only makes sense if non-ORM SQL
...
<a class="reference internal" href="query.html#sqlalchemy.orm.query.Query.with_for_update" title="sqlalchemy.orm.query.Query.with_for_update"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.with_for_update()</span></code></a>.
...
as used by <a class="reference internal" href="query.html#sqlalchemy.orm.query.Query.with_lockmode" title="sqlalchemy.orm.query.Query.with_lockmode"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Query.with_lockmode()</span></code></a>.
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">rollback</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.rollback" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">scalar</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">clause</span></em>, <em class="sig-param"><span class="n">params</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">mapper</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">bind</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="o">**</span><span class="n">kw</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.Session.scalar" title="Permalink to this definition">¶</a></dt>
<dd><p>Like <a class="reference internal" href="#sqlalchemy.orm.session.Session.execute" title="sqlalchemy.orm.session.Session.execute"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.execute()</span></code></a> but return a scalar result.</p>
</dd></dl>

<dl class="py attribute">
<dt id="sqlalchemy.orm.session.Session.transaction">
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.orm.session.Session"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.Session.</span></code></a><code class="sig-name descname">transaction</code><em class="property"> = None</em><a class="headerlink" href="#sqlalchemy.orm.session.Session.transaction" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.orm.session.</code><code class="sig-name descname">SessionTransaction</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">session</span></em>, <em class="sig-param"><span class="n">parent</span><span class="o">=</span><span class="default_value">None</span></em>, <em class="sig-param"><span class="n">nested</span><span class="o">=</span><span class="default_value">False</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.SessionTransaction" title="Permalink to this definition">¶</a></dt>
...
its default mode of <code class="docutils literal notranslate"><span class="pre">autocommit=False</span></code> immediately, associated
...
to emit SQL on behalf of various <a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Engine" title="sqlalchemy.engine.Engine"><code class="xref py py-class docutils literal notranslate"><span class="pre">Engine</span></code></a> or
<a class="reference internal" href="../core/connections.html#sqlalchemy.engine.Connection" title="sqlalchemy.engine.Connection"><code class="xref py py-class docutils literal notranslate"><span class="pre">Connection</span></code></a>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.orm.session.SessionTransaction"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.SessionTransaction.</span></code></a><code class="sig-name descname">nested</code><em class="property"> = False</em><a class="headerlink" href="#sqlalchemy.orm.session.SessionTransaction.nested" title="Permalink to this definition">¶</a></dt>
...
<em class="property">attribute </em><a class="reference internal" href="#sqlalchemy.orm.session.SessionTransaction"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.session.SessionTransaction.</span></code></a><code class="sig-name descname">parent</code><a class="headerlink" href="#sqlalchemy.orm.session.SessionTransaction.parent" title="Permalink to this definition">¶</a></dt>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.session.close_all_sessions"><code class="sig-name descname">close_all_sessions</code></a>()</p></td>
<td><p>Close all sessions in memory.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.session.make_transient"><code class="sig-name descname">make_transient</code></a>(instance)</p></td>
...
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.session.make_transient_to_detached"><code class="sig-name descname">make_transient_to_detached</code></a>(instance)</p></td>
...
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.session.object_session"><code class="sig-name descname">object_session</code></a>(instance)</p></td>
<td><p>Return the <a class="reference internal" href="#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> to which the given instance belongs.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.util.was_deleted"><code class="sig-name descname">was_deleted</code></a>(object_)</p></td>
...
<dt id="sqlalchemy.orm.session.close_all_sessions">
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.session.</code><code class="sig-name descname">close_all_sessions</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.close_all_sessions" title="Permalink to this definition">¶</a></dt>
<dd><p>Close all sessions in memory.</p>
<p>This function consults a global registry of all <a class="reference internal" href="#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a> objects
and calls <a class="reference internal" href="#sqlalchemy.orm.session.Session.close" title="sqlalchemy.orm.session.Session.close"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.close()</span></code></a> on them, which resets them to a clean
state.</p>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.session.</code><code class="sig-name descname">make_transient</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.make_transient" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.session.</code><code class="sig-name descname">make_transient_to_detached</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.make_transient_to_detached" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.session.</code><code class="sig-name descname">object_session</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.session.object_session" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.util.</code><code class="sig-name descname">was_deleted</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">object_</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.util.was_deleted" title="Permalink to this definition">¶</a></dt>
...
<tbody>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.attributes.del_attribute"><code class="sig-name descname">del_attribute</code></a>(instance, key)</p></td>
<td><p>Delete the value of an attribute, firing history events.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.attributes.flag_dirty"><code class="sig-name descname">flag_dirty</code></a>(instance)</p></td>
<td><p>Mark an instance as ‘dirty’ without any specific attribute mentioned.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.attributes.flag_modified"><code class="sig-name descname">flag_modified</code></a>(instance, key)</p></td>
<td><p>Mark an attribute on an instance as ‘modified’.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.attributes.get_attribute"><code class="sig-name descname">get_attribute</code></a>(instance, key)</p></td>
<td><p>Get the value of an attribute, firing any callables required.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.attributes.get_history"><code class="sig-name descname">get_history</code></a>(obj, key[, passive])</p></td>
...
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.attributes.History"><code class="sig-name descname">History</code></a></p></td>
<td><p>A 3-tuple of added, unchanged and deleted values,
representing the changes which have occurred on an instrumented
attribute.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.attributes.init_collection"><code class="sig-name descname">init_collection</code></a>(obj, key)</p></td>
<td><p>Initialize a collection attribute and return the collection adapter.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.attributes.instance_state"><code class="sig-name descname">instance_state</code></a></p></td>
<td><p>Return the <a class="reference internal" href="internals.html#sqlalchemy.orm.state.InstanceState" title="sqlalchemy.orm.state.InstanceState"><code class="xref py py-class docutils literal notranslate"><span class="pre">InstanceState</span></code></a> for a given
mapped object.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.instrumentation.is_instrumented"><code class="sig-name descname">is_instrumented</code></a>(instance, key)</p></td>
<td><p>Return True if the given attribute on the given instance is
instrumented by the attributes package.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.util.object_state"><code class="sig-name descname">object_state</code></a>(instance)</p></td>
<td><p>Given an object, return the <a class="reference internal" href="internals.html#sqlalchemy.orm.state.InstanceState" title="sqlalchemy.orm.state.InstanceState"><code class="xref py py-class docutils literal notranslate"><span class="pre">InstanceState</span></code></a>
associated with the object.</p></td>
</tr>
<tr class="row-even"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.attributes.set_attribute"><code class="sig-name descname">set_attribute</code></a>(instance, key, value[, initiator])</p></td>
<td><p>Set the value of an attribute, firing history events.</p></td>
</tr>
<tr class="row-odd"><td class="nowrap"><p><a class="reference internal" href="#sqlalchemy.orm.attributes.set_committed_value"><code class="sig-name descname">set_committed_value</code></a>(instance, key, value)</p></td>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.util.</code><code class="sig-name descname">object_state</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.util.object_state" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.attributes.</code><code class="sig-name descname">del_attribute</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em>, <em class="sig-param"><span class="n">key</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.del_attribute" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.attributes.</code><code class="sig-name descname">get_attribute</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em>, <em class="sig-param"><span class="n">key</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.get_attribute" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.attributes.</code><code class="sig-name descname">get_history</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">obj</span></em>, <em class="sig-param"><span class="n">key</span></em>, <em class="sig-param"><span class="n">passive</span><span class="o">=</span><span class="default_value">symbol('PASSIVE_OFF')</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.get_history" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.attributes.</code><code class="sig-name descname">init_collection</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">obj</span></em>, <em class="sig-param"><span class="n">key</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.init_collection" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.attributes.</code><code class="sig-name descname">flag_modified</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em>, <em class="sig-param"><span class="n">key</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.flag_modified" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.attributes.</code><code class="sig-name descname">flag_dirty</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.flag_dirty" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.attributes.</code><code class="sig-name descname">instance_state</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.instance_state" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.instrumentation.</code><code class="sig-name descname">is_instrumented</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em>, <em class="sig-param"><span class="n">key</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.instrumentation.is_instrumented" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.attributes.</code><code class="sig-name descname">set_attribute</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em>, <em class="sig-param"><span class="n">key</span></em>, <em class="sig-param"><span class="n">value</span></em>, <em class="sig-param"><span class="n">initiator</span><span class="o">=</span><span class="default_value">None</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.set_attribute" title="Permalink to this definition">¶</a></dt>
...
<em class="property">function </em><code class="sig-prename descclassname">sqlalchemy.orm.attributes.</code><code class="sig-name descname">set_committed_value</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">instance</span></em>, <em class="sig-param"><span class="n">key</span></em>, <em class="sig-param"><span class="n">value</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.set_committed_value" title="Permalink to this definition">¶</a></dt>
...
<em class="property">class </em><code class="sig-prename descclassname">sqlalchemy.orm.attributes.</code><code class="sig-name descname">History</code><span class="sig-paren">(</span><em class="sig-param"><span class="n">added</span></em>, <em class="sig-param"><span class="n">unchanged</span></em>, <em class="sig-param"><span class="n">deleted</span></em><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.History" title="Permalink to this definition">¶</a></dt>
...
<div class="class-bases docutils container">
<p><strong>Class signature</strong></p>
<p>class <a class="reference internal" href="#sqlalchemy.orm.attributes.History" title="sqlalchemy.orm.attributes.History"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.orm.attributes.History</span></code></a> (<a class="reference internal" href="#sqlalchemy.orm.attributes.History" title="sqlalchemy.orm.attributes.History"><code class="xref py py-class docutils literal notranslate"><span class="pre">sqlalchemy.orm.attributes.History</span></code></a>)</p>
</div>
<dl class="py method">
<dt id="sqlalchemy.orm.attributes.History.empty">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.attributes.History"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.attributes.History.</span></code></a><code class="sig-name descname">empty</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.History.empty" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.attributes.History"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.attributes.History.</span></code></a><code class="sig-name descname">has_changes</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.History.has_changes" title="Permalink to this definition">¶</a></dt>
...
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.attributes.History"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.attributes.History.</span></code></a><code class="sig-name descname">non_added</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.History.non_added" title="Permalink to this definition">¶</a></dt>
<dd><p>Return a collection of unchanged + deleted.</p>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.orm.attributes.History.non_deleted">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.attributes.History"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.attributes.History.</span></code></a><code class="sig-name descname">non_deleted</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.History.non_deleted" title="Permalink to this definition">¶</a></dt>
<dd><p>Return a collection of added + unchanged.</p>
</dd></dl>

<dl class="py method">
<dt id="sqlalchemy.orm.attributes.History.sum">
<em class="property">method </em><a class="reference internal" href="#sqlalchemy.orm.attributes.History"><code class="docutils literal notranslate"><span class="pre">sqlalchemy.orm.attributes.History.</span></code></a><code class="sig-name descname">sum</code><span class="sig-paren">(</span><span class="sig-paren">)</span><a class="headerlink" href="#sqlalchemy.orm.attributes.History.sum" title="Permalink to this definition">¶</a></dt>
