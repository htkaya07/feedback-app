...
orphaned objects may still be pulled into the ex-parent’s <a class="reference internal" href="session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a>; this is
so that the flush process may handle that related object appropriately.
This case usually only arises if an object is removed from one <a class="reference internal" href="session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a>
...
<div class="section" id="using-delete-cascade-with-many-to-many-relationships">
...
using <code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.delete()</span></code>, the flush process will as usual delete
...
<div class="section" id="using-foreign-key-on-delete-cascade-with-orm-relationships">
...
<p>There is then an additional option on <a class="reference internal" href="relationship_api.html#sqlalchemy.orm.relationship" title="sqlalchemy.orm.relationship"><code class="xref py py-func docutils literal notranslate"><span class="pre">relationship()</span></code></a> which which
...
<li><p>When the <code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code> next flushes changes to the database,
...
<div class="topic">
<p class="topic-title first">Notes on Passive Deletes</p>
...
already locally present in the <a class="reference internal" href="session_api.html#sqlalchemy.orm.session.Session" title="sqlalchemy.orm.session.Session"><code class="xref py py-class docutils literal notranslate"><span class="pre">Session</span></code></a>; for any collections
...
<div class="section" id="using-foreign-key-on-delete-with-many-to-many-relationships">
...
<code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.delete()</span></code>.</p></li>
...
course, <a class="reference internal" href="session_api.html#sqlalchemy.orm.session.Session.add" title="sqlalchemy.orm.session.Session.add"><code class="xref py py-meth docutils literal notranslate"><span class="pre">Session.add()</span></code></a> <code class="docutils literal notranslate"><span class="pre">i1</span></code> to the session at a later point.   This
